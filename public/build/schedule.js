    ...
    */
    ...
    function create_fragment$2(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*url*/ ctx[0] && !/*showError*/ ctx[2]) return create_if_block$1;
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(select, file, 96, 6, 3592);
    			add_location(hr0, file, 103, 6, 3830);
    			add_location(h31, file, 104, 6, 3843);
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(98:8) {#each options as option}",
    		ctx
    	});
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(92:25)      <Loader />   {:then options}",
    		ctx
    	});
