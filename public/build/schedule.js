...
var schedule = (function () {
    ...
    */
    ...
    const file$1 = "src/components/Meme.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 6, 2, 151);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*url*/ ctx[0]) return create_if_block$1;
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = /*preview*/ ctx[7])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Preview");
    			add_location(img, file, 107, 6, 3933);
    			add_location(hr2, file, 108, 6, 3975);
    			add_location(h33, file, 109, 6, 3988);
    			attr_dev(input1, "id", "name");
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "placeholder", "Name");
    			add_location(input1, file, 110, 6, 4029);
    			attr_dev(label0, "for", "name");
    			add_location(label0, file, 111, 6, 4104);
    			add_location(hr3, file, 117, 6, 4335);
    			add_location(h34, file, 118, 6, 4348);
    			attr_dev(label1, "for", "email");
    			add_location(label1, file, 119, 6, 4370);
    			attr_dev(input2, "id", "email");
    			attr_dev(input2, "type", "email");
    			attr_dev(input2, "placeholder", "School email");
    			add_location(input2, file, 120, 6, 4416);
    			attr_dev(label2, "for", "found-box");
    			add_location(label2, file, 127, 8, 4554);
    			attr_dev(input3, "id", "found-box");
    			attr_dev(input3, "type", "checkbox");
    			add_location(input3, file, 128, 8, 4619);
    			add_location(div, file, 126, 6, 4540);
    			attr_dev(form, "class", "flex flex-col");
    			add_location(form, file, 93, 4, 3496);
    			attr_dev(p, "class", "epilogue");
    			add_location(p, file, 136, 4, 4852);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (!current || dirty & /*preview*/ 128 && !src_url_equal(img.src, img_src_value = /*preview*/ ctx[7])) {
    				attr_dev(img, "src", img_src_value);
    			}
    ...
    function create_then_block_1(ctx) {
    	...
    	meme = new Meme({
    			props: {
    				url: /*firstMeme*/ ctx[24]?.url,
    				noMemeMessage: "Something went wrong :("
    			},
    			$$inline: true
    		});
    ...
    function create_pending_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(113:31)          <Loader />       {:then firstMeme}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 133, 8, 4756);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(91:25)      <Loader />   {:then options}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(footer, file, 139, 0, 4905);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const schedule = e => __awaiter(void 0, void 0, void 0, function* () {
    		...
    		const meme = { name, email, fileBase64, found: !made };
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('made' in $$props) $$invalidate(4, made = $$props.made);
