...
var schedule = (function () {
    ...
    */
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = space();
    			p = element("p");
    			t8 = text(/*message*/ ctx[6]);
    			attr_dev(select, "class", "font-mono");
    			if (/*chosenDate*/ ctx[0] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[10].call(select));
    			add_location(select, file, 78, 8, 3040);
    			attr_dev(input0, "type", "file");
    			add_location(input0, file, 85, 8, 3292);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "placeholder", "URL");
    			add_location(input1, file, 86, 8, 3333);
    			attr_dev(input2, "type", "email");
    			attr_dev(input2, "placeholder", "Email");
    			add_location(input2, file, 87, 8, 3398);
    			attr_dev(label, "for", "found-box");
    			add_location(label, file, 90, 10, 3523);
    			attr_dev(input3, "type", "checkbox");
    			attr_dev(input3, "id", "found-box");
    			add_location(input3, file, 91, 10, 3571);
    			add_location(div0, file, 88, 8, 3468);
    			attr_dev(form, "class", "flex flex-col justify-between h-72");
    			add_location(form, file, 77, 6, 2982);
    			attr_dev(p, "class", "epilogue");
    			add_location(p, file, 99, 6, 3821);
    			attr_dev(div1, "class", "max-w-sm");
    			add_location(div1, file, 76, 4, 2953);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*optionsPromise*/ 128) {
    				each_value = /*options*/ ctx[21];
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (dirty & /*chosenDate, optionsPromise*/ 129) {
    				select_option(select, /*chosenDate*/ ctx[0]);
    			}
    			...
    			if (!current || dirty & /*message*/ 64) set_data_dev(t8, /*message*/ ctx[6]);
    		},
    ...
    // (80:10) {#each options as option}
    function create_each_block(ctx) {
    	let option;
    	let t_value = /*option*/ ctx[22].text + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			option.__value = /*option*/ ctx[22].value;
    			option.value = option.__value;
    			option.disabled = !/*option*/ ctx[22].available;
    			add_location(option, file, 80, 12, 3139);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(80:10) {#each options as option}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 96, 10, 3719);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*schedule*/ ctx[8], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(74:25)      <Loader />   {:then options}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	handle_promise(/*optionsPromise*/ ctx[7], info);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 72, 2, 2865);
    			add_location(main, file, 71, 0, 2856);
    			add_location(footer, file, 103, 0, 3885);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const schedule = e => __awaiter(void 0, void 0, void 0, function* () {
    		...
    		const file = yield files[0].arrayBuffer();
    		console.log({ file });
    		...
    		try {
    			...
    			if (err.code === "functions/invalid-argument" || err.code === "functions/out-of-range") {
    	...
    	function select_change_handler() {
    		...
    		$$invalidate(0, chosenDate);
    		$$invalidate(7, optionsPromise);
    	}
