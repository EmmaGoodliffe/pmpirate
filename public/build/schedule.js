...
var schedule = (function () {
    ...
    */
    ...
    const firstMemeDate = compoundDate(12, 10, 2021);
    ...
    /* src/components/Switch.svelte generated by Svelte v3.49.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 13, 2, 208);
    			attr_dev(div1, "class", "switch");
    			toggle_class(div1, "off", !/*state*/ ctx[0]);
    			toggle_class(div1, "on", /*state*/ ctx[0]);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { onUpdate } = $$props;
    	const writable_props = ['state', 'onUpdate'];
    	...
    	$$self.$capture_state = () => ({ state, onUpdate });
    	...
    	return [state, onUpdate, click_handler];
    }

    class Switch extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { state: 0, onUpdate: 1 });
    		...
    		if (/*onUpdate*/ ctx[1] === undefined && !('onUpdate' in props)) {
    			console.warn("<Switch> was created without expected prop 'onUpdate'");
    		}
    	}
    ...
    /* src/components/Schedule.svelte generated by Svelte v3.49.0 */

    const { console: console_1 } = globals;
    const file = "src/components/Schedule.svelte";
    ...
    function create_then_block(ctx) {
    	...
    	handle_promise(/*firstMemePromise*/ ctx[8], info);
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			h31 = element("h3");
    			h31.textContent = "Select an image";
    			t5 = space();
    			...
    			add_location(select, file, 102, 6, 3725);
    			add_location(hr0, file, 109, 6, 3963);
    			add_location(h31, file, 110, 6, 3976);
    			attr_dev(input0, "id", "file");
    			attr_dev(input0, "type", "file");
    			add_location(input0, file, 111, 6, 4007);
    			add_location(hr1, file, 112, 6, 4056);
    			add_location(h32, file, 113, 6, 4069);
    			add_location(p0, file, 114, 6, 4098);
    			add_location(hr2, file, 120, 6, 4292);
    			add_location(h33, file, 121, 6, 4305);
    			attr_dev(input1, "id", "name");
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "placeholder", "Name");
    			add_location(input1, file, 122, 6, 4346);
    			attr_dev(label0, "for", "name");
    			add_location(label0, file, 123, 6, 4421);
    			add_location(hr3, file, 129, 6, 4612);
    			add_location(h34, file, 130, 6, 4625);
    			attr_dev(label1, "class", "mb-2");
    			attr_dev(label1, "for", "email");
    			add_location(label1, file, 131, 6, 4647);
    			...
    			toggle_class(span0, "text-dark-fg", /*found*/ ctx[4]);
    		...
    		m: function mount(target, anchor) {
    			...
    			select_option(select, /*chosenDate*/ ctx[1]);
    			append_dev(form, t2);
    			append_dev(form, hr0);
    			append_dev(form, t3);
    			append_dev(form, h31);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*chosenDate, optionsPromise*/ 514) {
    				select_option(select, /*chosenDate*/ ctx[1]);
    			}
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file, 104, 10, 3820);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(104:8) {#each options as option}",
    		ctx
    	});
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 118, 8, 4232);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const meme_changes = {};
    			if (dirty & /*preview*/ 128) meme_changes.url = /*preview*/ ctx[7];
    ...
    function create_pending_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(125:31)          <Loader />       {:then firstMeme}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*schedule*/ ctx[10], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(98:25)      <Loader />   {:then options}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	handle_promise(/*optionsPromise*/ ctx[9], info);
    	...
    	const block = {
    		c: function create() {
    			...
    			main = element("main");
    			h2 = element("h2");
    			h2.textContent = "Schedule a Meme";
    			t2 = space();
    			info.block.c();
    			t3 = space();
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const getOptions = () => __awaiter(void 0, void 0, void 0, function* () {
    		...
    		const options = (yield Promise.all(new Array(11).fill(0).map((_x, i) => __awaiter(void 0, void 0, void 0, function* () {
    			const date = compoundDate(currentDate + i - 2, currentMonth, currentYear);

    			const option = {
    				value: date,
    				text: dateToString(date),
    				available: !(yield getMemeOtd(db, date))
    			};
    		...
    		$$invalidate(1, chosenDate = (_b = (_a = options.filter(option => option.value && option.value >= today && option.available)[0]) === null || _a === void 0
    		? void 0
    	...
    	const schedule = e => __awaiter(void 0, void 0, void 0, function* () {
    		e.preventDefault();
    		$$invalidate(6, message = "");
    		$$invalidate(5, isLoading = true);

    		if (!files || !files[0]) {
    			$$invalidate(6, message = "Invalid image");
    		...
    		if (!chosenDate) {
    			$$invalidate(6, message = "Invalid date");
    			$$invalidate(5, isLoading = false);
    			return;
    		}
    		...
    		try {
    			...
    			$$invalidate(6, message = response.data.message);
    			$$invalidate(5, isLoading = false);
    		} catch(err) {
    			$$invalidate(5, isLoading = false);
    			...
    			if (err && typeof err === "object") {
    				...
    				if (code === "functions/invalid-argument" || code === "functions/out-of-range") {
    					$$invalidate(6, message = "That date is unavailable");
    					console.warn(err);
    					return;
    				}
    			}

    			$$invalidate(6, message = "Something went wrong");
    			throw err;
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Schedule> was created with unknown prop '${key}'`);
    	});

    	function select_change_handler() {
    		chosenDate = select_value(this);
    		$$invalidate(1, chosenDate);
    		$$invalidate(9, optionsPromise);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('db' in $$props) $$invalidate(11, db = $$props.db);
    		if ('chosenDate' in $$props) $$invalidate(1, chosenDate = $$props.chosenDate);
    		...
    		if ('preview' in $$props) $$invalidate(7, preview = $$props.preview);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*files*/ 1) {
    			$$invalidate(7, preview = files && files[0] ? URL.createObjectURL(files[0]) : "");
    		}
    	};
    ...
    class Schedule extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { db: 11 });
    		...
    		if (/*db*/ ctx[11] === undefined && !('db' in props)) {
    			console_1.warn("<Schedule> was created without expected prop 'db'");
    		}
    	}
