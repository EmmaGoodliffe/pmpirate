...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(fetch.bind(self));const Tl=function(t,e={}){if("object"!=typeof e){e={name:e}}const n=Object.assign({name:H,automaticDataCollectionEnabled:!1},e),i=n.name;if("string"!=typeof i||!i)throw Z.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(l(t,s.options)&&l(n,s.config))return s;throw Z.create("duplicate-app",{appName:i})}const r=new v(i);for(const t of W.values())r.addComponent(t);const o=new tt(t,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyDfGaweLVDXcfxJDZ4ztoMoilhU9fv4uXU",authDomain:"pmpirate.firebaseapp.com",projectId:"pmpirate",storageBucket:"pmpirate.appspot.com",messagingSenderId:"198590478768",appId:"1:198590478768:web:3d10abd6d006c0a0b93e75",measurementId:"G-19MDLJEYQG"});!function(t=et()){const e=J(t=p(t),te);e.isInitialized()?e.getImmediate():function(t,e={}){const n=J(t,te);if(n.isInitialized()){const t=n.getImmediate();if(l(e,n.getOptions()))return t;throw re.create("already-initialized")}n.initialize({options:e})}(t)}(Tl);const Il=function(t=et()){return J(t,"firestore").getImmediate()}(Tl),Sl=function(t=et(),e="us-central1"){return J(p(t),dl).getImmediate({identifier:e})}(Tl,"europe-west2");var Cl,Al;function Dl(){}function kl(t){return t()}function _l(){return Object.create(null)}function Nl(t){t.forEach(kl)}function xl(t){return"function"==typeof t}function Ol(t,e){return t!=t?e==e:t!==e||t&&"object"==typeof t||"function"==typeof t}function Ll(t,e){t.appendChild(e)}function Rl(t,e,n){t.insertBefore(e,n||null)}function Ml(t){t.parentNode.removeChild(t)}function Pl(t){return document.createElement(t)}function Fl(t){return document.createTextNode(t)}function Vl(){return Fl(" ")}function Ul(t,e,n,i){return t.addEventListener(e,n,i),()=>t.removeEventListener(e,n,i)}function $l(t,e,n){null==n?t.removeAttribute(e):t.getAttribute(e)!==n&&t.setAttribute(e,n)}function Bl(t,e){t.value=null==e?"":e}function jl(t,e){for(let n=0;n<t.options.length;n+=1){const i=t.options[n];if(i.__value===e)return void(i.selected=!0)}t.selectedIndex=-1}let ql;function Kl(t){ql=t}function zl(){if(!ql)throw new Error("Function called outside component initialization");return ql}(location.href.includes("localhost")||location.href.includes("127.0.0.1"))&&(function(t,e,i,s={}){var r;const o=(t=Bh(t,qh))._getSettings();if("firestore.googleapis.com"!==o.host&&o.host!==e&&jr("Host has been set in both settings() and useEmulator(), emulator host will be used"),t._setSettings(Object.assign(Object.assign({},o),{host:`${e}:${i}`,ssl:!1})),s.mockUserToken){let e,i;if("string"==typeof s.mockUserToken)e=s.mockUserToken,i=Pr.MOCK_USER;else{e=function(t,e){if(t.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const i=e||"demo-project",s=t.iat||0,r=t.sub||t.user_id;if(!r)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const o=Object.assign({iss:`https://securetoken.google.com/${i}`,aud:i,iat:s,exp:s+3600,auth_time:s,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}}},t);return[n(JSON.stringify({alg:"none",type:"JWT"})),n(JSON.stringify(o)),""].join(".")}(s.mockUserToken,null===(r=t._app)||void 0===r?void 0:r.options.projectId);const o=s.mockUserToken.sub||s.mockUserToken.user_id;if(!o)throw new Qr(Gr.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");i=new Pr(o)}t._authCredentials=new Jr(new Xr(e,i))}}(Il,"localhost",8080),Cl="localhost",Al=5001,function(t,e,n){t.emulatorOrigin=`http://${e}:${n}`}(p(Sl),Cl,Al));const Hl=[],Gl=[],Ql=[],Wl=[],Xl=Promise.resolve();let Yl=!1;function Jl(t){Ql.push(t)}const Zl=new Set;let td=0;function ed(){const t=ql;do{for(;td<Hl.length;){const t=Hl[td];td++,Kl(t),nd(t.$$)}for(Kl(null),Hl.length=0,td=0;Gl.length;)Gl.pop()();for(let t=0;t<Ql.length;t+=1){const e=Ql[t];Zl.has(e)||(Zl.add(e),e())}Ql.length=0}while(Hl.length);for(;Wl.length;)Wl.pop()();Yl=!1,Zl.clear(),Kl(t)}function nd(t){if(null!==t.fragment){t.update(),Nl(t.before_update);const e=t.dirty;t.dirty=[-1],t.fragment&&t.fragment.p(t.ctx,e),t.after_update.forEach(Jl)}}const id=new Set;let sd;function rd(t,e){t&&t.i&&(id.delete(t),t.i(e))}function od(t,e,n,i){if(t&&t.o){if(id.has(t))return;id.add(t),sd.c.push((()=>{id.delete(t),i&&(n&&t.d(1),i())})),t.o(e)}else i&&i()}function ad(t,e){const n=e.token={};function i(t,i,s,r){if(e.token!==n)return;e.resolved=r;let o=e.ctx;void 0!==s&&(o=o.slice(),o[s]=r);const a=t&&(e.current=t)(o);let c=!1;e.block&&(e.blocks?e.blocks.forEach(((t,n)=>{n!==i&&t&&(sd={r:0,c:[],p:sd},od(t,1,1,(()=>{e.blocks[n]===t&&(e.blocks[n]=null)})),sd.r||Nl(sd.c),sd=sd.p)})):e.block.d(1),a.c(),rd(a,1),a.m(e.mount(),e.anchor),c=!0),e.block=a,e.blocks&&(e.blocks[i]=a),c&&ed()}if((s=t)&&"object"==typeof s&&"function"==typeof s.then){const n=zl();if(t.then((t=>{Kl(n),i(e.then,1,e.value,t),Kl(null)}),(t=>{if(Kl(n),i(e.catch,2,e.error,t),Kl(null),!e.hasCatch)throw t})),e.current!==e.pending)return i(e.pending,0),!0}else{if(e.current!==e.then)return i(e.then,1,e.value,t),!0;e.resolved=t}var s}function cd(t){t&&t.c()}function ud(t,e,n,i){const{fragment:s,on_mount:r,on_destroy:o,after_update:a}=t.$$;s&&s.m(e,n),i||Jl((()=>{const e=r.map(kl).filter(xl);o?o.push(...e):Nl(e),t.$$.on_mount=[]})),a.forEach(Jl)}function hd(t,e){const n=t.$$;null!==n.fragment&&(Nl(n.on_destroy),n.fragment&&n.fragment.d(e),n.on_destroy=n.fragment=null,n.ctx=[])}function ld(t,e){-1===t.$$.dirty[0]&&(Hl.push(t),Yl||(Yl=!0,Xl.then(ed)),t.$$.dirty.fill(0)),t.$$.dirty[e/31|0]|=1<<e%31}function dd(t,e,n,i,s,r,o,a=[-1]){const c=ql;Kl(t);const u=t.$$={fragment:null,ctx:null,props:r,update:Dl,not_equal:s,bound:_l(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(c?c.$$.context:[])),callbacks:_l(),dirty:a,skip_bound:!1,root:e.target||c.$$.root};o&&o(u.root);let h=!1;if(u.ctx=n?n(t,e.props||{},((e,n,...i)=>{const r=i.length?i[0]:n;return u.ctx&&s(u.ctx[e],u.ctx[e]=r)&&(!u.skip_bound&&u.bound[e]&&u.bound[e](r),h&&ld(t,e)),n})):[],u.update(),h=!0,Nl(u.before_update),u.fragment=!!i&&i(u.ctx),e.target){if(e.hydrate){const t=function(t){return Array.from(t.childNodes)}(e.target);u.fragment&&u.fragment.l(t),t.forEach(Ml)}else u.fragment&&u.fragment.c();e.intro&&rd(t.$$.fragment),ud(t,e.target,e.anchor,e.customElement),ed()}Kl(c)}class fd{$destroy(){hd(this,1),this.$destroy=Dl}$on(t,e){const n=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return n.push(e),()=>{const t=n.indexOf(e);-1!==t&&n.splice(t,1)}}$set(t){var e;this.$$set&&(e=t,0!==Object.keys(e).length)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}const pd=t=>{const e=parseInt(t);if(!isNaN(e))return e;const n=["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"].indexOf(t);return-1===n?n+1:NaN},gd=t=>[t.getDate(),t.getMonth()+1,t.getFullYear()],md=(t,e,n)=>new Date(n,e-1,t),yd=(t,e="/",n=!1)=>{const[i,s,r]=gd(t).map((t=>`${t}`)),o=[i.padStart(2,"0"),s.padStart(2,"0"),r];return(n?o.reverse():o).join(e)},vd=t=>{const e=`${t}`;return e.length<=2?vd("20"+e.padStart(2,"0")):3===e.length?NaN:parseInt(e)},wd={},bd=new Set,Ed=md(1,9,2021);async function Td(t,e,n){try{return console.count("DB reads"),console.count(n),(await al(function(t,e,...n){if(t=p(t),1===arguments.length&&(e=ro.I()),Uh("doc","path",e),t instanceof qh){const i=lo.fromString(e,...n);return $h(i),new Kh(t,null,new go(i))}{if(!(t instanceof Kh||t instanceof Hh))throw new Qr(Gr.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=t._path.child(lo.fromString(e,...n));return $h(i),new Kh(t.firestore,t instanceof Hh?t.converter:null,new go(i))}}(t,e,n))).data()}catch(t){console.warn("Your DB emulations are likely not running correctly"),console.error(t)}}const Id=(t,e)=>{const n=md(1,e,t),i=new Date,s=gd(i)[2];return Ed<=n&&t<=s},Sd=async(t,e,n)=>{var i;if(!Id(t,e))return null;const s=((t,e)=>`${t}-${`${e}`.padStart(2,"0")}`)(t,e);if(bd.has(s))return await(r=1,new Promise((t=>setTimeout(t,1e3*r)))),Cd(t,e);var r;bd.add(s);const o=null!==(i=await Td(n,"memes",s))&&void 0!==i?i:{};return((t,e,n)=>{wd[t]||(wd[t]={}),wd[t][e]=n})(t,e,o),bd.delete(s),o},Cd=(t,e)=>{try{return wd[t][e]}catch(t){console.count("Cache errors")}},Ad=async(t,e,n=0)=>{if(!t)return null;if(n>=12)throw new Error("DB recursion");const[i,s,r]=gd(t);if(!Id(r,s))return null;try{return wd[r][s][i]}catch(t){console.count("Cache errors")}return await((t,e,n)=>{var i;return null!==(i=Cd(t,e))&&void 0!==i?i:Sd(t,e,n)})(r,s,e),Ad(t,e,n+1)};async function Dd(t,e){return function(t,e,n){return vl(p(t),e,n)}(Sl,t)(e)}function kd(t){let e;return{c(){e=Pl("header"),e.innerHTML='<a href="/"><img class="inline-block" style="height: 2.5em;" src="./favicon.png" alt="Logo"/> \n    <h1 class="inline-block ml-4">Physics &amp; Maths Pirate</h1></a>',$l(e,"class","my-8 flex")},m(t,n){Rl(t,e,n)},p:Dl,i:Dl,o:Dl,d(t){t&&Ml(e)}}}class _d extends fd{constructor(t){super(),dd(this,t,null,kd,Ol,{})}}function Nd(t){let e;return{c(){e=Pl("p"),e.textContent="It's loading, bro..."},m(t,n){Rl(t,e,n)},p:Dl,i:Dl,o:Dl,d(t){t&&Ml(e)}}}class xd extends fd{constructor(t){super(),dd(this,t,null,Nd,Ol,{})}}function Od(t,e,n){const i=t.slice();return i[17]=e[n],i}function Ld(t){return{c:Dl,m:Dl,p:Dl,i:Dl,o:Dl,d:Dl}}function Rd(t){let e,n,i,s,r,o,a,c,u,h,l,d,f,p,g,m=t[16],y=[];for(let e=0;e<m.length;e+=1)y[e]=Md(Od(t,m,e));return{c(){e=Pl("form"),n=Pl("select");for(let t=0;t<y.length;t+=1)y[t].c();i=Vl(),s=Pl("input"),r=Vl(),o=Pl("input"),a=Vl(),c=Pl("div"),u=Pl("label"),u.textContent="Found:",h=Vl(),l=Pl("input"),d=Vl(),f=Pl("button"),f.textContent="Schedule",$l(n,"class","font-mono"),void 0===t[0]&&Jl((()=>t[7].call(n))),$l(s,"type","text"),$l(s,"placeholder","URL"),$l(o,"type","email"),$l(o,"placeholder","Email"),$l(u,"for","found-box"),$l(l,"type","checkbox"),$l(l,"id","found-box"),$l(f,"class","btn px-4 py-2"),$l(e,"class","flex flex-col justify-between max-w-sm h-60")},m(m,v){Rl(m,e,v),Ll(e,n);for(let t=0;t<y.length;t+=1)y[t].m(n,null);jl(n,t[0]),Ll(e,i),Ll(e,s),Bl(s,t[1]),Ll(e,r),Ll(e,o),Bl(o,t[2]),Ll(e,a),Ll(e,c),Ll(c,u),Ll(c,h),Ll(c,l),Bl(l,t[3]),Ll(e,d),Ll(e,f),p||(g=[Ul(n,"change",t[7]),Ul(s,"input",t[8]),Ul(o,"input",t[9]),Ul(l,"change",t[10]),Ul(f,"click",t[5])],p=!0)},p(t,e){if(16&e){let i;for(m=t[16],i=0;i<m.length;i+=1){const s=Od(t,m,i);y[i]?y[i].p(s,e):(y[i]=Md(s),y[i].c(),y[i].m(n,null))}for(;i<y.length;i+=1)y[i].d(1);y.length=m.length}17&e&&jl(n,t[0]),2&e&&s.value!==t[1]&&Bl(s,t[1]),4&e&&o.value!==t[2]&&Bl(o,t[2]),8&e&&Bl(l,t[3])},i:Dl,o:Dl,d(t){t&&Ml(e),function(t,e){for(let n=0;n<t.length;n+=1)t[n]&&t[n].d(e)}(y,t),p=!1,Nl(g)}}}function Md(t){let e,n,i,s,r=t[17].text+"";return{c(){e=Pl("option"),n=Fl(r),e.__value=i=t[17].value,e.value=e.__value,e.disabled=s=!t[17].available},m(t,i){Rl(t,e,i),Ll(e,n)},p:Dl,d(t){t&&Ml(e)}}}function Pd(t){let e,n;return e=new xd({}),{c(){cd(e.$$.fragment)},m(t,i){ud(e,t,i),n=!0},p:Dl,i(t){n||(rd(e.$$.fragment,t),n=!0)},o(t){od(e.$$.fragment,t),n=!1},d(t){hd(e,t)}}}function Fd(t){let e,n,i,s,r,o,a,c;e=new _d({});let u={ctx:t,current:null,token:null,hasCatch:!1,pending:Pd,then:Rd,catch:Ld,value:16,blocks:[,,,]};return ad(t[4](),u),{c(){cd(e.$$.fragment),n=Vl(),i=Pl("main"),s=Pl("h2"),s.textContent="Schedule a Meme",r=Vl(),u.block.c(),o=Vl(),a=Pl("footer")},m(t,h){ud(e,t,h),Rl(t,n,h),Rl(t,i,h),Ll(i,s),Ll(i,r),u.block.m(i,u.anchor=null),u.mount=()=>i,u.anchor=null,Rl(t,o,h),Rl(t,a,h),c=!0},p(e,[n]){!function(t,e,n){const i=e.slice(),{resolved:s}=t;t.current===t.then&&(i[t.value]=s),t.current===t.catch&&(i[t.error]=s),t.block.p(i,n)}(u,t=e,n)},i(t){c||(rd(e.$$.fragment,t),rd(u.block),c=!0)},o(t){od(e.$$.fragment,t);for(let t=0;t<3;t+=1){od(u.blocks[t])}c=!1},d(t){hd(e,t),t&&Ml(n),t&&Ml(i),u.block.d(),u.token=null,u=null,t&&Ml(o),t&&Ml(a)}}}function Vd(t,e,n){var i=this&&this.__awaiter||function(t,e,n,i){return new(n||(n=Promise))((function(s,r){function o(t){try{c(i.next(t))}catch(t){r(t)}}function a(t){try{c(i.throw(t))}catch(t){r(t)}}function c(t){var e;t.done?s(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e)}))).then(o,a)}c((i=i.apply(t,e||[])).next())}))};let{db:s}=e;const r=new Date,[o,a,c]=gd(r);let u=null,h="",l="",d=!1;const f=()=>i(void 0,void 0,void 0,(function*(){var t,e;const h=(yield Promise.all(new Array(11).fill(0).map(((t,e)=>i(void 0,void 0,void 0,(function*(){const t=md(o+e-2,a,c),n={value:t,text:yd(t),available:!(yield Ad(t,s))};return yd(n.value)===yd(r)?[{value:null,text:"".padStart(10,"-"),available:!1},n]:n})))))).flat();return n(0,u=null!==(e=null===(t=h.filter((t=>t.value>=(t=>{const e=["/","-","."];for(const n of e){const[e,i,s]=t.split(n).map(pd),r=md(null!=e?e:NaN,null!=i?i:NaN,vd(null!=s?s:NaN));if(![e,i,s].some((t=>!t))&&"Invalid Date"!=`${r}`)return r}for(const n of e){const[e,i,s]=t.split(n).map(pd),r=md(null!=s?s:NaN,null!=i?i:NaN,vd(null!=e?e:NaN));if(![s,i,e].some((t=>!t))&&"Invalid Date"!=`${r}`)return r}const n=new Date(t);if("Invalid Date"!=`${n}`)return n})(yd(r))&&t.available))[0])||void 0===t?void 0:t.value)&&void 0!==e?e:null),h}));return t.$$set=t=>{"db"in t&&n(6,s=t.db)},[u,h,l,d,f,t=>{t.preventDefault(),(async(t,e)=>await Dd("submitMeme",{date:yd(t),meme:e}))(u,{email:l,url:h,found:d}).then((t=>{console.log({response:t})})).catch((t=>{if("functions/invalid-argument"!==t.code&&"functions/out-of-range"!==t.code)throw t;console.warn(t)}))},s,function(){u=function(t){const e=t.querySelector(":checked")||t.options[0];return e&&e.__value}(this),n(0,u),n(4,f)},function(){h=this.value,n(1,h)},function(){l=this.value,n(2,l)},function(){d=this.value,n(3,d)}]}return new class extends fd{constructor(t){super(),dd(this,t,Vd,Fd,Ol,{db:6})}}({target:document.body,props:{db:Il}})}();
