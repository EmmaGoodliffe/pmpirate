...
var schedule = (function () {
    ...
    */
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*schedule*/ ctx[5], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*chosenDate, optionsPromise*/ 17) {
    				select_option(select, /*chosenDate*/ ctx[0]);
    			}
    ...
    function create_fragment(ctx) {
    	...
    	handle_promise(/*optionsPromise*/ ctx[4](), info);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const optionsPromise = () => __awaiter(void 0, void 0, void 0, function* () {
    		...
    		$$invalidate(0, chosenDate = (_b = (_a = options.filter(option => option.value >= stringToDate(dateToString(today)) && option.available)[0]) === null || _a === void 0
    		? void 0
    ...
    class Schedule extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { db: 6 });
    		...
    		if (/*db*/ ctx[6] === undefined && !('db' in props)) {
