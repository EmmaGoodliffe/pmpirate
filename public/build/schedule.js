...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function et(t="[DEFAULT]"){const e=Q.get(t);if(!e)throw Z.create("no-app",{appName:t});return e}function nt(t,e,n){var i;let s=null!==(i=H[t])&&void 0!==i?i:t;n&&(s+=`-${n}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const t=[`Unable to register library "${s}" with version "${e}":`];return r&&t.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&t.push("and"),o&&t.push(`version name "${e}" contains illegal characters (whitespace or "/")`),void z.warn(t.join(" "))}Y(new g(`${s}-version`,(()=>({library:s,version:e})),"VERSION"))}
/**
     * @license
     * Copyright 2021 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(t,n),s=Ct(t,n),r=e.getImmediate({optional:!0});if(r){const t=await r.getHeartbeatsHeader();t&&s.append("x-firebase-client",t)}const o={installation:{sdkVersion:mt,appId:t.appId}},a={method:"POST",headers:s,body:JSON.stringify(o)},c=await At((()=>fetch(i,a)));if(c.ok){return Tt(await c.json())}throw await It("Generate Auth Token",c)}async function Gt(t,e=!1){let n;const i=await $t(t.appConfig,(i=>{if(!Qt(i))throw wt.create("not-registered");const s=i.authToken;if(!e&&function(t){return 2===t.requestStatus&&!function(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+vt}(t)}(s))return i;if(1===s.requestStatus)return n=async function(t,e){let n=await Ht(t.appConfig);for(;1===n.authToken.requestStatus;)await Dt(100),n=await Ht(t.appConfig);const i=n.authToken;return 0===i.requestStatus?Gt(t,e):i}(t,e),i;{if(!navigator.onLine)throw wt.create("app-offline");const e=function(t){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},t),{authToken:e})}(i);return n=async function(t,e){try{const n=await zt(t,e),i=Object.assign(Object.assign({},e),{authToken:n});return await Vt(t.appConfig,i),n}catch(n){if(!bt(n)||401!==n.customData.serverCode&&404!==n.customData.serverCode){const n=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await Vt(t.appConfig,n)}else await Ut(t.appConfig);throw n}}(t,e),e}}));return n?await n:i.authToken}function Ht(t){return $t(t,(t=>{if(!Qt(t))throw wt.create("not-registered");const e=t.authToken;return 1===(n=e).requestStatus&&n.requestTime+gt<Date.now()?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t;var n;
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
async function wo(t){if(t.code!==Hr.FAILED_PRECONDITION||"The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab."!==t.message)throw t;$r("LocalStore","Unexpectedly lost primary lease")}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Vu{constructor(t,e,n,i,s){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.au=[],this.hu=new Map,this.lu=new Set,this.fu=[],this.du=s,this.du.Br((t=>{n.enqueueAndForget((async()=>{Hu(this)&&($r("RemoteStore","Restarting streams for network reachability change."),await async function(t){const e=Gr(t);e.lu.add(4),await $u(e),e._u.set("Unknown"),e.lu.delete(4),await Uu(e)}(this))}))})),this._u=new Fu(n,i)}}async function Uu(t){if(Hu(t))for(const e of t.fu)await e(!0)}async function $u(t){for(const e of t.fu)await e(!1)}function Bu(t,e){const n=Gr(t);n.hu.has(e.targetId)||(n.hu.set(e.targetId,e),Gu(n)?zu(n):th(n).Co()&&qu(n,e))}function ju(t,e){const n=Gr(t),i=th(n);n.hu.delete(e),i.Co()&&Ku(n,e),0===n.hu.size&&(i.Co()?i.ko():Hu(n)&&n._u.set("Unknown"))}function qu(t,e){t.wu.Nt(e.targetId),th(t).Qo(e)}function Ku(t,e){t.wu.Nt(e),th(t).jo(e)}function zu(t){t.wu=new Dc({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),te:e=>t.hu.get(e)||null}),th(t).start(),t._u.iu()}function Gu(t){return Hu(t)&&!th(t).Do()&&t.hu.size>0}function Hu(t){return 0===Gr(t).lu.size}function Qu(t){t.wu=void 0}async function Wu(t){t.hu.forEach(((e,n)=>{qu(t,e)}))}async function Xu(t,e){Qu(t),Gu(t)?(t._u.uu(e),zu(t)):t._u.set("Unknown")}async function Yu(t,e,n){if(t._u.set("Online"),e instanceof Cc&&2===e.state&&e.cause)try{await async function(t,e){const n=e.cause;for(const i of e.targetIds)t.hu.has(i)&&(await t.remoteSyncer.rejectListen(i,n),t.hu.delete(i),t.wu.removeTarget(i))}(t,e)}catch(n){$r("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),n),await Ju(t,n)}else if(e instanceof Ic?t.wu.Ut(e):e instanceof Sc?t.wu.zt(e):t.wu.Gt(e),!n.isEqual(uo.min()))try{const e=await Eu(t.localStore);n.compareTo(e)>=0&&await function(t,e){const n=t.wu.Yt(e);return n.targetChanges.forEach(((n,i)=>{if(n.resumeToken.approximateByteSize()>0){const s=t.hu.get(i);s&&t.hu.set(i,s.withResumeToken(n.resumeToken,e))}})),n.targetMismatches.forEach((e=>{const n=t.hu.get(e);if(!n)return;t.hu.set(e,n.withResumeToken(xo.EMPTY_BYTE_STRING,n.snapshotVersion)),Ku(t,e);const i=new Jc(n.target,e,1,n.sequenceNumber);qu(t,i)})),t.remoteSyncer.applyRemoteEvent(n)}(t,n)}catch(e){$r("RemoteStore","Failed to raise snapshot:",e),await Ju(t,e)}}async function Ju(t,e,n){if(!Eo(e))throw e;t.lu.add(1),await $u(t),t._u.set("Offline"),n||(n=()=>Eu(t.localStore)),t.asyncQueue.enqueueRetryable((async()=>{$r("RemoteStore","Retrying IndexedDB access"),await n(),t.lu.delete(1),await Uu(t)}))}async function Zu(t,e){const n=Gr(t);n.asyncQueue.verifyOperationInProgress(),$r("RemoteStore","RemoteStore received new credentials");const i=Hu(n);n.lu.add(3),await $u(n),i&&n._u.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.lu.delete(3),await Uu(n)}function th(t){return t.mu||(t.mu=function(t,e,n){const i=Gr(t);return i.tu(),new Mu(e,i.bo,i.authCredentials,i.appCheckCredentials,i.wt,n)
/**
     * @license
     * Copyright 2018 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Jh{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new Qr(Hr.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new Qr(Hr.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return oo(this._lat,t._lat)||oo(this._long,t._long)}}const Zh=new RegExp("[~\\*/\\[\\]]");function tl(t,e,n,i,s){const r=i&&!i.isEmpty(),o=void 0!==s;let a=`Function ${e}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(r||o)&&(c+=" (found",r&&(c+=` in field ${i}`),o&&(c+=` in document ${s}`),c+=")"),new Qr(Hr.INVALID_ARGUMENT,a+t+c)
/**
     * @license
     * Copyright 2020 Google LLC
     *
