    ...
    */
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(select, file, 83, 8, 3144);
    			...
    			add_location(input2, file, 93, 8, 3541);
    			attr_dev(label, "for", "found-box");
    			add_location(label, file, 96, 10, 3671);
    			attr_dev(input3, "type", "checkbox");
    			attr_dev(input3, "id", "found-box");
    			add_location(input3, file, 97, 10, 3719);
    			add_location(div0, file, 94, 8, 3616);
    			attr_dev(form, "class", "flex flex-col justify-between h-72");
    			add_location(form, file, 82, 6, 3086);
    			attr_dev(p, "class", "epilogue");
    			add_location(p, file, 105, 6, 3969);
    			attr_dev(div1, "class", "max-w-sm");
    			add_location(div1, file, 81, 4, 3057);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file, 85, 12, 3243);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(85:10) {#each options as option}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 102, 10, 3867);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(79:25)      <Loader />   {:then options}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 77, 2, 2969);
    			add_location(main, file, 76, 0, 2960);
    			add_location(footer, file, 109, 0, 4033);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
