...
var archive = (function () {
    ...
    const getMemesOfMonthFromDb = (year, month) => {
    ...
    const getMemesOfMonth = (year, month) => { var _a; return (_a = getMemesOfMonthFromCache(year, month)) !== null && _a !== void 0 ? _a : getMemesOfMonthFromDb(year, month); };
    const getMemeOtd = (d) => {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file, 40, 2, 1393);
    			attr_dev(span0, "class", "-mt-1.5");
    			add_location(span0, file, 48, 8, 1626);
    			attr_dev(div0, "class", "flex-1 btn");
    			attr_dev(div0, "disabled", div0_disabled_value = !/*backwardsEnabled*/ ctx[4]);
    			add_location(div0, file, 43, 6, 1488);
    			attr_dev(div1, "class", "w-1/4");
    			add_location(div1, file, 42, 4, 1462);
    			attr_dev(p0, "class", "flex-1 my-2 text-lg text-center");
    			add_location(p0, file, 51, 4, 1688);
    			attr_dev(span1, "class", "-mt-1.5");
    			add_location(span1, file, 60, 8, 1950);
    			attr_dev(div2, "class", "flex-1 btn");
    			attr_dev(div2, "disabled", div2_disabled_value = !/*forwardsEnabled*/ ctx[3]);
    			add_location(div2, file, 55, 6, 1814);
    			attr_dev(div3, "class", "w-1/4");
    			add_location(div3, file, 54, 4, 1788);
    			attr_dev(div4, "class", "flex sm:w-1/4 mx-auto my-4");
    			add_location(div4, file, 41, 2, 1417);
    			attr_dev(th0, "class", "border-2");
    			add_location(th0, file, 67, 8, 2124);
    			attr_dev(th1, "class", "border-2");
    			add_location(th1, file, 68, 8, 2163);
    			add_location(tr, file, 66, 6, 2111);
    			add_location(thead, file, 65, 4, 2097);
    			add_location(tbody, file, 71, 4, 2223);
