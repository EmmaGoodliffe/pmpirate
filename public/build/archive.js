var archive=function(){"use strict";function e(){}function t(e){return e()}function n(){return Object.create(null)}function r(e){e.forEach(t)}function i(e){return"function"==typeof e}function o(e,t){return e!=e?t==t:e!==t||e&&"object"==typeof e||"function"==typeof e}let a,s;function c(e,t){return a||(a=document.createElement("a")),a.href=t,e===a.href}function l(e,t){e.appendChild(t)}function u(e,t,n){e.insertBefore(t,n||null)}function f(e){e.parentNode.removeChild(e)}function p(e){return document.createElement(e)}function d(e){return document.createTextNode(e)}function h(){return d(" ")}function m(e,t,n,r){return e.addEventListener(t,n,r),()=>e.removeEventListener(t,n,r)}function g(e,t,n){null==n?e.removeAttribute(t):e.getAttribute(t)!==n&&e.setAttribute(t,n)}function y(e,t){t=""+t,e.wholeText!==t&&(e.data=t)}function w(e,t){e.value=null==t?"":t}function b(e){s=e}const v=[],I=[],$=[],D=[],_=Promise.resolve();let x=!1;function E(e){$.push(e)}let S=!1;const C=new Set;function k(){if(!S){S=!0;do{for(let e=0;e<v.length;e+=1){const t=v[e];b(t),T(t.$$)}for(b(null),v.length=0;I.length;)I.pop()();for(let e=0;e<$.length;e+=1){const t=$[e];C.has(t)||(C.add(t),t())}$.length=0}while(v.length);for(;D.length;)D.pop()();x=!1,S=!1,C.clear()}}function T(e){if(null!==e.fragment){e.update(),r(e.before_update);const t=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,t),e.after_update.forEach(E)}}const j=new Set;function O(e,t){e&&e.i&&(j.delete(e),e.i(t))}function A(e,n,o,a){const{fragment:s,on_mount:c,on_destroy:l,after_update:u}=e.$$;s&&s.m(n,o),a||E((()=>{const n=c.map(t).filter(i);l?l.push(...n):r(n),e.$$.on_mount=[]})),u.forEach(E)}function P(e,t){const n=e.$$;null!==n.fragment&&(r(n.on_destroy),n.fragment&&n.fragment.d(t),n.on_destroy=n.fragment=null,n.ctx=[])}function M(e,t){-1===e.$$.dirty[0]&&(v.push(e),x||(x=!0,_.then(k)),e.$$.dirty.fill(0)),e.$$.dirty[t/31|0]|=1<<t%31}function N(t,i,o,a,c,l,u,p=[-1]){const d=s;b(t);const h=t.$$={fragment:null,ctx:null,props:l,update:e,not_equal:c,bound:n(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(i.context||(d?d.$$.context:[])),callbacks:n(),dirty:p,skip_bound:!1,root:i.target||d.$$.root};u&&u(h.root);let m=!1;if(h.ctx=o?o(t,i.props||{},((e,n,...r)=>{const i=r.length?r[0]:n;return h.ctx&&c(h.ctx[e],h.ctx[e]=i)&&(!h.skip_bound&&h.bound[e]&&h.bound[e](i),m&&M(t,e)),n})):[],h.update(),m=!0,r(h.before_update),h.fragment=!!a&&a(h.ctx),i.target){if(i.hydrate){const e=function(e){return Array.from(e.childNodes)}(i.target);h.fragment&&h.fragment.l(e),e.forEach(f)}else h.fragment&&h.fragment.c();i.intro&&O(t.$$.fragment),A(t,i.target,i.anchor,i.customElement),k()}b(d)}class F{$destroy(){P(this,1),this.$destroy=e}$on(e,t){const n=this.$$.callbacks[e]||(this.$$.callbacks[e]=[]);return n.push(t),()=>{const e=n.indexOf(t);-1!==e&&n.splice(e,1)}}$set(e){var t;this.$$set&&(t=e,0!==Object.keys(t).length)&&(this.$$.skip_bound=!0,this.$$set(e),this.$$.skip_bound=!1)}}function L(t){let n;return{c(){n=p("header"),n.innerHTML='<a href="/"><img class="inline-block" style="height: 2.5em;" src="./favicon.png" alt="Logo"/> \n    <h1 class="inline-block ml-4">Physics &amp; Maths Pirate</h1></a>',g(n,"class","my-8 flex")},m(e,t){u(e,n,t)},p:e,i:e,o:e,d(e){e&&f(n)}}}class z extends F{constructor(e){super(),N(this,e,null,L,o,{})}}function R(e,t,n){const r=e.slice();return r[15]=t[n],r}function B(e){let t,n,r,i,o,a,s,m,y,w,b,v=e[15].split("-").reverse().join("/")+"",I=new Date(e[15])>new Date&&function(e){let t;return{c(){t=d("(Sneak peek)")},m(e,n){u(e,t,n)},d(e){e&&f(t)}}}();return{c(){t=p("tr"),n=p("td"),r=d(v),i=h(),o=p("br"),a=h(),I&&I.c(),s=h(),m=p("td"),y=p("img"),b=h(),g(n,"class","text-center border-2 p-4"),g(y,"class","max-w-sm mx-auto w-1/2 sm:w-auto"),c(y.src,w=`memes/${e[0].otd[e[15]]}`)||g(y,"src",w),g(y,"alt","Meme"),g(m,"class","border-2 p-4")},m(e,c){u(e,t,c),l(t,n),l(n,r),l(n,i),l(n,o),l(n,a),I&&I.m(n,null),l(t,s),l(t,m),l(m,y),l(t,b)},p(e,t){1&t&&!c(y.src,w=`memes/${e[0].otd[e[15]]}`)&&g(y,"src",w)},d(e){e&&f(t),I&&I.d()}}}function q(e){let t,n=e[8](e[15],e[1],e[2]),r=n&&B(e);return{c(){r&&r.c(),t=d("")},m(e,n){r&&r.m(e,n),u(e,t,n)},p(e,i){6&i&&(n=e[8](e[15],e[1],e[2])),n?r?r.p(e,i):(r=B(e),r.c(),r.m(t.parentNode,t)):r&&(r.d(1),r=null)},d(e){r&&r.d(e),e&&f(t)}}}function H(t){let n;return{c(){n=p("p"),n.textContent="No memes that day :(",g(n,"class","w-full sm:w-4/6 md:w-1/2 max-w-md mx-auto text-center")},m(e,t){u(e,n,t)},p:e,d(e){e&&f(n)}}}function V(e){let t,n;return{c(){t=p("img"),g(t,"class","max-w-sm mx-auto w-1/2 sm:w-auto"),c(t.src,n=`memes/${e[0].otd[e[6][0]]}`)||g(t,"src",n),g(t,"alt","Meme")},m(e,n){u(e,t,n)},p(e,r){65&r&&!c(t.src,n=`memes/${e[0].otd[e[6][0]]}`)&&g(t,"src",n)},d(e){e&&f(t)}}}function K(e){let t,n,i,o,a,s,c,b,v,I,$,D,_,x,E,S,C,k,T,M,N,F,L,B,K,U,G,W,X,Y,J,Z,Q,ee,te,ne,re,ie,oe=`${e[1]}`.padStart(2,"0")+"";t=new z({});let ae=e[7],se=[];for(let t=0;t<ae.length;t+=1)se[t]=q(R(e,ae,t));function ce(e,t){return e[6].length?V:H}let le=ce(e),ue=le(e);return{c(){var r;(r=t.$$.fragment)&&r.c(),n=h(),i=p("main"),o=p("h2"),o.textContent="Meme archive",a=h(),s=p("div"),c=p("div"),b=p("div"),v=p("span"),v.textContent="<",$=h(),D=p("p"),_=d(oe),x=d("/"),E=d(e[2]),S=h(),C=p("div"),k=p("div"),T=p("span"),T.textContent=">",N=h(),F=p("table"),L=p("thead"),L.innerHTML='<tr><th class="border-2">Date</th> \n        <th class="border-2">Meme</th></tr>',B=h(),K=p("tbody");for(let e=0;e<se.length;e+=1)se[e].c();U=h(),G=p("section"),W=p("h2"),W.textContent="Specify a date",X=h(),Y=p("input"),J=h(),ue.c(),Z=h(),Q=p("p"),Q.textContent="DVS-style dates accepted",ee=h(),te=p("footer"),g(v,"class","-mt-1.5"),g(b,"class","flex-1 btn"),g(b,"disabled",I=!e[5]),g(c,"class","w-1/4"),g(D,"class","flex-1 my-2 text-lg text-center"),g(T,"class","-mt-1.5"),g(k,"class","flex-1 btn"),g(k,"disabled",M=!e[4]),g(C,"class","w-1/4"),g(s,"class","flex sm:w-1/4 mx-auto my-4"),g(F,"class","table-auto w-full max-w-4xl mx-auto border-white border-2"),g(Y,"type","text"),g(Q,"class","mt-4"),g(G,"class","mt-48"),g(te,"class","mb-4")},m(r,f){A(t,r,f),u(r,n,f),u(r,i,f),l(i,o),l(i,a),l(i,s),l(s,c),l(c,b),l(b,v),l(s,$),l(s,D),l(D,_),l(D,x),l(D,E),l(s,S),l(s,C),l(C,k),l(k,T),l(i,N),l(i,F),l(F,L),l(F,B),l(F,K);for(let e=0;e<se.length;e+=1)se[e].m(K,null);u(r,U,f),u(r,G,f),l(G,W),l(G,X),l(G,Y),w(Y,e[3]),l(G,J),ue.m(G,null),l(G,Z),l(G,Q),u(r,ee,f),u(r,te,f),ne=!0,re||(ie=[m(b,"click",e[11]),m(k,"click",e[12]),m(Y,"input",e[13])],re=!0)},p(e,[t]){if((!ne||32&t&&I!==(I=!e[5]))&&g(b,"disabled",I),(!ne||2&t)&&oe!==(oe=`${e[1]}`.padStart(2,"0")+"")&&y(_,oe),(!ne||4&t)&&y(E,e[2]),(!ne||16&t&&M!==(M=!e[4]))&&g(k,"disabled",M),391&t){let n;for(ae=e[7],n=0;n<ae.length;n+=1){const r=R(e,ae,n);se[n]?se[n].p(r,t):(se[n]=q(r),se[n].c(),se[n].m(K,null))}for(;n<se.length;n+=1)se[n].d(1);se.length=ae.length}8&t&&Y.value!==e[3]&&w(Y,e[3]),le===(le=ce(e))&&ue?ue.p(e,t):(ue.d(1),ue=le(e),ue&&(ue.c(),ue.m(G,Z)))},i(e){ne||(O(t.$$.fragment,e),ne=!0)},o(e){!function(e,t,n,r){if(e&&e.o){if(j.has(e))return;j.add(e),(void 0).c.push((()=>{j.delete(e),r&&(n&&e.d(1),r())})),e.o(t)}}(t.$$.fragment,e),ne=!1},d(e){P(t,e),e&&f(n),e&&f(i),function(e,t){for(let n=0;n<e.length;n+=1)e[n]&&e[n].d(t)}(se,e),e&&f(U),e&&f(G),ue.d(),e&&f(ee),e&&f(te),re=!1,r(ie)}}}function U(e,t,n){let r,{memes:i}=t,{dateToString:o}=t,{stringToDate:a}=t;const s=new Date,c=Object.keys(i.otd);let l=s.getMonth()+1,u=s.getFullYear(),f=o(s),p=!0,d=!0;return e.$$set=e=>{"memes"in e&&n(0,i=e.memes),"dateToString"in e&&n(9,o=e.dateToString),"stringToDate"in e&&n(10,a=e.stringToDate)},e.$$.update=()=>{6&e.$$.dirty&&(l<1?(n(1,l=12),n(2,u--,u)):l>12&&(n(1,l=1),n(2,u++,u))),6&e.$$.dirty&&n(4,p=!(s.getMonth()+1===l&&s.getFullYear()===u)),6&e.$$.dirty&&n(5,d=new Date(2021,8,1)<new Date(u,l-1,1)),1544&e.$$.dirty&&n(6,r=c.filter((e=>o(new Date(e))===o(a(f)))))},[i,l,u,f,p,d,r,c,(e,t,n)=>{const r=new Date(e);r.setDate(r.getDate()-1);const i=r.getMonth()+1===t,o=r.getFullYear()===n;return i&&o&&new Date(r)<=s},o,a,()=>d&&n(1,l--,l),()=>p&&n(1,l++,l),function(){f=this.value,n(3,f)}]}
/*! *****************************************************************************
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class At{constructor(e){this.app=e}_delete(){return delete Pt[this.app.options.appId],Promise.resolve()}}let Pt={},Mt=[];const Nt={};let Ft,Lt,zt="dataLayer",Rt=!1;function Bt(){const e=[];if(function(){const e="object"==typeof chrome?chrome.runtime:"object"==typeof browser?browser.runtime:void 0;return"object"==typeof e&&void 0!==e.id}()&&e.push("This is a browser extension environment."),"undefined"!=typeof navigator&&navigator.cookieEnabled||e.push("Cookies are not available."),e.length>0){const t=e.map(((e,t)=>`(${t+1}) ${e}`)).join(" "),n=xt.create("invalid-analytics-context",{errorInfo:t});$t.warn(n.message)}}function qt(e,t,n){Bt();const r=e.options.appId;if(!r)throw xt.create("no-app-id");if(!e.options.apiKey){if(!e.options.measurementId)throw xt.create("no-api-key");$t.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`)}if(null!=Pt[r])throw xt.create("already-exists",{id:r});if(!Rt){!function(e){let t=[];Array.isArray(window[e])?t=window[e]:window[e]=t}(zt);const{wrappedGtag:e,gtagCore:t}=function(e,t,n,r,i){let o=function(...e){window[r].push(arguments)};return window[i]&&"function"==typeof window[i]&&(o=window[i]),window[i]=_t(o,e,t,n),{gtagCore:o,wrappedGtag:window[i]}}(Pt,Mt,Nt,zt,"gtag");Lt=e,Ft=t,Rt=!0}Pt[r]=Ot(e,Mt,Nt,t,Ft,zt,n);return new At(e)}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function Ht(e,t,n,r){e=oe(e),async function(e,t,n,r,i){if(i&&i.global)e("event",n,r);else{const i=await t;e("event",n,Object.assign(Object.assign({},r),{send_to:i}))}}(Lt,Pt[e.app.options.appId],t,n,r).catch((e=>$t.error(e)))}_e(new ae(vt,((e,{options:t})=>qt(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),t)),"PUBLIC")),_e(new ae("analytics-internal",(function(e){try{const t=e.getProvider(vt).getImmediate();return{logEvent:(e,n,r)=>Ht(t,e,n,r)}}catch(e){throw xt.create("interop-component-reg-failed",{reason:e})}}),"PRIVATE")),Ce("@firebase/analytics","0.7.1");
/**
     * @license
     * Copyright 2020 Google LLC
     *
