...
var archive = (function () {
     ...
     */
    async function update$1(appConfig, updateFn) {
        const key = getKey(appConfig);
        const db = await getDbPromise();
        const tx = db.transaction(OBJECT_STORE_NAME, 'readwrite');
    ...
    async function getInstallationEntry(installations) {
        ...
        const installationEntry = await update$1(installations.appConfig, oldEntry => {
    ...
    function updateInstallationRequest(appConfig) {
        return update$1(appConfig, oldEntry => {
            if (!oldEntry) {
    ...
    async function refreshAuthToken(installations, forceRefresh = false) {
        let tokenPromise;
        const entry = await update$1(installations.appConfig, oldEntry => {
    ...
    */
    ...
    k$1.Ia=function(a){try{if(a==this.g)a:{const r=O(this.g);var b=this.g.Da();const G=this.g.ba();if(!(3>r)&&(3!=r||Ja||this.g&&(this.h.h||this.g.ga()||oc$1(this.g)))){this.I||4!=r||7==b||(8==b||0>=G?I(3):I(2));pc$1(this);var c=this.g.ba();this.N=c;b:if(qc$1(this)){var d=oc$1(this.g);a="";var e=d.length,f=4==O(this.g);if(!this.h.i){if("undefined"===typeof TextDecoder){P(this);rc$1(this);var h="";break b}this.h.i=new l.TextDecoder;}for(b=0;b<e;b++)this.h.h=!0,a+=this.h.i.decode(d[b],{stream:f&&b==e-1});d.splice(0,
    ...
    function tc(a,b,c){let d=!0,e;for(;!a.I&&a.C<c.length;)if(e=vc(a,c),e==hc){4==b&&(a.o=4,J$1(14),d=!1);F$1(a.j,a.m,null,"[Incomplete Response]");break}else if(e==gc){a.o=4;J$1(15);F$1(a.j,a.m,c,"[Invalid Chunk]");d=!1;break}else F$1(a.j,a.m,e,null),sc$1(a,e);qc$1(a)&&e!=hc&&e!=gc&&(a.h.g="",a.C=0);4!=b||0!=c.length||a.h.h||(a.o=1,J$1(16),d=!1);a.i=a.i&&d;d?0<c.length&&!a.aa&&(a.aa=!0,b=a.l,b.g==a&&b.$&&!b.L&&(b.h.info("Great, no buffering proxy detected. Bytes received: "+c.length),wc(b),b.L=!0,J$1(11))):(F$1(a.j,a.m,
    c,"[Invalid Chunked Response]"),P(a),rc$1(a));}k$1.fb=function(){if(this.g){var a=O(this.g),b=this.g.ga();this.C<b.length&&(pc$1(this),tc(this,a,b),this.i&&4!=a&&lc$1(this));}};function vc(a,b){var c=a.C,d=b.indexOf("\n",c);if(-1==d)return hc;c=Number(b.substring(c,d));if(isNaN(c))return gc;d+=1;if(d+c>b.length)return hc;b=b.substr(d,c);a.C=d+c;return b}k$1.cancel=function(){this.I=!0;P(this);};function lc$1(a){a.Y=Date.now()+a.P;xc(a,a.P);}
    ...
    function sc$1(a,b){try{var c=a.l;if(0!=c.G&&(c.g==a||yc(c.i,a)))if(c.I=a.N,!a.J&&yc(c.i,a)&&3==c.G){try{var d=c.Ca.g.parse(b);}catch(m){d=null;}if(Array.isArray(d)&&3==d.length){var e=d;if(0==e[0])a:{if(!c.u){if(c.g)if(c.g.F+3E3<a.F)zc$1(c),Ac$1(c);else break a;Bc$1(c);J$1(18);}}else c.ta=e[1],0<c.ta-c.U&&37500>e[2]&&c.N&&0==c.A&&!c.v&&(c.v=K$1(q(c.ab,c),6E3));if(1>=Cc(c.i)&&c.ka){try{c.ka();}catch(m){}c.ka=void 0;}}else Q$1(c,11);}else if((a.J||c.g==a)&&zc$1(c),!sa$1(b))for(e=c.Ca.g.parse(b),b=0;b<e.length;b++){let m=e[b];
    ...
    ca.g?ca.g.getResponseHeader("X-HTTP-Session-Id"):null;xb&&(d.sa=xb,R(d.F,d.D,xb));}}c.G=3;c.j&&c.j.xa();c.$&&(c.O=Date.now()-a.F,c.h.info("Handshake RTT: "+c.O+"ms"));d=c;var h=a;d.oa=Ec$1(d,d.H?d.la:null,d.W);if(h.J){Fc(d.i,h);var n=h,u=d.K;u&&n.setTimeout(u);n.B&&(pc$1(n),lc$1(n));d.g=h;}else Gc$1(d);0<c.l.length&&Hc$1(c);}else "stop"!=m[0]&&"close"!=m[0]||Q$1(c,7);else 3==c.G&&("stop"==m[0]||"close"==m[0]?"stop"==m[0]?Q$1(c,7):Ic$1(c):"noop"!=m[0]&&c.j&&c.j.wa(m),c.A=0);}I(4);}catch(m){}}function Jc$1(a){if(a.R&&"function"==typeof a.R)return a.R();if("string"===typeof a)return a.split("");if(ba$1(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}b=[];c=0;for(d in a)b[c++]=a[d];return b}
    ...
    function Oc(a,b,c){a.j=c?Tc$1(b,!0):b;a.j&&(a.j=a.j.replace(/:$/,""));}function Pc$1(a,b,c){a.i=c?Tc$1(b,!0):b;}function Qc(a,b){if(b){b=Number(b);if(isNaN(b)||0>b)throw Error("Bad port number "+b);a.m=b;}else a.m=null;}function Sc(a,b,c){b instanceof Rc$1?(a.h=b,Zc(a.h,a.g)):(c||(b=Uc(b,$c)),a.h=new Rc$1(b,a.g));}function R(a,b,c){a.h.set(b,c);}function jc(a){R(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36));return a}
    ...
    */
    ...
    const normaliseDate = (date) => stringToDate(dateToString(date));
    const getToday = () => normaliseDate(new Date());
    const getTomorrow = () => {
    ...
    const getMemesOfMonthFromDb = async (db, year, month) => {
        var _a;
    ...
    const getMemesOfMonth = (year, month, db) => {
        var _a;
        return (_a = getMemesOfMonthFromCache(year, month)) !== null && _a !== void 0 ? _a : getMemesOfMonthFromDb(db, year, month);
    };
    const getMemeOtd = async (db, d, n = 0) => {
        if (!d)
            return null;
        if (n >= 12)
    ...
    /* src/components/Meme.svelte generated by Svelte v3.49.0 */
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", `${/*className*/ ctx[3]} text-center`);
    			add_location(p, file$2, 24, 2, 540);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			img = element("img");
    			attr_dev(img, "class", img_class_value = /*className*/ ctx[3] + " md:w-1/2" + (isNaN(/*width*/ ctx[1]) ? " max-w-md" : ""));
    			...
    			add_location(img, file$2, 13, 2, 284);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*width*/ 2 && img_class_value !== (img_class_value = /*className*/ ctx[3] + " md:w-1/2" + (isNaN(/*width*/ ctx[1]) ? " max-w-md" : ""))) {
    ...
    /* src/components/Shelf.svelte generated by Svelte v3.49.0 */
    const file$1 = "src/components/Shelf.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 14, 6, 351);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	let td0;
    	let p0;
    	let t0_value = dateToString(/*date*/ ctx[0], "/") + "";
    	let t0;
    	let t1;
    	let p1;
    	let t2_value = (/*meme*/ ctx[1].found ? "Found by" : "By") + "";
    	let t2;
    	let t3;
    	let span;
    	let t4_value = /*meme*/ ctx[1].author + "";
    	let t4;
    	let t5;
    	let t6;
    	let td1;
    	let img;
    	let img_src_value;
    	let if_block = /*isTomorrow*/ ctx[2] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			td1 = element("td");
    			img = element("img");
    			add_location(p0, file$1, 8, 4, 187);
    			attr_dev(span, "class", "author");
    			add_location(span, file$1, 11, 6, 273);
    			add_location(p1, file$1, 9, 4, 224);
    			attr_dev(td0, "class", "text-center");
    			add_location(td0, file$1, 7, 2, 158);
    			attr_dev(img, "class", "min-w-[12rem] max-w-sm mx-auto w-1/2 sm:w-auto");
    			if (!src_url_equal(img.src, img_src_value = /*meme*/ ctx[1].url)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Meme");
    			add_location(img, file$1, 18, 4, 400);
    			add_location(td1, file$1, 17, 2, 391);
    			add_location(tr, file$1, 6, 0, 151);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*date*/ 1 && t0_value !== (t0_value = dateToString(/*date*/ ctx[0], "/") + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*meme*/ 2 && t2_value !== (t2_value = (/*meme*/ ctx[1].found ? "Found by" : "By") + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*meme*/ 2 && t4_value !== (t4_value = /*meme*/ ctx[1].author + "")) set_data_dev(t4, t4_value);
    			...
    			if (dirty & /*meme*/ 2 && !src_url_equal(img.src, img_src_value = /*meme*/ ctx[1].url)) {
    				attr_dev(img, "src", img_src_value);
    			}
    		},
    		i: noop,
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { date } = $$props;
    	let { meme } = $$props;
    	let { isTomorrow = false } = $$props;
    	const writable_props = ['date', 'meme', 'isTomorrow'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('isTomorrow' in $$props) $$invalidate(2, isTomorrow = $$props.isTomorrow);
    	};

    	$$self.$capture_state = () => ({ dateToString, date, meme, isTomorrow });
    	...
    	return [date, meme, isTomorrow];
    }

    class Shelf extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { date: 0, meme: 1, isTomorrow: 2 });
    		...
    		if (/*date*/ ctx[0] === undefined && !('date' in props)) {
    			console.warn("<Shelf> was created without expected prop 'date'");
    		}

    		if (/*meme*/ ctx[1] === undefined && !('meme' in props)) {
    			console.warn("<Shelf> was created without expected prop 'meme'");
    		}
    	}
    	...
    	set isTomorrow(value) {
    		throw new Error("<Shelf>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src/components/Archive.svelte generated by Svelte v3.49.0 */

    const { Object: Object_1 } = globals;
    const file = "src/components/Archive.svelte";
    ...
    // (100:4) {:then [archivedMemes, tomorrowMeme]}
    function create_then_block_1(ctx) {
    	...
    	let current;
    	let each_value = Object.keys(/*archivedMemes*/ ctx[20]).map(/*func*/ ctx[14]);
    	...
    	let if_block0 = /*tomorrowMeme*/ ctx[21] && !/*forwardsEnabled*/ ctx[3] && create_if_block_2(ctx);
    	let if_block1 = /*noMemes*/ ctx[5] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tbody, file, 100, 6, 3717);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*compoundDate, Object, memePromises, parseInt, month, year*/ 131) {
    				each_value = Object.keys(/*archivedMemes*/ ctx[20]).map(/*func*/ ctx[14]);
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (/*tomorrowMeme*/ ctx[21] && !/*forwardsEnabled*/ ctx[3]) {
    				if (if_block0) {
    					if_block0.p(ctx, dirty);

    					if (dirty & /*memePromises, forwardsEnabled*/ 136) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "then",
    		source: "(100:4) {:then [archivedMemes, tomorrowMeme]}",
    		ctx
    	});
    ...
    // (102:8) {#each Object.keys(archivedMemes).map(x => parseInt(x)) as date}
    function create_each_block(ctx) {
    	...
    	shelf = new Shelf({
    			props: {
    				date: compoundDate(/*date*/ ctx[23], /*month*/ ctx[0], /*year*/ ctx[1]),
    				meme: /*archivedMemes*/ ctx[20][/*date*/ ctx[23]]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const shelf_changes = {};
    			if (dirty & /*memePromises, month, year*/ 131) shelf_changes.date = compoundDate(/*date*/ ctx[23], /*month*/ ctx[0], /*year*/ ctx[1]);
    			if (dirty & /*memePromises*/ 128) shelf_changes.meme = /*archivedMemes*/ ctx[20][/*date*/ ctx[23]];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(102:8) {#each Object.keys(archivedMemes).map(x => parseInt(x)) as date}",
    		ctx
    	});
    ...
    // (108:8) {#if tomorrowMeme && !forwardsEnabled}
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const shelf_changes = {};
    			if (dirty & /*memePromises*/ 128) shelf_changes.meme = /*tomorrowMeme*/ ctx[21];
    			shelf.$set(shelf_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(108:8) {#if tomorrowMeme && !forwardsEnabled}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (dirty & /*month, year*/ 3) show_if = null;
    		if (show_if == null) show_if = !!(/*month*/ ctx[0] === separateDate(/*today*/ ctx[8])[1] && /*year*/ ctx[1] === separateDate(/*today*/ ctx[8])[2]);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tfoot, file, 115, 10, 4264);
    		},
    		m: function mount(target, anchor) {
    ...
    // (113:8) {#if month === separateDate(today)[1] && year === separateDate(today)[2]}
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tfoot, file, 113, 10, 4196);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tfoot, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(113:8) {#if month === separateDate(today)[1] && year === separateDate(today)[2]}",
    		ctx
    	});
    ...
    // (96:25)        <tfoot>         <Loader />       </tfoot>     {:then [archivedMemes, tomorrowMeme]}
    function create_pending_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tfoot, file, 96, 6, 3627);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tfoot, anchor);
    			mount_component(loader, tfoot, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(96:25)        <tfoot>         <Loader />       </tfoot>     {:then [archivedMemes, tomorrowMeme]}",
    		ctx
    	});
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			create_component(meme.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			const meme_changes = {};
    			if (dirty & /*queriedMemePromise*/ 64) meme_changes.url = /*queriedMeme*/ ctx[19]?.url;
    		...
    		o: function outro(local) {
    			transition_out(meme.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(meme, detaching);
    		}
    	};
    ...
    // (130:4) <Meme url={queriedMeme?.url}>
    function create_default_slot(ctx) {
    	let t;

    	const block = {
    		c: function create() {
    			t = text("No memes that day :(");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(130:4) <Meme url={queriedMeme?.url}>",
    		ctx
    	});
    ...
    // (127:29)      <Loader />   {:then queriedMeme}
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(127:29)      <Loader />   {:then queriedMeme}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	handle_promise(promise = /*memePromises*/ ctx[7], info);
    	...
    	handle_promise(promise_1 = /*queriedMemePromise*/ ctx[6], info_1);
    	...
    	const block = {
    		c: function create() {
    			...
    			h22 = element("h2");
    			h22.textContent = "Schedule a Meme";
    			t25 = space();
    			p2 = element("p");
    			a = element("a");
    			...
    			add_location(h20, file, 64, 2, 2586);
    			attr_dev(span0, "class", "-mt-1.5");
    			add_location(span0, file, 72, 8, 2888);
    			...
    			add_location(div0, file, 67, 6, 2685);
    			add_location(div1, file, 66, 4, 2673);
    			attr_dev(p0, "class", "flex-1 my-2 text-lg text-center");
    			add_location(p0, file, 75, 4, 2950);
    			attr_dev(span1, "class", "-mt-1.5");
    			add_location(span1, file, 84, 8, 3263);
    			...
    			add_location(div2, file, 79, 6, 3062);
    			add_location(div3, file, 78, 4, 3050);
    			attr_dev(div4, "class", "flex sm:w-2/3 md:w-1/2 lg:w-1/4 mx-auto my-4");
    			add_location(div4, file, 65, 2, 2610);
    			attr_dev(th0, "class", th0_class_value = "border-2" + (/*noMemes*/ ctx[5] ? " w-1/2" : ""));
    			add_location(th0, file, 91, 8, 3440);
    			attr_dev(th1, "class", th1_class_value = "border-2" + (/*noMemes*/ ctx[5] ? " w-1/2" : ""));
    			add_location(th1, file, 92, 8, 3509);
    			add_location(tr, file, 90, 6, 3427);
    			add_location(thead, file, 89, 4, 3413);
    			attr_dev(table, "class", "table-auto w-full max-w-4xl mx-auto border-light-fg border-2");
    			add_location(table, file, 88, 2, 3332);
    			attr_dev(main, "class", "min-w-min");
    			add_location(main, file, 63, 0, 2559);
    			add_location(hr0, file, 121, 0, 4360);
    			add_location(h21, file, 123, 2, 4379);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 124, 2, 4405);
    			attr_dev(p1, "class", "my-4");
    			add_location(p1, file, 125, 2, 4452);
    			add_location(section0, file, 122, 0, 4367);
    			add_location(hr1, file, 132, 0, 4647);
    			add_location(h22, file, 134, 2, 4666);
    			attr_dev(a, "class", "hover:underline");
    			attr_dev(a, "href", "schedule.html");
    			add_location(a, file, 136, 4, 4718);
    			attr_dev(p2, "class", "epilogue");
    			add_location(p2, file, 135, 2, 4693);
    			add_location(section1, file, 133, 0, 4654);
    			add_location(footer, file, 139, 0, 4804);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (!current || dirty & /*noMemes*/ 32 && th0_class_value !== (th0_class_value = "border-2" + (/*noMemes*/ ctx[5] ? " w-1/2" : ""))) {
    				attr_dev(th0, "class", th0_class_value);
    			}

    			if (!current || dirty & /*noMemes*/ 32 && th1_class_value !== (th1_class_value = "border-2" + (/*noMemes*/ ctx[5] ? " w-1/2" : ""))) {
    				attr_dev(th1, "class", th1_class_value);
    			}

    			info.ctx = ctx;

    			if (dirty & /*memePromises*/ 128 && promise !== (promise = /*memePromises*/ ctx[7]) && handle_promise(promise, info)) ; else {
    			...
    			if (dirty & /*queriedMemePromise*/ 64 && promise_1 !== (promise_1 = /*queriedMemePromise*/ ctx[6]) && handle_promise(promise_1, info_1)) ; else {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const getArchivedMemes = (db, year, month) => __awaiter(void 0, void 0, void 0, function* () {
    		var _a;

    		const memesOfMonth = (_a = yield getMemesOfMonth(year, month, db)) !== null && _a !== void 0
    		? _a
    		: {};

    		const archivedDates = Object.keys(memesOfMonth).map(x => parseInt(x)).sort((a, b) => a - b).filter(date => compoundDate(date, month, year) <= today);
    		const result = {};
    	...
    	$$self.$$set = $$props => {
    		if ('db' in $$props) $$invalidate(10, db = $$props.db);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('noMemes' in $$props) $$invalidate(5, noMemes = $$props.noMemes);
    		if ('queriedMemePromise' in $$props) $$invalidate(6, queriedMemePromise = $$props.queriedMemePromise);
    		if ('archivedMemesPromise' in $$props) $$invalidate(11, archivedMemesPromise = $$props.archivedMemesPromise);
    		if ('memePromises' in $$props) $$invalidate(7, memePromises = $$props.memePromises);
    	};
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*month, year*/ 3) {
    			$$invalidate(3, forwardsEnabled = !(separateDate(today)[1] === month && separateDate(today)[2] === year));
    		}
    		...
    		if ($$self.$$.dirty & /*db, year, month*/ 1027) {
    			$$invalidate(11, archivedMemesPromise = getArchivedMemes(db, year, month));
    		}

    		if ($$self.$$.dirty & /*archivedMemesPromise*/ 2048) {
    			$$invalidate(7, memePromises = Promise.all([archivedMemesPromise, tomorrowMemePromise]).then(results => {
    				const [archivedMemes, tomorrowMeme] = results;
    				$$invalidate(5, noMemes = !Object.keys(archivedMemes).length && !tomorrowMeme);
    				return results;
    			}));
    		}

    		if ($$self.$$.dirty & /*db, dateQuery*/ 1028) {
    			// TODO: Debounce
    			$$invalidate(6, queriedMemePromise = getMemeOtd(db, stringToDate(dateQuery)));
    		}
    	};
    ...
    class Archive extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { db: 10 });
    		...
    		if (/*db*/ ctx[10] === undefined && !('db' in props)) {
