var archive=function(){"use strict";
/**
     * @license
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function et(t="[DEFAULT]"){const e=Q.get(t);if(!e)throw Z.create("no-app",{appName:t});return e}function nt(t,e,n){var s;let i=null!==(s=G[t])&&void 0!==s?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const t=[`Unable to register library "${i}" with version "${e}":`];return r&&t.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&t.push("and"),o&&t.push(`version name "${e}" contains illegal characters (whitespace or "/")`),void z.warn(t.join(" "))}Y(new g(`${i}-version`,(()=>({library:i,version:e})),"VERSION"))}
/**
     * @license
     * Copyright 2021 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Vu{constructor(t,e,n,s,i){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.au=[],this.hu=new Map,this.lu=new Set,this.fu=[],this.du=i,this.du.Br((t=>{n.enqueueAndForget((async()=>{Gu(this)&&(Ur("RemoteStore","Restarting streams for network reachability change."),await async function(t){const e=Hr(t);e.lu.add(4),await Uu(e),e._u.set("Unknown"),e.lu.delete(4),await $u(e)}(this))}))})),this._u=new Fu(n,s)}}async function $u(t){if(Gu(t))for(const e of t.fu)await e(!0)}async function Uu(t){for(const e of t.fu)await e(!1)}function Bu(t,e){const n=Hr(t);n.hu.has(e.targetId)||(n.hu.set(e.targetId,e),Hu(n)?zu(n):th(n).Co()&&qu(n,e))}function ju(t,e){const n=Hr(t),s=th(n);n.hu.delete(e),s.Co()&&Ku(n,e),0===n.hu.size&&(s.Co()?s.ko():Gu(n)&&n._u.set("Unknown"))}function qu(t,e){t.wu.Nt(e.targetId),th(t).Qo(e)}function Ku(t,e){t.wu.Nt(e),th(t).jo(e)}function zu(t){t.wu=new kc({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),te:e=>t.hu.get(e)||null}),th(t).start(),t._u.iu()}function Hu(t){return Gu(t)&&!th(t).Do()&&t.hu.size>0}function Gu(t){return 0===Hr(t).lu.size}function Qu(t){t.wu=void 0}async function Wu(t){t.hu.forEach(((e,n)=>{qu(t,e)}))}async function Xu(t,e){Qu(t),Hu(t)?(t._u.uu(e),zu(t)):t._u.set("Unknown")}async function Yu(t,e,n){if(t._u.set("Online"),e instanceof Cc&&2===e.state&&e.cause)try{await async function(t,e){const n=e.cause;for(const s of e.targetIds)t.hu.has(s)&&(await t.remoteSyncer.rejectListen(s,n),t.hu.delete(s),t.wu.removeTarget(s))}(t,e)}catch(n){Ur("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),n),await Ju(t,n)}else if(e instanceof Ic?t.wu.Ut(e):e instanceof Sc?t.wu.zt(e):t.wu.Gt(e),!n.isEqual(uo.min()))try{const e=await Eu(t.localStore);n.compareTo(e)>=0&&await function(t,e){const n=t.wu.Yt(e);return n.targetChanges.forEach(((n,s)=>{if(n.resumeToken.approximateByteSize()>0){const i=t.hu.get(s);i&&t.hu.set(s,i.withResumeToken(n.resumeToken,e))}})),n.targetMismatches.forEach((e=>{const n=t.hu.get(e);if(!n)return;t.hu.set(e,n.withResumeToken(xo.EMPTY_BYTE_STRING,n.snapshotVersion)),Ku(t,e);const s=new Jc(n.target,e,1,n.sequenceNumber);qu(t,s)})),t.remoteSyncer.applyRemoteEvent(n)}(t,n)}catch(e){Ur("RemoteStore","Failed to raise snapshot:",e),await Ju(t,e)}}async function Ju(t,e,n){if(!Eo(e))throw e;t.lu.add(1),await Uu(t),t._u.set("Offline"),n||(n=()=>Eu(t.localStore)),t.asyncQueue.enqueueRetryable((async()=>{Ur("RemoteStore","Retrying IndexedDB access"),await n(),t.lu.delete(1),await $u(t)}))}async function Zu(t,e){const n=Hr(t);n.asyncQueue.verifyOperationInProgress(),Ur("RemoteStore","RemoteStore received new credentials");const s=Gu(n);n.lu.add(3),await Uu(n),s&&n._u.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.lu.delete(3),await $u(n)}function th(t){return t.mu||(t.mu=function(t,e,n){const s=Hr(t);return s.tu(),new Mu(e,s.bo,s.authCredentials,s.appCheckCredentials,s.wt,n)
/**
     * @license
     * Copyright 2018 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Jh{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new Qr(Gr.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new Qr(Gr.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return oo(this._lat,t._lat)||oo(this._long,t._long)}}const Zh=new RegExp("[~\\*/\\[\\]]");function tl(t,e,n,s,i){const r=s&&!s.isEmpty(),o=void 0!==i;let a=`Function ${e}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(r||o)&&(c+=" (found",r&&(c+=` in field ${s}`),o&&(c+=` in document ${i}`),c+=")"),new Qr(Gr.INVALID_ARGUMENT,a+t+c)
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(fetch.bind(self));const gl=function(t,e={}){if("object"!=typeof e){e={name:e}}const n=Object.assign({name:H,automaticDataCollectionEnabled:!1},e),s=n.name;if("string"!=typeof s||!s)throw Z.create("bad-app-name",{appName:String(s)});const i=Q.get(s);if(i){if(l(t,i.options)&&l(n,i.config))return i;throw Z.create("duplicate-app",{appName:s})}const r=new v(s);for(const t of W.values())r.addComponent(t);const o=new tt(t,n,r);return Q.set(s,o),o}({apiKey:"AIzaSyDfGaweLVDXcfxJDZ4ztoMoilhU9fv4uXU",authDomain:"pmpirate.firebaseapp.com",projectId:"pmpirate",storageBucket:"pmpirate.appspot.com",messagingSenderId:"198590478768",appId:"1:198590478768:web:3d10abd6d006c0a0b93e75",measurementId:"G-19MDLJEYQG"});!function(t=et()){const e=J(t=p(t),te);e.isInitialized()?e.getImmediate():function(t,e={}){const n=J(t,te);if(n.isInitialized()){const t=n.getImmediate();if(l(e,n.getOptions()))return t;throw re.create("already-initialized")}n.initialize({options:e})}(t)}(gl);const ml=function(t=et()){return J(t,"firestore").getImmediate()}(gl),yl=function(t=et(),e="us-central1"){return J(p(t),ul).getImmediate({identifier:e})}(gl,"europe-west2");var vl,wl;function bl(){}function El(t){return t()}function Tl(){return Object.create(null)}function Il(t){t.forEach(El)}function Sl(t){return"function"==typeof t}function Cl(t,e){return t!=t?e==e:t!==e||t&&"object"==typeof t||"function"==typeof t}let Al,kl;function Dl(t,e){return Al||(Al=document.createElement("a")),Al.href=e,t===Al.href}function _l(t,e,n,s){return t[1]&&s?function(t,e){for(const n in e)t[n]=e[n];return t}(n.ctx.slice(),t[1](s(e))):n.ctx}function Nl(t,e){t.appendChild(e)}function xl(t,e,n){t.insertBefore(e,n||null)}function Ll(t){t.parentNode.removeChild(t)}function Ol(t){return document.createElement(t)}function Rl(t){return document.createTextNode(t)}function Ml(){return Rl(" ")}function Pl(){return Rl("")}function Fl(t,e,n,s){return t.addEventListener(e,n,s),()=>t.removeEventListener(e,n,s)}function Vl(t,e,n){null==n?t.removeAttribute(e):t.getAttribute(e)!==n&&t.setAttribute(e,n)}function $l(t,e){e=""+e,t.wholeText!==e&&(t.data=e)}function Ul(t,e){t.value=null==e?"":e}function Bl(t){kl=t}function jl(){if(!kl)throw new Error("Function called outside component initialization");return kl}(location.href.includes("localhost")||location.href.includes("127.0.0.1"))&&(function(t,e,s,i={}){var r;const o=(t=Bh(t,qh))._getSettings();if("firestore.googleapis.com"!==o.host&&o.host!==e&&jr("Host has been set in both settings() and useEmulator(), emulator host will be used"),t._setSettings(Object.assign(Object.assign({},o),{host:`${e}:${s}`,ssl:!1})),i.mockUserToken){let e,s;if("string"==typeof i.mockUserToken)e=i.mockUserToken,s=Pr.MOCK_USER;else{e=function(t,e){if(t.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const s=e||"demo-project",i=t.iat||0,r=t.sub||t.user_id;if(!r)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const o=Object.assign({iss:`https://securetoken.google.com/${s}`,aud:s,iat:i,exp:i+3600,auth_time:i,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}}},t);return[n(JSON.stringify({alg:"none",type:"JWT"})),n(JSON.stringify(o)),""].join(".")}(i.mockUserToken,null===(r=t._app)||void 0===r?void 0:r.options.projectId);const o=i.mockUserToken.sub||i.mockUserToken.user_id;if(!o)throw new Qr(Gr.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");s=new Pr(o)}t._authCredentials=new Jr(new Xr(e,s))}}(ml,"localhost",8080),vl="localhost",wl=5001,function(t,e,n){t.emulatorOrigin=`http://${e}:${n}`}(p(yl),vl,wl));const ql=[],Kl=[],zl=[],Hl=[],Gl=Promise.resolve();let Ql=!1;function Wl(t){zl.push(t)}const Xl=new Set;let Yl=0;function Jl(){const t=kl;do{for(;Yl<ql.length;){const t=ql[Yl];Yl++,Bl(t),Zl(t.$$)}for(Bl(null),ql.length=0,Yl=0;Kl.length;)Kl.pop()();for(let t=0;t<zl.length;t+=1){const e=zl[t];Xl.has(e)||(Xl.add(e),e())}zl.length=0}while(ql.length);for(;Hl.length;)Hl.pop()();Ql=!1,Xl.clear(),Bl(t)}function Zl(t){if(null!==t.fragment){t.update(),Il(t.before_update);const e=t.dirty;t.dirty=[-1],t.fragment&&t.fragment.p(t.ctx,e),t.after_update.forEach(Wl)}}const td=new Set;let ed;function nd(){ed={r:0,c:[],p:ed}}function sd(){ed.r||Il(ed.c),ed=ed.p}function id(t,e){t&&t.i&&(td.delete(t),t.i(e))}function rd(t,e,n,s){if(t&&t.o){if(td.has(t))return;td.add(t),ed.c.push((()=>{td.delete(t),s&&(n&&t.d(1),s())})),t.o(e)}else s&&s()}function od(t,e){const n=e.token={};function s(t,s,i,r){if(e.token!==n)return;e.resolved=r;let o=e.ctx;void 0!==i&&(o=o.slice(),o[i]=r);const a=t&&(e.current=t)(o);let c=!1;e.block&&(e.blocks?e.blocks.forEach(((t,n)=>{n!==s&&t&&(nd(),rd(t,1,1,(()=>{e.blocks[n]===t&&(e.blocks[n]=null)})),sd())})):e.block.d(1),a.c(),id(a,1),a.m(e.mount(),e.anchor),c=!0),e.block=a,e.blocks&&(e.blocks[s]=a),c&&Jl()}if((i=t)&&"object"==typeof i&&"function"==typeof i.then){const n=jl();if(t.then((t=>{Bl(n),s(e.then,1,e.value,t),Bl(null)}),(t=>{if(Bl(n),s(e.catch,2,e.error,t),Bl(null),!e.hasCatch)throw t})),e.current!==e.pending)return s(e.pending,0),!0}else{if(e.current!==e.then)return s(e.then,1,e.value,t),!0;e.resolved=t}var i}function ad(t,e,n){const s=e.slice(),{resolved:i}=t;t.current===t.then&&(s[t.value]=i),t.current===t.catch&&(s[t.error]=i),t.block.p(s,n)}function cd(t){t&&t.c()}function ud(t,e,n,s){const{fragment:i,on_mount:r,on_destroy:o,after_update:a}=t.$$;i&&i.m(e,n),s||Wl((()=>{const e=r.map(El).filter(Sl);o?o.push(...e):Il(e),t.$$.on_mount=[]})),a.forEach(Wl)}function hd(t,e){const n=t.$$;null!==n.fragment&&(Il(n.on_destroy),n.fragment&&n.fragment.d(e),n.on_destroy=n.fragment=null,n.ctx=[])}function ld(t,e){-1===t.$$.dirty[0]&&(ql.push(t),Ql||(Ql=!0,Gl.then(Jl)),t.$$.dirty.fill(0)),t.$$.dirty[e/31|0]|=1<<e%31}function dd(t,e,n,s,i,r,o,a=[-1]){const c=kl;Bl(t);const u=t.$$={fragment:null,ctx:null,props:r,update:bl,not_equal:i,bound:Tl(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(c?c.$$.context:[])),callbacks:Tl(),dirty:a,skip_bound:!1,root:e.target||c.$$.root};o&&o(u.root);let h=!1;if(u.ctx=n?n(t,e.props||{},((e,n,...s)=>{const r=s.length?s[0]:n;return u.ctx&&i(u.ctx[e],u.ctx[e]=r)&&(!u.skip_bound&&u.bound[e]&&u.bound[e](r),h&&ld(t,e)),n})):[],u.update(),h=!0,Il(u.before_update),u.fragment=!!s&&s(u.ctx),e.target){if(e.hydrate){const t=function(t){return Array.from(t.childNodes)}(e.target);u.fragment&&u.fragment.l(t),t.forEach(Ll)}else u.fragment&&u.fragment.c();e.intro&&id(t.$$.fragment),ud(t,e.target,e.anchor,e.customElement),Jl()}Bl(c)}class fd{$destroy(){hd(this,1),this.$destroy=bl}$on(t,e){const n=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return n.push(e),()=>{const t=n.indexOf(e);-1!==t&&n.splice(t,1)}}$set(t){var e;this.$$set&&(e=t,0!==Object.keys(e).length)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}const pd=t=>{const e=parseInt(t);if(!isNaN(e))return e;const n=["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"].indexOf(t);return-1===n?n+1:NaN},gd=t=>[t.getDate(),t.getMonth()+1,t.getFullYear()],md=(t,e,n)=>new Date(n,e-1,t),yd=(t,e="/",n=!1)=>{const[s,i,r]=gd(t).map((t=>`${t}`)),o=[s.padStart(2,"0"),i.padStart(2,"0"),r];return(n?o.reverse():o).join(e)},vd=t=>{const e=`${t}`;return e.length<=2?vd("20"+e.padStart(2,"0")):3===e.length?NaN:parseInt(e)},wd=t=>{const e=["/","-","."];for(const n of e){const[e,s,i]=t.split(n).map(pd),r=md(null!=e?e:NaN,null!=s?s:NaN,vd(null!=i?i:NaN));if(![e,s,i].some((t=>!t))&&"Invalid Date"!=`${r}`)return r}for(const n of e){const[e,s,i]=t.split(n).map(pd),r=md(null!=i?i:NaN,null!=s?s:NaN,vd(null!=e?e:NaN));if(![i,s,e].some((t=>!t))&&"Invalid Date"!=`${r}`)return r}const n=new Date(t);if("Invalid Date"!=`${n}`)return n},bd=()=>{return t=new Date,wd(yd(t));var t},Ed={},Td=new Set,Id=md(1,9,2021);async function Sd(t,e,n){try{return console.count("DB reads"),console.count(n),(await al(function(t,e,...n){if(t=p(t),1===arguments.length&&(e=ro.I()),$h("doc","path",e),t instanceof qh){const s=lo.fromString(e,...n);return Uh(s),new Kh(t,null,new go(s))}{if(!(t instanceof Kh||t instanceof Hh))throw new Qr(Gr.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=t._path.child(lo.fromString(e,...n));return Uh(s),new Kh(t.firestore,t instanceof Hh?t.converter:null,new go(s))}}(t,e,n))).data()}catch(t){console.warn("Your DB emulations are likely not running correctly"),console.error(t)}}const Cd=(t,e)=>{const n=md(1,e,t),s=bd(),i=gd(s)[2];return Id<=n&&t<=i},Ad=async(t,e,n)=>{var s;if(!Cd(e,n))return null;const i=((t,e)=>`${t}-${`${e}`.padStart(2,"0")}`)(e,n);if(Td.has(i))return await(r=1,new Promise((t=>setTimeout(t,1e3*r)))),kd(e,n);var r;Td.add(i);const o=null!==(s=await Sd(t,"memes",i))&&void 0!==s?s:{};return((t,e,n)=>{Ed[t]||(Ed[t]={}),Ed[t][e]=n})(e,n,o),Td.delete(i),o},kd=(t,e)=>{try{return Ed[t][e]}catch(t){console.count("Cache errors")}},Dd=(t,e,n)=>{var s;return null!==(s=kd(t,e))&&void 0!==s?s:Ad(n,t,e)},_d=async(t,e,n=0)=>{if(!e)return null;if(n>=12)throw new Error("DB recursion");const[s,i,r]=gd(e);if(!Cd(r,i))return null;try{return Ed[r][i][s]}catch(t){console.count("Cache errors")}return await Dd(r,i,t),_d(t,e,n+1)};function Nd(t){let e;return{c(){e=Ol("header"),e.innerHTML='<a class="flex" href="/"><img class="inline-block" style="height: 2.5em;" src="./favicon.png" alt="Logo"/> \n    <h1 class="inline-block ml-4">Physics &amp; Maths Pirate</h1></a>',Vl(e,"class","my-8")},m(t,n){xl(t,e,n)},p:bl,i:bl,o:bl,d(t){t&&Ll(e)}}}class xd extends fd{constructor(t){super(),dd(this,t,null,Nd,Cl,{})}}function Ld(t){let e;return{c(){e=Ol("footer")},m(t,n){xl(t,e,n)},p:bl,i:bl,o:bl,d(t){t&&Ll(e)}}}class Od extends fd{constructor(t){super(),dd(this,t,null,Ld,Cl,{})}}function Rd(t){let e;return{c(){e=Ol("p"),e.textContent="It's loading, bro..."},m(t,n){xl(t,e,n)},p:bl,i:bl,o:bl,d(t){t&&Ll(e)}}}class Md extends fd{constructor(t){super(),dd(this,t,null,Rd,Cl,{})}}function Pd(t){let e,n;const s=t[4].default,i=function(t,e,n,s){if(t){const i=_l(t,e,n,s);return t[0](i)}}(s,t,t[3],null),r=i||function(t){let e;return{c(){e=Rl(Ud)},m(t,n){xl(t,e,n)},p:bl,d(t){t&&Ll(e)}}}();return{c(){e=Ol("p"),r&&r.c(),Vl(e,"class",`${$d} text-center`)},m(t,s){xl(t,e,s),r&&r.m(e,null),n=!0},p(t,e){i&&i.p&&(!n||8&e)&&function(t,e,n,s,i,r){if(i){const o=_l(e,n,s,r);t.p(o,i)}}(i,s,t,t[3],n?function(t,e,n,s){if(t[2]&&s){const i=t[2](s(n));if(void 0===e.dirty)return i;if("object"==typeof i){const t=[],n=Math.max(e.dirty.length,i.length);for(let s=0;s<n;s+=1)t[s]=e.dirty[s]|i[s];return t}return e.dirty|i}return e.dirty}(s,t[3],e,null):function(t){if(t.ctx.length>32){const e=[],n=t.ctx.length/32;for(let t=0;t<n;t++)e[t]=-1;return e}return-1}(t[3]),null)},i(t){n||(id(r,t),n=!0)},o(t){rd(r,t),n=!1},d(t){t&&Ll(e),r&&r.d(t)}}}function Fd(t){let e,n,s,i,r,o;return{c(){e=Ol("img"),Vl(e,"class",n=$d+" md:w-1/2"+(isNaN(t[1])?" max-w-md":"")),Vl(e,"style",s=t[1]?`width: ${t[1]}px`:""),Dl(e.src,i=t[0])||Vl(e,"src",i),Vl(e,"alt","Meme")},m(n,s){xl(n,e,s),r||(o=Fl(e,"error",t[5]),r=!0)},p(t,r){2&r&&n!==(n=$d+" md:w-1/2"+(isNaN(t[1])?" max-w-md":""))&&Vl(e,"class",n),2&r&&s!==(s=t[1]?`width: ${t[1]}px`:"")&&Vl(e,"style",s),1&r&&!Dl(e.src,i=t[0])&&Vl(e,"src",i)},i:bl,o:bl,d(t){t&&Ll(e),r=!1,o()}}}function Vd(t){let e,n,s,i;const r=[Fd,Pd],o=[];function a(t,e){return t[0]&&!t[2]?0:1}return e=a(t),n=o[e]=r[e](t),{c(){n.c(),s=Pl()},m(t,n){o[e].m(t,n),xl(t,s,n),i=!0},p(t,[i]){let c=e;e=a(t),e===c?o[e].p(t,i):(nd(),rd(o[c],1,1,(()=>{o[c]=null})),sd(),n=o[e],n?n.p(t,i):(n=o[e]=r[e](t),n.c()),id(n,1),n.m(s.parentNode,s))},i(t){i||(id(n),i=!0)},o(t){rd(n),i=!1},d(t){o[e].d(t),t&&Ll(s)}}}let $d="mx-auto w-full sm:w-4/6";const Ud="Couldn't load meme :(";function Bd(t,e,n){let{$$slots:s={},$$scope:i}=e,{url:r=""}=e,{width:o=NaN}=e,a=!1;return t.$$set=t=>{"url"in t&&n(0,r=t.url),"width"in t&&n(1,o=t.width),"$$scope"in t&&n(3,i=t.$$scope)},t.$$.update=()=>{1&t.$$.dirty&&n(2,a=!1)},[r,o,a,i,s,()=>{n(2,a=!0),console.log("Detected error")}]}class jd extends fd{constructor(t){super(),dd(this,t,Bd,Vd,Cl,{url:0,width:1})}}function qd(t){let e;return{c(){e=Ol("p"),e.textContent="(Sneak peek)"},m(t,n){xl(t,e,n)},d(t){t&&Ll(e)}}}function Kd(t){let e,n,s,i,r,o,a,c,u,h,l,d,f,p,g,m=yd(t[0],"/")+"",y=t[1].found?"Found by":"By",v=t[1].author+"",w=t[2]&&qd();return{c(){e=Ol("tr"),n=Ol("td"),s=Ol("p"),i=Rl(m),r=Ml(),o=Ol("p"),a=Rl(y),c=Ml(),u=Ol("span"),h=Rl(v),l=Ml(),w&&w.c(),d=Ml(),f=Ol("td"),p=Ol("img"),Vl(u,"class","author"),Vl(n,"class","text-center"),Vl(p,"class","min-w-[12rem] max-w-sm mx-auto w-1/2 sm:w-auto"),Dl(p.src,g=t[1].url)||Vl(p,"src",g),Vl(p,"alt","Meme")},m(t,g){xl(t,e,g),Nl(e,n),Nl(n,s),Nl(s,i),Nl(n,r),Nl(n,o),Nl(o,a),Nl(o,c),Nl(o,u),Nl(u,h),Nl(n,l),w&&w.m(n,null),Nl(e,d),Nl(e,f),Nl(f,p)},p(t,[e]){1&e&&m!==(m=yd(t[0],"/")+"")&&$l(i,m),2&e&&y!==(y=t[1].found?"Found by":"By")&&$l(a,y),2&e&&v!==(v=t[1].author+"")&&$l(h,v),t[2]?w||(w=qd(),w.c(),w.m(n,null)):w&&(w.d(1),w=null),2&e&&!Dl(p.src,g=t[1].url)&&Vl(p,"src",g)},i:bl,o:bl,d(t){t&&Ll(e),w&&w.d()}}}function zd(t,e,n){let{date:s}=e,{meme:i}=e,{isTomorrow:r=!1}=e;return t.$$set=t=>{"date"in t&&n(0,s=t.date),"meme"in t&&n(1,i=t.meme),"isTomorrow"in t&&n(2,r=t.isTomorrow)},[s,i,r]}class Hd extends fd{constructor(t){super(),dd(this,t,zd,Kd,Cl,{date:0,meme:1,isTomorrow:2})}}function Gd(t){t[20]=t[22][0],t[21]=t[22][1]}function Qd(t,e,n){const s=t.slice();return s[23]=e[n],s}function Wd(t){return{c:bl,m:bl,p:bl,i:bl,o:bl,d:bl}}function Xd(t){let e,n,s,i,r;Gd(t);let o=Object.keys(t[20]).map(t[14]),a=[];for(let e=0;e<o.length;e+=1)a[e]=Yd(Qd(t,o,e));const c=t=>rd(a[t],1,1,(()=>{a[t]=null}));let u=t[21]&&!t[3]&&Jd(t),h=t[5]&&Zd(t);return{c(){e=Ol("tbody");for(let t=0;t<a.length;t+=1)a[t].c();n=Ml(),u&&u.c(),s=Ml(),h&&h.c(),i=Pl()},m(t,o){xl(t,e,o);for(let t=0;t<a.length;t+=1)a[t].m(e,null);Nl(e,n),u&&u.m(e,null),xl(t,s,o),h&&h.m(t,o),xl(t,i,o),r=!0},p(t,s){if(Gd(t),131&s){let i;for(o=Object.keys(t[20]).map(t[14]),i=0;i<o.length;i+=1){const r=Qd(t,o,i);a[i]?(a[i].p(r,s),id(a[i],1)):(a[i]=Yd(r),a[i].c(),id(a[i],1),a[i].m(e,n))}for(nd(),i=o.length;i<a.length;i+=1)c(i);sd()}t[21]&&!t[3]?u?(u.p(t,s),136&s&&id(u,1)):(u=Jd(t),u.c(),id(u,1),u.m(e,null)):u&&(nd(),rd(u,1,1,(()=>{u=null})),sd()),t[5]?h?h.p(t,s):(h=Zd(t),h.c(),h.m(i.parentNode,i)):h&&(h.d(1),h=null)},i(t){if(!r){for(let t=0;t<o.length;t+=1)id(a[t]);id(u),r=!0}},o(t){a=a.filter(Boolean);for(let t=0;t<a.length;t+=1)rd(a[t]);rd(u),r=!1},d(t){t&&Ll(e),function(t,e){for(let n=0;n<t.length;n+=1)t[n]&&t[n].d(e)}(a,t),u&&u.d(),t&&Ll(s),h&&h.d(t),t&&Ll(i)}}}function Yd(t){let e,n;return e=new Hd({props:{date:md(t[23],t[0],t[1]),meme:t[20][t[23]]}}),{c(){cd(e.$$.fragment)},m(t,s){ud(e,t,s),n=!0},p(t,n){const s={};131&n&&(s.date=md(t[23],t[0],t[1])),128&n&&(s.meme=t[20][t[23]]),e.$set(s)},i(t){n||(id(e.$$.fragment,t),n=!0)},o(t){rd(e.$$.fragment,t),n=!1},d(t){hd(e,t)}}}function Jd(t){let e,n;return e=new Hd({props:{date:t[9],meme:t[21],isTomorrow:!0}}),{c(){cd(e.$$.fragment)},m(t,s){ud(e,t,s),n=!0},p(t,n){const s={};128&n&&(s.meme=t[21]),e.$set(s)},i(t){n||(id(e.$$.fragment,t),n=!0)},o(t){rd(e.$$.fragment,t),n=!1},d(t){hd(e,t)}}}function Zd(t){let e,n;function s(t,n){return 3&n&&(e=null),null==e&&(e=!(t[0]!==gd(t[8])[1]||t[1]!==gd(t[8])[2])),e?ef:tf}let i=s(t,-1),r=i(t);return{c(){r.c(),n=Pl()},m(t,e){r.m(t,e),xl(t,n,e)},p(t,e){i!==(i=s(t,e))&&(r.d(1),r=i(t),r&&(r.c(),r.m(n.parentNode,n)))},d(t){r.d(t),t&&Ll(n)}}}function tf(t){let e;return{c(){e=Ol("tfoot"),e.textContent="No memes that month :("},m(t,n){xl(t,e,n)},d(t){t&&Ll(e)}}}function ef(t){let e;return{c(){e=Ol("tfoot"),e.textContent="No memes yet this month :("},m(t,n){xl(t,e,n)},d(t){t&&Ll(e)}}}function nf(t){let e,n,s;return n=new Md({}),{c(){e=Ol("tfoot"),cd(n.$$.fragment)},m(t,i){xl(t,e,i),ud(n,e,null),s=!0},p:bl,i(t){s||(id(n.$$.fragment,t),s=!0)},o(t){rd(n.$$.fragment,t),s=!1},d(t){t&&Ll(e),hd(n)}}}function sf(t){return{c:bl,m:bl,p:bl,i:bl,o:bl,d:bl}}function rf(t){let e,n;return e=new jd({props:{url:t[19]?.url,$$slots:{default:[of]},$$scope:{ctx:t}}}),{c(){cd(e.$$.fragment)},m(t,s){ud(e,t,s),n=!0},p(t,n){const s={};64&n&&(s.url=t[19]?.url),67108864&n&&(s.$$scope={dirty:n,ctx:t}),e.$set(s)},i(t){n||(id(e.$$.fragment,t),n=!0)},o(t){rd(e.$$.fragment,t),n=!1},d(t){hd(e,t)}}}function of(t){let e;return{c(){e=Rl("No memes that day :(")},m(t,n){xl(t,e,n)},d(t){t&&Ll(e)}}}function af(t){let e,n;return e=new Md({}),{c(){cd(e.$$.fragment)},m(t,s){ud(e,t,s),n=!0},p:bl,i(t){n||(id(e.$$.fragment,t),n=!0)},o(t){rd(e.$$.fragment,t),n=!1},d(t){hd(e,t)}}}function cf(t){let e,n,s,i,r,o,a,c,u,h,l,d,f,p,g,m,y,v,w,b,E,T,I,S,C,A,k,D,_,N,x,L,O,R,M,P,F,V,$,U,B,j,q,K,z,H,G,Q,W,X,Y,J,Z,tt=`${t[0]}`.padStart(2,"0")+"";e=new xd({});let et={ctx:t,current:null,token:null,hasCatch:!1,pending:nf,then:Xd,catch:Wd,value:22,blocks:[,,,]};od(O=t[7],et);let nt={ctx:t,current:null,token:null,hasCatch:!1,pending:af,then:rf,catch:sf,value:19,blocks:[,,,]};return od(K=t[6],nt),X=new Od({}),{c(){cd(e.$$.fragment),n=Ml(),s=Ol("main"),i=Ol("h2"),i.textContent="Meme Archive",r=Ml(),o=Ol("div"),a=Ol("div"),c=Ol("div"),u=Ol("span"),u.textContent="<",l=Ml(),d=Ol("p"),f=Rl(tt),p=Rl("/"),g=Rl(t[1]),m=Ml(),y=Ol("div"),v=Ol("div"),w=Ol("span"),w.textContent=">",E=Ml(),T=Ol("table"),I=Ol("thead"),S=Ol("tr"),C=Ol("th"),A=Rl("Date"),D=Ml(),_=Ol("th"),N=Rl("Meme"),L=Ml(),et.block.c(),R=Ml(),M=Ol("hr"),P=Ml(),F=Ol("section"),V=Ol("h2"),V.textContent="Specify a Date",$=Ml(),U=Ol("input"),B=Ml(),j=Ol("p"),j.textContent="DVS-style dates accepted",q=Ml(),nt.block.c(),z=Ml(),H=Ol("hr"),G=Ml(),Q=Ol("section"),Q.innerHTML='<h2>Schedule a Meme</h2> \n  <p class="epilogue"><a class="hover:underline" href="schedule.html">Schedule a Meme</a></p>',W=Ml(),cd(X.$$.fragment),Vl(u,"class","-mt-1.5"),Vl(c,"class","flex-1 btn min-w-[3rem] max-w-[5rem] h-[3rem] max-h-full font-mono text-3xl"),Vl(c,"disabled",h=!t[4]),Vl(d,"class","flex-1 my-2 text-lg text-center"),Vl(w,"class","-mt-1.5"),Vl(v,"class","flex-1 btn min-w-[3rem] max-w-[5rem] h-[3rem] max-h-full font-mono text-3xl"),Vl(v,"disabled",b=!t[3]),Vl(o,"class","flex sm:w-2/3 md:w-1/2 lg:w-1/4 mx-auto my-4"),Vl(C,"class",k="border-2"+(t[5]?" w-1/2":"")),Vl(_,"class",x="border-2"+(t[5]?" w-1/2":"")),Vl(T,"class","table-auto w-full max-w-4xl mx-auto border-light-fg border-2"),Vl(s,"class","min-w-min"),Vl(U,"type","text"),Vl(j,"class","my-4")},m(h,b){ud(e,h,b),xl(h,n,b),xl(h,s,b),Nl(s,i),Nl(s,r),Nl(s,o),Nl(o,a),Nl(a,c),Nl(c,u),Nl(o,l),Nl(o,d),Nl(d,f),Nl(d,p),Nl(d,g),Nl(o,m),Nl(o,y),Nl(y,v),Nl(v,w),Nl(s,E),Nl(s,T),Nl(T,I),Nl(I,S),Nl(S,C),Nl(C,A),Nl(S,D),Nl(S,_),Nl(_,N),Nl(T,L),et.block.m(T,et.anchor=null),et.mount=()=>T,et.anchor=null,xl(h,R,b),xl(h,M,b),xl(h,P,b),xl(h,F,b),Nl(F,V),Nl(F,$),Nl(F,U),Ul(U,t[2]),Nl(F,B),Nl(F,j),Nl(F,q),nt.block.m(F,nt.anchor=null),nt.mount=()=>F,nt.anchor=null,xl(h,z,b),xl(h,H,b),xl(h,G,b),xl(h,Q,b),xl(h,W,b),ud(X,h,b),Y=!0,J||(Z=[Fl(c,"click",t[12]),Fl(v,"click",t[13]),Fl(U,"input",t[15])],J=!0)},p(e,[n]){t=e,(!Y||16&n&&h!==(h=!t[4]))&&Vl(c,"disabled",h),(!Y||1&n)&&tt!==(tt=`${t[0]}`.padStart(2,"0")+"")&&$l(f,tt),(!Y||2&n)&&$l(g,t[1]),(!Y||8&n&&b!==(b=!t[3]))&&Vl(v,"disabled",b),(!Y||32&n&&k!==(k="border-2"+(t[5]?" w-1/2":"")))&&Vl(C,"class",k),(!Y||32&n&&x!==(x="border-2"+(t[5]?" w-1/2":"")))&&Vl(_,"class",x),et.ctx=t,128&n&&O!==(O=t[7])&&od(O,et)||ad(et,t,n),4&n&&U.value!==t[2]&&Ul(U,t[2]),nt.ctx=t,64&n&&K!==(K=t[6])&&od(K,nt)||ad(nt,t,n)},i(t){Y||(id(e.$$.fragment,t),id(et.block),id(nt.block),id(X.$$.fragment,t),Y=!0)},o(t){rd(e.$$.fragment,t);for(let t=0;t<3;t+=1){rd(et.blocks[t])}for(let t=0;t<3;t+=1){rd(nt.blocks[t])}rd(X.$$.fragment,t),Y=!1},d(t){hd(e,t),t&&Ll(n),t&&Ll(s),et.block.d(),et.token=null,et=null,t&&Ll(R),t&&Ll(M),t&&Ll(P),t&&Ll(F),nt.block.d(),nt.token=null,nt=null,t&&Ll(z),t&&Ll(H),t&&Ll(G),t&&Ll(Q),t&&Ll(W),hd(X,t),J=!1,Il(Z)}}}function uf(t,e,n){let s,i,r;var o=this&&this.__awaiter||function(t,e,n,s){return new(n||(n=Promise))((function(i,r){function o(t){try{c(s.next(t))}catch(t){r(t)}}function a(t){try{c(s.throw(t))}catch(t){r(t)}}function c(t){var e;t.done?i(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e)}))).then(o,a)}c((s=s.apply(t,e||[])).next())}))};let{db:a}=e;const c=bd(),u=(()=>{const[t,e,n]=gd(bd());return md(t+1,e,n)})(),h=_d(a,u);let[,l,d]=gd(c),f=yd(c),p=!0,g=!0,m=!1;return t.$$set=t=>{"db"in t&&n(10,a=t.db)},t.$$.update=()=>{3&t.$$.dirty&&(l<1?(n(0,l=12),n(1,d--,d)):l>12&&(n(0,l=1),n(1,d++,d))),3&t.$$.dirty&&n(3,p=!(gd(c)[1]===l&&gd(c)[2]===d)),3&t.$$.dirty&&n(4,g=Id<md(1,l,d)),1027&t.$$.dirty&&n(11,s=((t,e,n)=>o(void 0,void 0,void 0,(function*(){var s;const i=null!==(s=yield Dd(e,n,t))&&void 0!==s?s:{},r=Object.keys(i).map((t=>parseInt(t))).sort(((t,e)=>t-e)).filter((t=>md(t,n,e)<=c)),o={};for(const t of r)o[t]=i[t];return o})))(a,d,l)),2048&t.$$.dirty&&n(7,i=Promise.all([s,h]).then((t=>{const[e,s]=t;return n(5,m=!Object.keys(e).length&&!s),t}))),1028&t.$$.dirty&&n(6,r=_d(a,wd(f)))},[l,d,f,p,g,m,r,i,c,u,a,s,()=>g&&n(0,l--,l),()=>p&&n(0,l++,l),t=>parseInt(t),function(){f=this.value,n(2,f)}]}return new class extends fd{constructor(t){super(),dd(this,t,uf,cf,Cl,{db:10})}}({target:document.body,props:{db:ml}})}();
