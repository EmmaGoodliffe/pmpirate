    ...
    */
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 12, 6, 363);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			td1 = element("td");
    			img = element("img");
    			add_location(p0, file$1, 9, 4, 231);
    			attr_dev(span, "class", "font-bold italic");
    			add_location(span, file$1, 10, 16, 280);
    			add_location(p1, file$1, 10, 4, 268);
    			attr_dev(td0, "class", "text-center");
    			add_location(td0, file$1, 8, 2, 202);
    			...
    			add_location(img, file$1, 16, 4, 412);
    			add_location(td1, file$1, 15, 2, 403);
    			add_location(tr, file$1, 7, 0, 195);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*credit*/ 8) set_data_dev(t2, /*credit*/ ctx[3]);
    			...
    			if (dirty & /*meme*/ 2 && !src_url_equal(img.src, img_src_value = `memes/${/*meme*/ ctx[1].url}`)) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('meme' in $$props) $$invalidate(1, meme = $$props.meme);
    		if ('isTomorrow' in $$props) $$invalidate(2, isTomorrow = $$props.isTomorrow);
    		if ('credit' in $$props) $$invalidate(3, credit = $$props.credit);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*meme*/ 2) {
    			$$invalidate(3, credit = meme.found ? "Found by" : "By");
    		}
    	};

    	return [date, meme, isTomorrow, credit];
    }
    ...
    // (1:0) <script lang="ts">import { compoundDate, dateToString, getToday, getTomorrow, separateDate, stringToDate, }
    function create_catch_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "catch",
    		source: "(1:0) <script lang=\\\"ts\\\">import { compoundDate, dateToString, getToday, getTomorrow, separateDate, stringToDate, }",
    		ctx
    	});
    ...
    function create_then_block_1(ctx) {
    	...
    	let if_block_anchor;
    	let current;
    	let each_value = Object.keys(/*archivedMemes*/ ctx[16]).map(/*func*/ ctx[13]).sort(func_1);
    	...
    	handle_promise(promise = /*tomorrowMemePromise*/ ctx[6], info);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tbody, file, 67, 6, 2049);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*compoundDate, Object, archivedMemesPromise, parseInt, month, year, today*/ 387) {
    				each_value = Object.keys(/*archivedMemes*/ ctx[16]).map(/*func*/ ctx[13]).sort(func_1);
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (dirty & /*tomorrowMemePromise*/ 64 && promise !== (promise = /*tomorrowMemePromise*/ ctx[6]) && handle_promise(promise, info)) ; else {
    				update_await_block_branch(info, ctx, dirty);
    			}

    			if (dirty & /*archivedMemesPromise*/ 128) show_if = !Object.keys(/*archivedMemes*/ ctx[16]).length;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "then",
    		source: "(67:4) {:then archivedMemes}",
    		ctx
    	});
    ...
    // (72:10) {#if compoundDate(date, month, year) <= today}
    function create_if_block_3(ctx) {
    	...
    	shelf = new Shelf({
    			props: {
    				date: compoundDate(/*date*/ ctx[18], /*month*/ ctx[0], /*year*/ ctx[1]),
    				meme: /*archivedMemes*/ ctx[16][/*date*/ ctx[18]]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const shelf_changes = {};
    			if (dirty & /*archivedMemesPromise, month, year*/ 131) shelf_changes.date = compoundDate(/*date*/ ctx[18], /*month*/ ctx[0], /*year*/ ctx[1]);
    			if (dirty & /*archivedMemesPromise*/ 128) shelf_changes.meme = /*archivedMemes*/ ctx[16][/*date*/ ctx[18]];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(72:10) {#if compoundDate(date, month, year) <= today}",
    		ctx
    	});
    ...
    // (69:8) {#each Object.keys(archivedMemes)           .map(x => parseInt(x))           .sort((a, b) => a - b) as date}
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*archivedMemesPromise, month, year*/ 131) show_if = compoundDate(/*date*/ ctx[18], /*month*/ ctx[0], /*year*/ ctx[1]) <= /*today*/ ctx[8];

    			if (show_if) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*archivedMemesPromise, month, year*/ 131) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(69:8) {#each Object.keys(archivedMemes)           .map(x => parseInt(x))           .sort((a, b) => a - b) as date}",
    		ctx
    	});
    ...
    // (81:8) {:then tomorrowMeme}
    function create_then_block_2(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*tomorrowMeme*/ ctx[17] && create_if_block_2(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*tomorrowMeme*/ ctx[17]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*tomorrowMemePromise*/ 64) {
    						transition_in(if_block, 1);
    					}
    				} else {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const shelf_changes = {};
    			if (dirty & /*tomorrowMemePromise*/ 64) shelf_changes.meme = /*tomorrowMeme*/ ctx[17];
    			shelf.$set(shelf_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    // (79:36)            <Loader />         {:then tomorrowMeme}
    function create_pending_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(79:36)            <Loader />         {:then tomorrowMeme}",
    		ctx
    	});
    ...
    // (87:6) {#if !Object.keys(archivedMemes).length}
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tfoot, file, 87, 8, 2686);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(87:6) {#if !Object.keys(archivedMemes).length}",
    		ctx
    	});
    ...
    // (63:33)        <tfoot>         <Loader />       </tfoot>     {:then archivedMemes}
    function create_pending_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			tfoot = element("tfoot");
    			create_component(loader.$$.fragment);
    			add_location(tfoot, file, 63, 6, 1975);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tfoot, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(63:33)        <tfoot>         <Loader />       </tfoot>     {:then archivedMemes}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 107, 6, 3141);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "Meme");
    			add_location(img, file, 101, 6, 3000);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*queriedMemePromise*/ 32 && !src_url_equal(img.src, img_src_value = `memes/${/*queriedMeme*/ ctx[15].url}`)) {
    				attr_dev(img, "src", img_src_value);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(98:29)      <Loader />   {:then queriedMeme}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	handle_promise(promise = /*archivedMemesPromise*/ ctx[7], info);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file, 31, 2, 1031);
    			attr_dev(span0, "class", "-mt-1.5");
    			add_location(span0, file, 39, 8, 1303);
    			...
    			add_location(div0, file, 34, 6, 1126);
    			attr_dev(div1, "class", "w-1/4");
    			add_location(div1, file, 33, 4, 1100);
    			attr_dev(p0, "class", "flex-1 my-2 text-lg text-center");
    			add_location(p0, file, 42, 4, 1365);
    			attr_dev(span1, "class", "-mt-1.5");
    			add_location(span1, file, 51, 8, 1666);
    			...
    			add_location(div2, file, 46, 6, 1491);
    			attr_dev(div3, "class", "w-1/4");
    			add_location(div3, file, 45, 4, 1465);
    			attr_dev(div4, "class", "flex sm:w-1/4 mx-auto my-4");
    			add_location(div4, file, 32, 2, 1055);
    			attr_dev(th0, "class", "border-2");
    			add_location(th0, file, 58, 8, 1840);
    			attr_dev(th1, "class", "border-2");
    			add_location(th1, file, 59, 8, 1879);
    			add_location(tr, file, 57, 6, 1827);
    			add_location(thead, file, 56, 4, 1813);
    			attr_dev(table, "class", "table-auto w-full max-w-4xl mx-auto border-white border-2");
    			add_location(table, file, 55, 2, 1735);
    			add_location(main, file, 30, 0, 1022);
    			add_location(hr0, file, 92, 0, 2768);
    			add_location(h21, file, 94, 2, 2787);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 95, 2, 2813);
    			attr_dev(p1, "class", "my-4");
    			add_location(p1, file, 96, 2, 2860);
    			add_location(section0, file, 93, 0, 2775);
    			add_location(hr1, file, 113, 0, 3279);
    			add_location(h22, file, 115, 2, 3298);
    			attr_dev(a, "class", "hover:underline");
    			attr_dev(a, "href", "schedule.html");
    			add_location(a, file, 117, 4, 3350);
    			attr_dev(p2, "class", "epilogue");
    			add_location(p2, file, 116, 2, 3325);
    			add_location(section1, file, 114, 0, 3286);
    			add_location(footer, file, 120, 0, 3436);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*archivedMemesPromise*/ 128 && promise !== (promise = /*archivedMemesPromise*/ ctx[7]) && handle_promise(promise, info)) ; else {
    				update_await_block_branch(info, ctx, dirty);
    			}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('tomorrowMemePromise' in $$props) $$invalidate(6, tomorrowMemePromise = $$props.tomorrowMemePromise);
    		if ('archivedMemesPromise' in $$props) $$invalidate(7, archivedMemesPromise = $$props.archivedMemesPromise);
    	};
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*year, month, db*/ 1027) {
    			$$invalidate(7, archivedMemesPromise = getMemesOfMonth(year, month, db));
    		}

    		if ($$self.$$.dirty & /*db*/ 1024) {
    			$$invalidate(6, tomorrowMemePromise = getMemeOtd(tomorrow, db));
    		}
