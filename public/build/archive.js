    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 130, 4, 3730);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "Meme");
    			add_location(img, file, 124, 4, 3589);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h21, file, 121, 2, 3492);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 122, 2, 3518);
    			attr_dev(p1, "class", "mt-4");
    			add_location(p1, file, 134, 2, 3842);
    			attr_dev(section, "class", "mt-48");
    			add_location(section, file, 120, 0, 3466);
    			add_location(footer, file, 136, 0, 3898);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
