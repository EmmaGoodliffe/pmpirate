...
var archive = (function () {
    ...
    */
    ...
    // (1:0) <script lang="ts">import { compoundDate, dateToString, normaliseDate, separateDate, stringToDate, }
    function create_catch_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "catch",
    		source: "(1:0) <script lang=\\\"ts\\\">import { compoundDate, dateToString, normaliseDate, separateDate, stringToDate, }",
    		ctx
    	});
    ...
    function create_then_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tbody, file, 67, 6, 2107);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tfoot, file, 87, 8, 2744);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_pending_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			tfoot = element("tfoot");
    			create_component(loader.$$.fragment);
    			add_location(tfoot, file, 63, 6, 2033);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tfoot, anchor);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 107, 6, 3199);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "Meme");
    			add_location(img, file, 101, 6, 3058);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file, 31, 2, 1089);
    			attr_dev(span0, "class", "-mt-1.5");
    			add_location(span0, file, 39, 8, 1361);
    			...
    			add_location(div0, file, 34, 6, 1184);
    			attr_dev(div1, "class", "w-1/4");
    			add_location(div1, file, 33, 4, 1158);
    			attr_dev(p0, "class", "flex-1 my-2 text-lg text-center");
    			add_location(p0, file, 42, 4, 1423);
    			attr_dev(span1, "class", "-mt-1.5");
    			add_location(span1, file, 51, 8, 1724);
    			...
    			add_location(div2, file, 46, 6, 1549);
    			attr_dev(div3, "class", "w-1/4");
    			add_location(div3, file, 45, 4, 1523);
    			attr_dev(div4, "class", "flex sm:w-1/4 mx-auto my-4");
    			add_location(div4, file, 32, 2, 1113);
    			attr_dev(th0, "class", "border-2");
    			add_location(th0, file, 58, 8, 1898);
    			attr_dev(th1, "class", "border-2");
    			add_location(th1, file, 59, 8, 1937);
    			add_location(tr, file, 57, 6, 1885);
    			add_location(thead, file, 56, 4, 1871);
    			attr_dev(table, "class", "table-auto w-full max-w-4xl mx-auto border-white border-2");
    			add_location(table, file, 55, 2, 1793);
    			add_location(main, file, 30, 0, 1080);
    			add_location(hr0, file, 92, 0, 2826);
    			add_location(h21, file, 94, 2, 2845);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 95, 2, 2871);
    			attr_dev(p1, "class", "my-4");
    			add_location(p1, file, 96, 2, 2918);
    			add_location(section0, file, 93, 0, 2833);
    			add_location(hr1, file, 113, 0, 3337);
    			add_location(h22, file, 115, 2, 3356);
    			attr_dev(a, "class", "hover:underline");
    			attr_dev(a, "href", "schedule.html");
    			add_location(a, file, 117, 4, 3408);
    			attr_dev(p2, "class", "epilogue");
    			add_location(p2, file, 116, 2, 3383);
    			add_location(section1, file, 114, 0, 3344);
    			add_location(footer, file, 120, 0, 3494);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
