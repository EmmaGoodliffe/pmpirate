...
var archive = (function () {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			br = element("br");
    			t = text("\n              (Sneak peek)");
    			add_location(br, file, 94, 14, 2784);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(94:12) {#if isTomorrow(meme.date)}",
    		ctx
    	});
    ...
    // (90:6) {#each archivedMemes as meme}
    function create_each_block(ctx) {
    	let tr;
    	let td0;
    	let t0_value = dateToString(/*meme*/ ctx[14].date, "/") + "";
    	let t0;
    	let t1;
    	let show_if = /*isTomorrow*/ ctx[7](/*meme*/ ctx[14].date);
    	let t2;
    	let td1;
    	let img;
    	let img_src_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td0, file, 91, 10, 2662);
    			...
    			add_location(img, file, 99, 12, 2879);
    			add_location(td1, file, 98, 10, 2862);
    			add_location(tr, file, 90, 8, 2647);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*archivedMemes*/ 64 && t0_value !== (t0_value = dateToString(/*meme*/ ctx[14].date, "/") + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*archivedMemes*/ 64) show_if = /*isTomorrow*/ ctx[7](/*meme*/ ctx[14].date);
    			...
    			if (dirty & /*archivedMemes*/ 64 && !src_url_equal(img.src, img_src_value = /*meme*/ ctx[14].meme)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(90:6) {#each archivedMemes as meme}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tfoot, file, 109, 6, 3104);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(109:4) {#if !archivedMemes.length}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 123, 4, 3443);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "Meme");
    			add_location(img, file, 117, 4, 3329);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	let each_value = /*archivedMemes*/ ctx[6];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file, 39, 2, 1299);
    			attr_dev(span0, "class", "-mt-1.5");
    			add_location(span0, file, 47, 8, 1532);
    			attr_dev(div0, "class", "flex-1 btn");
    			attr_dev(div0, "disabled", div0_disabled_value = !/*backwardsEnabled*/ ctx[4]);
    			add_location(div0, file, 42, 6, 1394);
    			attr_dev(div1, "class", "w-1/4");
    			add_location(div1, file, 41, 4, 1368);
    			attr_dev(p0, "class", "flex-1 my-2 text-lg text-center");
    			add_location(p0, file, 50, 4, 1594);
    			attr_dev(span1, "class", "-mt-1.5");
    			add_location(span1, file, 59, 8, 1856);
    			attr_dev(div2, "class", "flex-1 btn");
    			attr_dev(div2, "disabled", div2_disabled_value = !/*forwardsEnabled*/ ctx[3]);
    			add_location(div2, file, 54, 6, 1720);
    			attr_dev(div3, "class", "w-1/4");
    			add_location(div3, file, 53, 4, 1694);
    			attr_dev(div4, "class", "flex sm:w-1/4 mx-auto my-4");
    			add_location(div4, file, 40, 2, 1323);
    			attr_dev(th0, "class", "border-2");
    			add_location(th0, file, 66, 8, 2030);
    			attr_dev(th1, "class", "border-2");
    			add_location(th1, file, 67, 8, 2069);
    			add_location(tr, file, 65, 6, 2017);
    			add_location(thead, file, 64, 4, 2003);
    			add_location(tbody, file, 70, 4, 2129);
    			attr_dev(table, "class", "table-auto w-full max-w-4xl mx-auto border-white border-2");
    			add_location(table, file, 63, 2, 1925);
    			add_location(main, file, 38, 0, 1290);
    			add_location(h21, file, 114, 2, 3234);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 115, 2, 3260);
    			attr_dev(p1, "class", "mt-4");
    			add_location(p1, file, 127, 2, 3555);
    			attr_dev(section, "class", "mt-48");
    			add_location(section, file, 113, 0, 3208);
    			add_location(footer, file, 129, 0, 3611);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*archivedMemes, isTomorrow, dateToString*/ 192) {
    				each_value = /*archivedMemes*/ ctx[6];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*year, month*/ 3) {
    			$$invalidate(4, backwardsEnabled = new Date(2021, 9 - 1, 1) < new Date(year, month - 1, 1));
    		}
    	...
    	$$invalidate(8, tomorrowMeme = getMemeOtd(tomorrow));
