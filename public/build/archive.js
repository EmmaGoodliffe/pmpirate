...
var archive = (function () {
    ...
    function create_if_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(83:12) {#if isTomorrow(date)}",
    		ctx
    	});
    ...
    // (78:6) {#each archivedDates as date}
    function create_each_block(ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*date*/ ctx[15].split("-").reverse().join("/") + "";
    	let t0;
    	let t1;
    	let br;
    	let t2;
    	let show_if = /*isTomorrow*/ ctx[8](/*date*/ ctx[15]);
    	let t3;
    	let td1;
    	let img;
    	let img_src_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			img = element("img");
    			t4 = space();
    			add_location(br, file, 81, 12, 2592);
    			attr_dev(td0, "class", "text-center");
    			add_location(td0, file, 79, 10, 2505);
    			attr_dev(img, "class", "max-w-sm mx-auto w-1/2 sm:w-auto");
    			if (!src_url_equal(img.src, img_src_value = `memes/${/*memes*/ ctx[0].otd[/*date*/ ctx[15]]}`)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Meme");
    			add_location(img, file, 87, 12, 2722);
    			add_location(td1, file, 86, 10, 2705);
    			add_location(tr, file, 78, 8, 2490);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*archivedDates*/ 128 && t0_value !== (t0_value = /*date*/ ctx[15].split("-").reverse().join("/") + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*archivedDates*/ 128) show_if = /*isTomorrow*/ ctx[8](/*date*/ ctx[15]);
    			...
    			if (dirty & /*memes, archivedDates*/ 129 && !src_url_equal(img.src, img_src_value = `memes/${/*memes*/ ctx[0].otd[/*date*/ ctx[15]]}`)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(78:6) {#each archivedDates as date}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tfoot, file, 97, 6, 2964);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(97:4) {#if !archivedDates.length}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 111, 4, 3337);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "Meme");
    			add_location(img, file, 105, 4, 3196);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*memes, matchingDates*/ 65 && !src_url_equal(img.src, img_src_value = `memes/${/*memes*/ ctx[0].otd[/*matchingDates*/ ctx[6][0]]}`)) {
    				attr_dev(img, "src", img_src_value);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(105:2) {#if matchingDates.length}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let t4;
    	let p0;
    	let t5_value = `${/*month*/ ctx[1]}`.padStart(2, "0") + "";
    	let t5;
    	let t6;
    	let t7;
    	let t8;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file, 45, 2, 1608);
    			attr_dev(span0, "class", "-mt-1.5");
    			add_location(span0, file, 53, 8, 1841);
    			attr_dev(div0, "class", "flex-1 btn");
    			attr_dev(div0, "disabled", div0_disabled_value = !/*backwardsEnabled*/ ctx[5]);
    			add_location(div0, file, 48, 6, 1703);
    			attr_dev(div1, "class", "w-1/4");
    			add_location(div1, file, 47, 4, 1677);
    			attr_dev(p0, "class", "flex-1 my-2 text-lg text-center");
    			add_location(p0, file, 56, 4, 1903);
    			attr_dev(span1, "class", "-mt-1.5");
    			add_location(span1, file, 65, 8, 2165);
    			attr_dev(div2, "class", "flex-1 btn");
    			attr_dev(div2, "disabled", div2_disabled_value = !/*forwardsEnabled*/ ctx[4]);
    			add_location(div2, file, 60, 6, 2029);
    			attr_dev(div3, "class", "w-1/4");
    			add_location(div3, file, 59, 4, 2003);
    			attr_dev(div4, "class", "flex sm:w-1/4 mx-auto my-4");
    			add_location(div4, file, 46, 2, 1632);
    			attr_dev(th0, "class", "border-2");
    			add_location(th0, file, 72, 8, 2339);
    			attr_dev(th1, "class", "border-2");
    			add_location(th1, file, 73, 8, 2378);
    			add_location(tr, file, 71, 6, 2326);
    			add_location(thead, file, 70, 4, 2312);
    			add_location(tbody, file, 76, 4, 2438);
    			attr_dev(table, "class", "table-auto w-full max-w-4xl mx-auto border-white border-2");
    			add_location(table, file, 69, 2, 2234);
    			add_location(main, file, 44, 0, 1599);
    			add_location(h21, file, 102, 2, 3091);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 103, 2, 3117);
    			attr_dev(p1, "class", "mt-4");
    			add_location(p1, file, 115, 2, 3449);
    			attr_dev(section, "class", "mt-48");
    			add_location(section, file, 101, 0, 3065);
    			add_location(footer, file, 117, 0, 3505);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*backwardsEnabled*/ 32 && div0_disabled_value !== (div0_disabled_value = !/*backwardsEnabled*/ ctx[5])) {
    				attr_dev(div0, "disabled", div0_disabled_value);
    			}

    			if ((!current || dirty & /*month*/ 2) && t5_value !== (t5_value = `${/*month*/ ctx[1]}`.padStart(2, "0") + "")) set_data_dev(t5, t5_value);
    			if (!current || dirty & /*year*/ 4) set_data_dev(t7, /*year*/ ctx[2]);

    			if (!current || dirty & /*forwardsEnabled*/ 16 && div2_disabled_value !== (div2_disabled_value = !/*forwardsEnabled*/ ctx[4])) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['memes'];

    	Object_1.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Archive> was created with unknown prop '${key}'`);
    	});

    	const click_handler = () => backwardsEnabled && $$invalidate(1, month--, month);
    	const click_handler_1 = () => forwardsEnabled && $$invalidate(1, month++, month);

    	function input_input_handler() {
    		dateString = this.value;
    		$$invalidate(3, dateString);
    	}
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*month, year*/ 6) {
    			{
    				if (month < 1) {
    					$$invalidate(1, month = 12);
    					$$invalidate(2, year--, year);
    				} else if (month > 12) {
    ...
    class Archive extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { memes: 0 });
    		...
    		if (/*memes*/ ctx[0] === undefined && !('memes' in props)) {
