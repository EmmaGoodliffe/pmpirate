...
var archive = (function () {
    ...
    // (31:8) {#if isArchived(date)}
    function create_if_block_1(ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*date*/ ctx[9].split("-").reverse().join("/") + "";
    	let t0;
    	let t1;
    	let br;
    	let t2;
    	let show_if = new Date(/*date*/ ctx[9]) > new Date();
    	let t3;
    	let td1;
    	let img;
    	let img_src_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			img = element("img");
    			t4 = space();
    			add_location(br, file, 34, 14, 1073);
    			attr_dev(td0, "class", "text-center border-2 p-4");
    			add_location(td0, file, 32, 12, 969);
    			attr_dev(img, "class", "max-w-sm mx-auto w-1/2 sm:w-auto");
    			if (!src_url_equal(img.src, img_src_value = `memes/${/*memes*/ ctx[0].otd[/*date*/ ctx[9]]}`)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Meme");
    			add_location(img, file, 40, 14, 1247);
    			attr_dev(td1, "class", "border-2 p-4");
    			add_location(td1, file, 39, 12, 1207);
    			add_location(tr, file, 31, 10, 952);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*memes*/ 1 && !src_url_equal(img.src, img_src_value = `memes/${/*memes*/ ctx[0].otd[/*date*/ ctx[9]]}`)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(31:8) {#if isArchived(date)}",
    		ctx
    	});
    ...
    // (36:14) {#if new Date(date) > new Date()}
    function create_if_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(36:14) {#if new Date(date) > new Date()}",
    		ctx
    	});
    ...
    // (30:6) {#each dates as date}
    function create_each_block(ctx) {
    	let show_if = /*isArchived*/ ctx[4](/*date*/ ctx[9]);
    	let if_block_anchor;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(30:6) {#each dates as date}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			img = element("img");
    			attr_dev(img, "class", "max-w-sm mx-auto w-1/2 sm:w-auto");
    			if (!src_url_equal(img.src, img_src_value = `memes/${/*memes*/ ctx[0].otd[/*matchingDates*/ ctx[2][0]]}`)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Meme");
    			add_location(img, file, 60, 4, 1685);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*memes, matchingDates*/ 5 && !src_url_equal(img.src, img_src_value = `memes/${/*memes*/ ctx[0].otd[/*matchingDates*/ ctx[2][0]]}`)) {
    				attr_dev(img, "src", img_src_value);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(60:2) {#if matchingDates.length}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*matchingDates*/ ctx[2].length) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file, 19, 2, 610);
    			attr_dev(p0, "class", "my-2");
    			add_location(p0, file, 20, 2, 634);
    			attr_dev(th0, "class", "border-2");
    			add_location(th0, file, 24, 8, 776);
    			attr_dev(th1, "class", "border-2");
    			add_location(th1, file, 25, 8, 815);
    			add_location(tr, file, 23, 6, 763);
    			add_location(thead, file, 22, 4, 749);
    			add_location(tbody, file, 28, 4, 875);
    			attr_dev(table, "class", "table-auto w-full max-w-4xl mx-auto border-white border-2");
    			add_location(table, file, 21, 2, 671);
    			add_location(main, file, 18, 0, 601);
    			add_location(h21, file, 53, 2, 1522);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "class", "bg-bg border-white border px-2 py-1");
    			add_location(input, file, 54, 2, 1548);
    			attr_dev(p1, "class", "mt-4");
    			add_location(p1, file, 70, 2, 1938);
    			attr_dev(section, "class", "mt-48");
    			add_location(section, file, 52, 0, 1496);
    			attr_dev(footer, "class", "mb-4");
    			add_location(footer, file, 72, 0, 1994);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*memes, dates, Date, isArchived*/ 25) {
    			...
    			if (dirty & /*dateString*/ 2 && input.value !== /*dateString*/ ctx[1]) {
    				set_input_value(input, /*dateString*/ ctx[1]);
    			}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { memes } = $$props;
    	let { dateToString } = $$props;
    	let { stringToDate } = $$props;
    	...
    	const writable_props = ['memes', 'dateToString', 'stringToDate'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('dateToString' in $$props) $$invalidate(5, dateToString = $$props.dateToString);
    		if ('stringToDate' in $$props) $$invalidate(6, stringToDate = $$props.stringToDate);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('matchingDates' in $$props) $$invalidate(2, matchingDates = $$props.matchingDates);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*dateToString, stringToDate, dateString*/ 98) {
    			$$invalidate(2, matchingDates = dates.filter(date => dateToString(new Date(date)) === dateToString(stringToDate(dateString))));
    		}
    	};
    ...
    class Archive extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*dateToString*/ ctx[5] === undefined && !('dateToString' in props)) {
    			console.warn("<Archive> was created without expected prop 'dateToString'");
    		}

    		if (/*stringToDate*/ ctx[6] === undefined && !('stringToDate' in props)) {
