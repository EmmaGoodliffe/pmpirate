    ...
    */
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$2, 6, 2, 151);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*url*/ ctx[0]) return create_if_block$2;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Meme> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ url, noMemeMessage, className });
    	...
    	return [url, noMemeMessage];
    }

    class Meme extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { url: 0, noMemeMessage: 1 });
    		...
    		if (/*noMemeMessage*/ ctx[1] === undefined && !('noMemeMessage' in props)) {
    			console.warn("<Meme> was created without expected prop 'noMemeMessage'");
    		}
    	}
    ...
    // (92:4) {:then [archivedMemes, tomorrowMeme]}
    function create_then_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tbody, file, 92, 6, 3421);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "then",
    		source: "(92:4) {:then [archivedMemes, tomorrowMeme]}",
    		ctx
    	});
    ...
    // (94:8) {#each Object.keys(archivedMemes).map(x => parseInt(x)) as date}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(94:8) {#each Object.keys(archivedMemes).map(x => parseInt(x)) as date}",
    		ctx
    	});
    ...
    // (100:8) {#if tomorrowMeme && !forwardsEnabled}
    function create_if_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(100:8) {#if tomorrowMeme && !forwardsEnabled}",
    		ctx
    	});
    ...
    // (104:6) {#if !Object.keys(archivedMemes).length && !tomorrowMeme}
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(104:6) {#if !Object.keys(archivedMemes).length && !tomorrowMeme}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tfoot, file, 107, 10, 4012);
    		},
    		m: function mount(target, anchor) {
    ...
    // (105:8) {#if month === separateDate(today)[1] && year === separateDate(today)[2]}
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tfoot, file, 105, 10, 3944);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tfoot, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(105:8) {#if month === separateDate(today)[1] && year === separateDate(today)[2]}",
    		ctx
    	});
    ...
    // (88:25)        <tfoot>         <Loader />       </tfoot>     {:then [archivedMemes, tomorrowMeme]}
    function create_pending_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tfoot, file, 88, 6, 3331);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tfoot, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(88:25)        <tfoot>         <Loader />       </tfoot>     {:then [archivedMemes, tomorrowMeme]}",
    		ctx
    	});
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const meme_changes = {};
    			if (dirty & /*queriedMemePromise*/ 32) meme_changes.url = /*queriedMeme*/ ctx[18]?.url;
    ...
    // (119:29)      <Loader />   {:then queriedMeme}
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(119:29)      <Loader />   {:then queriedMeme}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th0, file, 83, 8, 3204);
    			attr_dev(th1, "class", "border-2");
    			add_location(th1, file, 84, 8, 3243);
    			add_location(tr, file, 82, 6, 3191);
    			add_location(thead, file, 81, 4, 3177);
    			...
    			add_location(hr0, file, 113, 0, 4108);
    			add_location(h21, file, 115, 2, 4127);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 116, 2, 4153);
    			attr_dev(p1, "class", "my-4");
    			add_location(p1, file, 117, 2, 4200);
    			add_location(section0, file, 114, 0, 4115);
    			add_location(hr1, file, 124, 0, 4407);
    			add_location(h22, file, 126, 2, 4426);
    			attr_dev(a, "class", "hover:underline");
    			attr_dev(a, "href", "schedule.html");
    			add_location(a, file, 128, 4, 4478);
    			attr_dev(p2, "class", "epilogue");
    			add_location(p2, file, 127, 2, 4453);
    			add_location(section1, file, 125, 0, 4414);
    			add_location(footer, file, 131, 0, 4564);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
