    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file, 36, 2, 795);
    			attr_dev(div0, "class", "book-section");
    			add_location(div0, file, 37, 2, 812);
    			add_location(hr0, file, 42, 2, 942);
    			add_location(h21, file, 43, 2, 951);
    			attr_dev(div1, "class", "book-section");
    			add_location(div1, file, 44, 2, 976);
    			attr_dev(p0, "class", "epilogue");
    			add_location(p0, file, 49, 2, 1113);
    			add_location(hr1, file, 52, 2, 1222);
    			add_location(h22, file, 53, 2, 1231);
    			attr_dev(div2, "class", "book-section");
    			add_location(div2, file, 54, 2, 1255);
    			add_location(hr2, file, 62, 2, 1458);
    			add_location(h23, file, 63, 2, 1467);
    			attr_dev(div3, "class", "book-section");
    			add_location(div3, file, 64, 2, 1486);
    			add_location(main, file, 35, 0, 786);
    			add_location(hr3, file, 69, 0, 1636);
    			add_location(h24, file, 71, 2, 1664);
    			attr_dev(section0, "id", "otd");
    			add_location(section0, file, 70, 0, 1643);
    			add_location(hr4, file, 78, 0, 1797);
    			add_location(h25, file, 80, 2, 1816);
    			attr_dev(a, "class", "hover:underline");
    			attr_dev(a, "href", "archive.html");
    			add_location(a, file, 82, 4, 1865);
    			attr_dev(p1, "class", "epilogue");
    			add_location(p1, file, 81, 2, 1840);
    			add_location(section1, file, 79, 0, 1804);
    			add_location(footer, file, 85, 0, 1947);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
