    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(hr4, file, 79, 0, 1850);
    			add_location(h25, file, 81, 2, 1869);
    			attr_dev(a, "class", "hover:underline");
    			attr_dev(a, "href", "archive.html");
    			add_location(a, file, 83, 4, 1918);
    			attr_dev(p1, "class", "epilogue");
    			add_location(p1, file, 82, 2, 1893);
    			add_location(section1, file, 80, 0, 1857);
    			add_location(footer, file, 86, 0, 2000);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
