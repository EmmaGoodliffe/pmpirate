...
var index = (function () {
    ...
    */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$3, 2, 4, 54);
    			attr_dev(h1, "class", "inline-block ml-4");
    			add_location(h1, file$3, 8, 4, 169);
    			attr_dev(a, "class", "flex");
    			attr_dev(a, "href", "/");
    			add_location(a, file$3, 1, 2, 24);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 24, 2, 540);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 13, 2, 284);
    		},
    		m: function mount(target, anchor) {
    ...
    class Meme extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { url: 0, width: 1 });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file, 37, 2, 850);
    			attr_dev(div0, "class", "book-section");
    			add_location(div0, file, 38, 2, 867);
    			add_location(hr0, file, 43, 2, 997);
    			add_location(h21, file, 44, 2, 1006);
    			attr_dev(div1, "class", "book-section");
    			add_location(div1, file, 45, 2, 1031);
    			attr_dev(p0, "class", "epilogue");
    			add_location(p0, file, 50, 2, 1168);
    			add_location(hr1, file, 53, 2, 1277);
    			add_location(h22, file, 54, 2, 1286);
    			attr_dev(div2, "class", "book-section");
    			add_location(div2, file, 55, 2, 1310);
    			add_location(hr2, file, 63, 2, 1513);
    			add_location(h23, file, 64, 2, 1522);
    			attr_dev(div3, "class", "book-section");
    			add_location(div3, file, 65, 2, 1541);
    			add_location(main, file, 36, 0, 841);
    			add_location(hr3, file, 70, 0, 1691);
