    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file, 35, 2, 746);
    			attr_dev(div0, "class", "book-section");
    			add_location(div0, file, 36, 2, 763);
    			add_location(hr0, file, 41, 2, 893);
    			add_location(h21, file, 42, 2, 902);
    			attr_dev(div1, "class", "book-section");
    			add_location(div1, file, 43, 2, 927);
    			attr_dev(p0, "class", "epilogue");
    			add_location(p0, file, 48, 2, 1064);
    			add_location(hr1, file, 51, 2, 1173);
    			add_location(h22, file, 52, 2, 1182);
    			attr_dev(div2, "class", "book-section");
    			add_location(div2, file, 53, 2, 1206);
    			add_location(hr2, file, 61, 2, 1409);
    			add_location(h23, file, 62, 2, 1418);
    			attr_dev(div3, "class", "book-section");
    			add_location(div3, file, 63, 2, 1437);
    			add_location(main, file, 34, 0, 737);
    			add_location(hr3, file, 68, 0, 1587);
    			attr_dev(a, "class", "hover:underline");
    			attr_dev(a, "href", "archive.html");
    			add_location(a, file, 72, 4, 1663);
    			attr_dev(p1, "class", "epilogue");
    			add_location(p1, file, 71, 2, 1638);
    			attr_dev(section, "id", "otd");
    			add_location(section, file, 69, 0, 1594);
    			add_location(footer, file, 75, 0, 1745);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
