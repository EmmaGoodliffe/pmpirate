...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 9, 2, 221);
    		},
    		m: function mount(target, anchor) {
    ...
    // (15:4) {#each ["Further Mech", "Further Pure Year 1", "Further Pure Year 2", "Further Stats"] as book}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(15:4) {#each [\\\"Further Mech\\\", \\\"Further Pure Year 1\\\", \\\"Further Pure Year 2\\\", \\\"Further Stats\\\"] as book}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let each_value_1 = ["Further Mech", "Further Pure Year 1", "Further Pure Year 2", "Further Stats"];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file, 18, 2, 569);
    			attr_dev(h21, "class", "mt-12");
    			add_location(h21, file, 21, 2, 675);
    			attr_dev(div1, "class", "flex flex-col sm:flex-row");
    			add_location(div1, file, 22, 2, 713);
    			add_location(main, file, 11, 0, 338);
    			attr_dev(a, "class", "hover:underline");
    			attr_dev(a, "href", "archive.html");
    			add_location(a, file, 34, 4, 1075);
    			attr_dev(p1, "class", "mt-12");
    			add_location(p1, file, 33, 2, 1053);
    			attr_dev(section, "class", "mt-48");
    			add_location(section, file, 31, 0, 1004);
    			attr_dev(footer, "class", "mb-4");
    			add_location(footer, file, 37, 0, 1157);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
