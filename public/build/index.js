    ...
    */
    ...
    function create_each_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(38:4) {#each mathsBooks as book}",
    		ctx
    	});
    ...
    // (45:4) {#each furtherMathsBooks as book}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(45:4) {#each furtherMathsBooks as book}",
    		ctx
    	});
    ...
    // (55:4) {#each gbdBooklets as booklet}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(55:4) {#each gbdBooklets as booklet}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file, 35, 2, 755);
    			attr_dev(div0, "class", "book-section");
    			add_location(div0, file, 36, 2, 772);
    			add_location(hr0, file, 41, 2, 902);
    			add_location(h21, file, 42, 2, 911);
    			attr_dev(div1, "class", "book-section");
    			add_location(div1, file, 43, 2, 936);
    			attr_dev(p0, "class", "epilogue");
    			add_location(p0, file, 48, 2, 1073);
    			add_location(hr1, file, 51, 2, 1182);
    			add_location(h22, file, 52, 2, 1191);
    			attr_dev(div2, "class", "book-section");
    			add_location(div2, file, 53, 2, 1215);
    			add_location(hr2, file, 61, 2, 1418);
    			add_location(h23, file, 62, 2, 1427);
    			attr_dev(div3, "class", "book-section");
    			add_location(div3, file, 63, 2, 1446);
    			add_location(main, file, 34, 0, 746);
    			add_location(hr3, file, 68, 0, 1596);
    			attr_dev(a, "class", "hover:underline");
    			attr_dev(a, "href", "archive.html");
    			add_location(a, file, 74, 4, 1722);
    			attr_dev(p1, "class", "epilogue");
    			add_location(p1, file, 73, 2, 1697);
    			attr_dev(section, "id", "otd");
    			add_location(section, file, 69, 0, 1603);
    			add_location(footer, file, 77, 0, 1804);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { db } = $$props;
    	const today = new Date();
    	const otdSrcPromise = getMemeOtd(today);
