...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file, 36, 2, 844);
    			attr_dev(div0, "class", "book-section");
    			add_location(div0, file, 37, 2, 861);
    			add_location(hr0, file, 42, 2, 991);
    			add_location(h21, file, 43, 2, 1000);
    			attr_dev(div1, "class", "book-section");
    			add_location(div1, file, 44, 2, 1025);
    			attr_dev(p0, "class", "epilogue");
    			add_location(p0, file, 49, 2, 1162);
    			add_location(hr1, file, 52, 2, 1271);
    			add_location(h22, file, 53, 2, 1280);
    			attr_dev(div2, "class", "book-section");
    			add_location(div2, file, 54, 2, 1304);
    			add_location(hr2, file, 62, 2, 1507);
    			add_location(h23, file, 63, 2, 1516);
    			attr_dev(div3, "class", "book-section");
    			add_location(div3, file, 64, 2, 1535);
    			add_location(main, file, 35, 0, 835);
    			add_location(hr3, file, 69, 0, 1685);
    			attr_dev(a, "class", "hover:underline");
    			attr_dev(a, "href", "archive.html");
    			add_location(a, file, 73, 4, 1761);
    			attr_dev(p1, "class", "epilogue");
    			add_location(p1, file, 72, 2, 1736);
    			attr_dev(section, "id", "otd");
    			add_location(section, file, 70, 0, 1692);
    			add_location(footer, file, 76, 0, 1843);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [otdSrc, mathsBooks, furtherMathsBooks, gbdBooklets, memes];
    }

    class Home extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { memes: 4 });
