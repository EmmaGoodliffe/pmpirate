...
/**
     ...
     * limitations under the License.
     */
function al(t){t=Bh(t,Kh);const e=Bh(t.firestore,Qh);return Fh(function(t){return t._firestoreClient||Wh(t),t._firestoreClient.verifyNotTerminated(),t._firestoreClient}(e),t._key).then((n=>function(t,e,n){const s=n.docs.get(e._key),i=new cl(t);return new rl(t,i,e._key,s,new il(n.hasPendingWrites,n.fromCache),e.converter)}(e,t,n)))}class cl extends class{convertValue(t,e="none"){switch(Ko(t)){case 0:return null;case 1:return t.booleanValue;case 2:return Ro(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(Mo(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 10:return this.convertObject(t.mapValue,e);default:throw Kr()}}convertObject(t,e){const n={};return So(t.fields,((t,s)=>{n[t]=this.convertValue(s,e)})),n}convertGeoPoint(t){return new Jh(Ro(t.latitude),Ro(t.longitude))}convertArray(t,e){return(t.values||[]).map((t=>this.convertValue(t,e)))}convertServerTimestamp(t,e){switch(e){case"previous":const n=Fo(t);return null==n?null:this.convertValue(n,e);case"estimate":return this.convertTimestamp(Vo(t));default:return null}}convertTimestamp(t){const e=Oo(t);return new co(e.seconds,e.nanos)}convertDocumentKey(t,e){const n=lo.fromString(t);zr(Wc(n));const s=new Uo(n.get(1),n.get(3)),i=new go(n.popFirst(5));return s.isEqual(e)||Br(`Document ${i} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),i}}{constructor(t){super(),this.firestore=t}convertBytes(t){return new Yh(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new Kh(this.firestore,null,e)}}!function(t,e=!0){Fr="9.9.0",Y(new g("firestore",((t,{options:n})=>{const s=t.getProvider("app").getImmediate(),i=new Qh(s,new Zr(t.getProvider("auth-internal")),new so(t.getProvider("app-check-internal")));return n=Object.assign({useFetchStreams:e},n),i._setSettings(n),i}),"PUBLIC")),nt(Mr,"3.4.12",t),nt(Mr,"3.4.12","esm2017")}();const ul=function(t,e={}){if("object"!=typeof e){e={name:e}}const n=Object.assign({name:G,automaticDataCollectionEnabled:!1},e),s=n.name;if("string"!=typeof s||!s)throw Z.create("bad-app-name",{appName:String(s)});const i=Q.get(s);if(i){if(l(t,i.options)&&l(n,i.config))return i;throw Z.create("duplicate-app",{appName:s})}const r=new v(s);for(const t of W.values())r.addComponent(t);const o=new tt(t,n,r);return Q.set(s,o),o}({apiKey:"AIzaSyDfGaweLVDXcfxJDZ4ztoMoilhU9fv4uXU",authDomain:"pmpirate.firebaseapp.com",projectId:"pmpirate",storageBucket:"pmpirate.appspot.com",messagingSenderId:"198590478768",appId:"1:198590478768:web:3d10abd6d006c0a0b93e75",measurementId:"G-19MDLJEYQG"});!function(t=et()){const e=J(t=p(t),te);e.isInitialized()?e.getImmediate():function(t,e={}){const n=J(t,te);if(n.isInitialized()){const t=n.getImmediate();if(l(e,n.getOptions()))return t;throw re.create("already-initialized")}n.initialize({options:e})}(t)}(ul);const hl=function(t=et()){return J(t,"firestore").getImmediate()}(ul);function ll(){}function dl(t){return t()}function fl(){return Object.create(null)}function pl(t){t.forEach(dl)}function gl(t){return"function"==typeof t}function ml(t,e){return t!=t?e==e:t!==e||t&&"object"==typeof t||"function"==typeof t}let yl,vl;function wl(t,e){return yl||(yl=document.createElement("a")),yl.href=e,t===yl.href}function bl(t,e){t.appendChild(e)}function El(t,e,n){t.insertBefore(e,n||null)}function Tl(t){t.parentNode.removeChild(t)}function Il(t,e){for(let n=0;n<t.length;n+=1)t[n]&&t[n].d(e)}function Sl(t){return document.createElement(t)}function Cl(t){return document.createTextNode(t)}function Al(){return Cl(" ")}function Dl(t,e,n){null==n?t.removeAttribute(e):t.getAttribute(e)!==n&&t.setAttribute(e,n)}function kl(t){vl=t}function _l(){if(!vl)throw new Error("Function called outside component initialization");return vl}(location.href.includes("localhost")||location.href.includes("127.0.0.1"))&&function(t,e,s,i={}){var r;const o=(t=Bh(t,qh))._getSettings();if("firestore.googleapis.com"!==o.host&&o.host!==e&&jr("Host has been set in both settings() and useEmulator(), emulator host will be used"),t._setSettings(Object.assign(Object.assign({},o),{host:`${e}:${s}`,ssl:!1})),i.mockUserToken){let e,s;if("string"==typeof i.mockUserToken)e=i.mockUserToken,s=Pr.MOCK_USER;else{e=function(t,e){if(t.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const s=e||"demo-project",i=t.iat||0,r=t.sub||t.user_id;if(!r)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const o=Object.assign({iss:`https://securetoken.google.com/${s}`,aud:s,iat:i,exp:i+3600,auth_time:i,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}}},t);return[n(JSON.stringify({alg:"none",type:"JWT"})),n(JSON.stringify(o)),""].join(".")}(i.mockUserToken,null===(r=t._app)||void 0===r?void 0:r.options.projectId);const o=i.mockUserToken.sub||i.mockUserToken.user_id;if(!o)throw new Qr(Hr.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");s=new Pr(o)}t._authCredentials=new Jr(new Xr(e,s))}}(hl,"localhost",8080);const Nl=[],xl=[],Ll=[],Ol=[],Rl=Promise.resolve();let Ml=!1;function Pl(t){Ll.push(t)}const Fl=new Set;let Vl=0;function $l(){const t=vl;do{for(;Vl<Nl.length;){const t=Nl[Vl];Vl++,kl(t),Ul(t.$$)}for(kl(null),Nl.length=0,Vl=0;xl.length;)xl.pop()();for(let t=0;t<Ll.length;t+=1){const e=Ll[t];Fl.has(e)||(Fl.add(e),e())}Ll.length=0}while(Nl.length);for(;Ol.length;)Ol.pop()();Ml=!1,Fl.clear(),kl(t)}function Ul(t){if(null!==t.fragment){t.update(),pl(t.before_update);const e=t.dirty;t.dirty=[-1],t.fragment&&t.fragment.p(t.ctx,e),t.after_update.forEach(Pl)}}const Bl=new Set;let jl;function ql(){jl={r:0,c:[],p:jl}}function Kl(){jl.r||pl(jl.c),jl=jl.p}function zl(t,e){t&&t.i&&(Bl.delete(t),t.i(e))}function Gl(t,e,n,s){if(t&&t.o){if(Bl.has(t))return;Bl.add(t),jl.c.push((()=>{Bl.delete(t),s&&(n&&t.d(1),s())})),t.o(e)}else s&&s()}function Hl(t,e){const n=e.token={};function s(t,s,i,r){if(e.token!==n)return;e.resolved=r;let o=e.ctx;void 0!==i&&(o=o.slice(),o[i]=r);const a=t&&(e.current=t)(o);let c=!1;e.block&&(e.blocks?e.blocks.forEach(((t,n)=>{n!==s&&t&&(ql(),Gl(t,1,1,(()=>{e.blocks[n]===t&&(e.blocks[n]=null)})),Kl())})):e.block.d(1),a.c(),zl(a,1),a.m(e.mount(),e.anchor),c=!0),e.block=a,e.blocks&&(e.blocks[s]=a),c&&$l()}if((i=t)&&"object"==typeof i&&"function"==typeof i.then){const n=_l();if(t.then((t=>{kl(n),s(e.then,1,e.value,t),kl(null)}),(t=>{if(kl(n),s(e.catch,2,e.error,t),kl(null),!e.hasCatch)throw t})),e.current!==e.pending)return s(e.pending,0),!0}else{if(e.current!==e.then)return s(e.then,1,e.value,t),!0;e.resolved=t}var i}function Ql(t){t&&t.c()}function Wl(t,e,n,s){const{fragment:i,on_mount:r,on_destroy:o,after_update:a}=t.$$;i&&i.m(e,n),s||Pl((()=>{const e=r.map(dl).filter(gl);o?o.push(...e):pl(e),t.$$.on_mount=[]})),a.forEach(Pl)}function Xl(t,e){const n=t.$$;null!==n.fragment&&(pl(n.on_destroy),n.fragment&&n.fragment.d(e),n.on_destroy=n.fragment=null,n.ctx=[])}function Yl(t,e){-1===t.$$.dirty[0]&&(Nl.push(t),Ml||(Ml=!0,Rl.then($l)),t.$$.dirty.fill(0)),t.$$.dirty[e/31|0]|=1<<e%31}function Jl(t,e,n,s,i,r,o,a=[-1]){const c=vl;kl(t);const u=t.$$={fragment:null,ctx:null,props:r,update:ll,not_equal:i,bound:fl(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(c?c.$$.context:[])),callbacks:fl(),dirty:a,skip_bound:!1,root:e.target||c.$$.root};o&&o(u.root);let h=!1;if(u.ctx=n?n(t,e.props||{},((e,n,...s)=>{const r=s.length?s[0]:n;return u.ctx&&i(u.ctx[e],u.ctx[e]=r)&&(!u.skip_bound&&u.bound[e]&&u.bound[e](r),h&&Yl(t,e)),n})):[],u.update(),h=!0,pl(u.before_update),u.fragment=!!s&&s(u.ctx),e.target){if(e.hydrate){const t=function(t){return Array.from(t.childNodes)}(e.target);u.fragment&&u.fragment.l(t),t.forEach(Tl)}else u.fragment&&u.fragment.c();e.intro&&zl(t.$$.fragment),Wl(t,e.target,e.anchor,e.customElement),$l()}kl(c)}class Zl{$destroy(){Xl(this,1),this.$destroy=ll}$on(t,e){const n=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return n.push(e),()=>{const t=n.indexOf(e);-1!==t&&n.splice(t,1)}}$set(t){var e;this.$$set&&(e=t,0!==Object.keys(e).length)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}const td=t=>[t.getDate(),t.getMonth()+1,t.getFullYear()],ed=(t,e,n)=>new Date(n,e-1,t),nd={},sd=new Set,id=ed(1,9,2021),rd=async(t,e,n)=>{try{return(await al(function(t,e,...n){if(t=p(t),1===arguments.length&&(e=ro.I()),$h("doc","path",e),t instanceof qh){const s=lo.fromString(e,...n);return Uh(s),new Kh(t,null,new go(s))}{if(!(t instanceof Kh||t instanceof Gh))throw new Qr(Hr.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=t._path.child(lo.fromString(e,...n));return Uh(s),new Kh(t.firestore,t instanceof Gh?t.converter:null,new go(s))}}(t,e,n))).data()}catch(t){console.warn("Your DB emulations are likely not running correctly"),console.error(t)}},od=(t,e)=>{const n=ed(1,e,t),s=new Date,i=td(s)[2];return id<=n&&t<=i},ad=async(t,e,n)=>{var s;if(!od(t,e))return null;const i=`${t}-${`${e}`.padStart(2,"0")}`;if(sd.has(i))return await(r=1,new Promise((t=>setTimeout(t,1e3*r)))),cd(t,e);var r;console.count(i),console.count("DB reads"),sd.add(i),console.log(sd,nd);const o=null!==(s=await rd(n,"memes",i))&&void 0!==s?s:{};return((t,e,n)=>{nd[t]||(nd[t]={}),nd[t][e]=n})(t,e,o),sd.delete(i),console.log(sd,nd),o},cd=(t,e)=>{try{return nd[t][e]}catch(t){console.count("Cache errors")}},ud=async(t,e,n=0)=>{if(!t)return null;if(n>=12)throw new Error("DB recursion");const[s,i,r]=td(t);if(!od(r,i))return null;try{return nd[r][i][s]}catch(t){console.count("Cache errors")}return await((t,e,n)=>{var s;return null!==(s=cd(t,e))&&void 0!==s?s:ad(t,e,n)})(r,i,e),ud(t,e,n+1)};function hd(t){let e,n,s,i;return{c(){e=Sl("span"),n=Sl("a"),s=Cl(t[0]),Dl(n,"class","hover:underline"),Dl(n,"href",i=`pdf/${t[1]}.pdf`),Dl(e,"class","flex-1 basis-1/4 pt-2 pb-8")},m(t,i){El(t,e,i),bl(e,n),bl(n,s)},p(t,[e]){1&e&&function(t,e){e=""+e,t.wholeText!==e&&(t.data=e)}(s,t[0]),2&e&&i!==(i=`pdf/${t[1]}.pdf`)&&Dl(n,"href",i)},i:ll,o:ll,d(t){t&&Tl(e)}}}function ld(t,e,n){let{name:s}=e,{path:i}=e;return t.$$set=t=>{"name"in t&&n(0,s=t.name),"path"in t&&n(1,i=t.path)},[s,i]}class dd extends Zl{constructor(t){super(),Jl(this,t,ld,hd,ml,{name:0,path:1})}}function fd(t){let e;return{c(){e=Sl("header"),e.innerHTML='<a href="/"><img class="inline-block" style="height: 2.5em;" src="./favicon.png" alt="Logo"/> \n    <h1 class="inline-block ml-4">Physics &amp; Maths Pirate</h1></a>',Dl(e,"class","my-8 flex")},m(t,n){El(t,e,n)},p:ll,i:ll,o:ll,d(t){t&&Tl(e)}}}class pd extends Zl{constructor(t){super(),Jl(this,t,null,fd,ml,{})}}function gd(t){let e;return{c(){e=Sl("p"),e.textContent="It's loading, bro..."},m(t,n){El(t,e,n)},p:ll,i:ll,o:ll,d(t){t&&Tl(e)}}}class md extends Zl{constructor(t){super(),Jl(this,t,null,gd,ml,{})}}function yd(t){let e,n;return{c(){e=Sl("p"),n=Cl("No meme today :( ... Send suggestions"),Dl(e,"class",`${bd} text-center`)},m(t,s){El(t,e,s),bl(e,n)},p:ll,d(t){t&&Tl(e)}}}function vd(t){let e,n;return{c(){e=Sl("img"),Dl(e,"class",bd),wl(e.src,n=`memes/${t[0]}`)||Dl(e,"src",n),Dl(e,"alt","Meme")},m(t,n){El(t,e,n)},p(t,s){1&s&&!wl(e.src,n=`memes/${t[0]}`)&&Dl(e,"src",n)},d(t){t&&Tl(e)}}}function wd(t){let e;function n(t,e){return t[0]?vd:yd}let s=n(t),i=s(t);return{c(){i.c(),e=Cl("")},m(t,n){i.m(t,n),El(t,e,n)},p(t,[r]){s===(s=n(t))&&i?i.p(t,r):(i.d(1),i=s(t),i&&(i.c(),i.m(e.parentNode,e)))},i:ll,o:ll,d(t){i.d(t),t&&Tl(e)}}}const bd="w-full sm:w-4/6 md:w-1/2 max-w-md mx-auto";function Ed(t,e,n){let{src:s}=e;return t.$$set=t=>{"src"in t&&n(0,s=t.src)},[s]}class Td extends Zl{constructor(t){super(),Jl(this,t,Ed,wd,ml,{src:0})}}function Id(t,e,n){const s=t.slice();return s[7]=e[n],s}function Sd(t,e,n){const s=t.slice();return s[10]=e[n],s}function Cd(t,e,n){const s=t.slice();return s[10]=e[n],s}function Ad(t){let e,n;return e=new dd({props:{name:t[10],path:`maths/${t[10]}`}}),{c(){Ql(e.$$.fragment)},m(t,s){Wl(e,t,s),n=!0},p:ll,i(t){n||(zl(e.$$.fragment,t),n=!0)},o(t){Gl(e.$$.fragment,t),n=!1},d(t){Xl(e,t)}}}function Dd(t){let e,n;return e=new dd({props:{name:t[10],path:`maths/${t[10]}`}}),{c(){Ql(e.$$.fragment)},m(t,s){Wl(e,t,s),n=!0},p:ll,i(t){n||(zl(e.$$.fragment,t),n=!0)},o(t){Gl(e.$$.fragment,t),n=!1},d(t){Xl(e,t)}}}function kd(t){let e,n;return e=new dd({props:{name:t[7],path:`physics/${t[7].toLowerCase().split(" ").join("_")}_GBD`}}),{c(){Ql(e.$$.fragment)},m(t,s){Wl(e,t,s),n=!0},p:ll,i(t){n||(zl(e.$$.fragment,t),n=!0)},o(t){Gl(e.$$.fragment,t),n=!1},d(t){Xl(e,t)}}}function _d(t){return{c:ll,m:ll,p:ll,i:ll,o:ll,d:ll}}function Nd(t){let e,n;return e=new Td({props:{src:t[6]}}),{c(){Ql(e.$$.fragment)},m(t,s){Wl(e,t,s),n=!0},p:ll,i(t){n||(zl(e.$$.fragment,t),n=!0)},o(t){Gl(e.$$.fragment,t),n=!1},d(t){Xl(e,t)}}}function xd(t){let e,n;return e=new md({}),{c(){Ql(e.$$.fragment)},m(t,s){Wl(e,t,s),n=!0},p:ll,i(t){n||(zl(e.$$.fragment,t),n=!0)},o(t){Gl(e.$$.fragment,t),n=!1},d(t){Xl(e,t)}}}function Ld(t){let e,n,s,i,r,o,a,c,u,h,l,d,f,p,g,m,y,v,w,b,E,T,I,S,C,A,D,k,_,N,x,L,O,R,M,P,F,V,$,U;e=new pd({});let B=t[1],j=[];for(let e=0;e<B.length;e+=1)j[e]=Ad(Cd(t,B,e));const q=t=>Gl(j[t],1,1,(()=>{j[t]=null}));let K=t[2],z=[];for(let e=0;e<K.length;e+=1)z[e]=Dd(Sd(t,K,e));const G=t=>Gl(z[t],1,1,(()=>{z[t]=null}));let H=t[3],Q=[];for(let e=0;e<H.length;e+=1)Q[e]=kd(Id(t,H,e));const W=t=>Gl(Q[t],1,1,(()=>{Q[t]=null}));D=new dd({props:{name:"Physics Year 2",path:"physics/Physics Year 2"}}),_=new dd({props:{name:"PiP",path:"physics/PiP"}});let X={ctx:t,current:null,token:null,hasCatch:!1,pending:xd,then:Nd,catch:_d,value:6,blocks:[,,,]};return Hl(t[0],X),{c(){Ql(e.$$.fragment),n=Al(),s=Sl("main"),i=Sl("h2"),i.textContent="Maths",r=Al(),o=Sl("div");for(let t=0;t<j.length;t+=1)j[t].c();a=Al(),c=Sl("hr"),u=Al(),h=Sl("h2"),h.textContent="Further Maths",l=Al(),d=Sl("div");for(let t=0;t<z.length;t+=1)z[t].c();f=Al(),p=Sl("p"),p.textContent="The year 1 pure and stats are dodgy older versions but I'll fix them soon.",g=Al(),m=Sl("hr"),y=Al(),v=Sl("h2"),v.textContent="GBD Booklets",w=Al(),b=Sl("div");for(let t=0;t<Q.length;t+=1)Q[t].c();E=Al(),T=Sl("hr"),I=Al(),S=Sl("h2"),S.textContent="Physics",C=Al(),A=Sl("div"),Ql(D.$$.fragment),k=Al(),Ql(_.$$.fragment),N=Al(),x=Sl("hr"),L=Al(),O=Sl("section"),R=Sl("h2"),R.textContent="Meme of the Day",M=Al(),X.block.c(),P=Al(),F=Sl("p"),F.innerHTML='<a class="hover:underline" href="archive.html">Meme Archive</a>',V=Al(),$=Sl("footer"),Dl(o,"class","book-section"),Dl(d,"class","book-section"),Dl(p,"class","epilogue"),Dl(b,"class","book-section"),Dl(A,"class","book-section"),Dl(F,"class","epilogue"),Dl(O,"id","otd")},m(t,B){Wl(e,t,B),El(t,n,B),El(t,s,B),bl(s,i),bl(s,r),bl(s,o);for(let t=0;t<j.length;t+=1)j[t].m(o,null);bl(s,a),bl(s,c),bl(s,u),bl(s,h),bl(s,l),bl(s,d);for(let t=0;t<z.length;t+=1)z[t].m(d,null);bl(s,f),bl(s,p),bl(s,g),bl(s,m),bl(s,y),bl(s,v),bl(s,w),bl(s,b);for(let t=0;t<Q.length;t+=1)Q[t].m(b,null);bl(s,E),bl(s,T),bl(s,I),bl(s,S),bl(s,C),bl(s,A),Wl(D,A,null),bl(A,k),Wl(_,A,null),El(t,N,B),El(t,x,B),El(t,L,B),El(t,O,B),bl(O,R),bl(O,M),X.block.m(O,X.anchor=null),X.mount=()=>O,X.anchor=P,bl(O,P),bl(O,F),El(t,V,B),El(t,$,B),U=!0},p(e,[n]){if(t=e,2&n){let e;for(B=t[1],e=0;e<B.length;e+=1){const s=Cd(t,B,e);j[e]?(j[e].p(s,n),zl(j[e],1)):(j[e]=Ad(s),j[e].c(),zl(j[e],1),j[e].m(o,null))}for(ql(),e=B.length;e<j.length;e+=1)q(e);Kl()}if(4&n){let e;for(K=t[2],e=0;e<K.length;e+=1){const s=Sd(t,K,e);z[e]?(z[e].p(s,n),zl(z[e],1)):(z[e]=Dd(s),z[e].c(),zl(z[e],1),z[e].m(d,null))}for(ql(),e=K.length;e<z.length;e+=1)G(e);Kl()}if(8&n){let e;for(H=t[3],e=0;e<H.length;e+=1){const s=Id(t,H,e);Q[e]?(Q[e].p(s,n),zl(Q[e],1)):(Q[e]=kd(s),Q[e].c(),zl(Q[e],1),Q[e].m(b,null))}for(ql(),e=H.length;e<Q.length;e+=1)W(e);Kl()}!function(t,e,n){const s=e.slice(),{resolved:i}=t;t.current===t.then&&(s[t.value]=i),t.current===t.catch&&(s[t.error]=i),t.block.p(s,n)}(X,t,n)},i(t){if(!U){zl(e.$$.fragment,t);for(let t=0;t<B.length;t+=1)zl(j[t]);for(let t=0;t<K.length;t+=1)zl(z[t]);for(let t=0;t<H.length;t+=1)zl(Q[t]);zl(D.$$.fragment,t),zl(_.$$.fragment,t),zl(X.block),U=!0}},o(t){Gl(e.$$.fragment,t),j=j.filter(Boolean);for(let t=0;t<j.length;t+=1)Gl(j[t]);z=z.filter(Boolean);for(let t=0;t<z.length;t+=1)Gl(z[t]);Q=Q.filter(Boolean);for(let t=0;t<Q.length;t+=1)Gl(Q[t]);Gl(D.$$.fragment,t),Gl(_.$$.fragment,t);for(let t=0;t<3;t+=1){Gl(X.blocks[t])}U=!1},d(t){Xl(e,t),t&&Tl(n),t&&Tl(s),Il(j,t),Il(z,t),Il(Q,t),Xl(D),Xl(_),t&&Tl(N),t&&Tl(x),t&&Tl(L),t&&Tl(O),X.block.d(),X.token=null,X=null,t&&Tl(V),t&&Tl($)}}}function Od(t,e,n){let{db:s}=e;const i=new Date,r=ud(i,s);return t.$$set=t=>{"db"in t&&n(4,s=t.db)},[r,["Pure Year 1","Pure Year 2","Applied Year 1","Applied Year 2"],["Further Mech","Further Pure Year 1","Further Pure Year 2","Further Stats"],["Gravitational Fields","Circular Motion","Electric Fields","Simple Harmonic Motion","Capacitors","Thermal Physics","Magnetism","Nuclear Physics","Radioactivity","Astrophysics"],s]}return new class extends Zl{constructor(t){super(),Jl(this,t,Od,Ld,ml,{db:4})}}({target:document.body,props:{db:hl}})}();
