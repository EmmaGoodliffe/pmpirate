...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "No meme today :( ... Send suggestions";
    			attr_dev(p, "class", "w-full sm:w-4/6 md:w-1/2 max-w-md mx-auto text-center");
    			add_location(p, file$2, 5, 2, 96);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$1, 5, 3, 92);
    			attr_dev(span, "class", "flex-1 py-2");
    			add_location(span, file$1, 4, 0, 63);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Doc extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { name: 0, path: 1 });
    ...
    // (15:4) {#each ["Further Mech", "Further Pure Year 1", "Further Stats"] as book}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(15:4) {#each [\\\"Further Mech\\\", \\\"Further Pure Year 1\\\", \\\"Further Stats\\\"] as book}",
    		ctx
    	});
    ...
    // (24:4) {#each ["Gravitational Fields", "Circular Motion", "Electric Fields", "Simple Harmonic Motion"] as booklet}
    function create_each_block(ctx) {
    	...
    	doc = new Doc({
    			props: {
    				name: /*booklet*/ ctx[5],
    				path: /*booklet*/ ctx[5].toLowerCase().split(" ").join("_") + "_GBD"
    			},
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(24:4) {#each [\\\"Gravitational Fields\\\", \\\"Circular Motion\\\", \\\"Electric Fields\\\", \\\"Simple Harmonic Motion\\\"] as booklet}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let each_value_1 = ["Further Mech", "Further Pure Year 1", "Further Stats"];
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			p0 = element("p");
    			p0.textContent = "The pure and stats are dodgy older versions but I'll fix them soon.";
    			t5 = space();
    			h21 = element("h2");
    			h21.textContent = "GBD Booklets";
    			t7 = space();
    			div1 = element("div");
    			...
    			add_location(h20, file, 12, 2, 347);
    			attr_dev(div0, "class", "flex flex-col sm:flex-row");
    			add_location(div0, file, 13, 2, 368);
    			attr_dev(p0, "class", "mt-12");
    			add_location(p0, file, 18, 2, 546);
    			attr_dev(h21, "class", "mt-12");
    			add_location(h21, file, 21, 2, 645);
    			attr_dev(div1, "class", "flex flex-col sm:flex-row");
    			add_location(div1, file, 22, 2, 683);
    			add_location(main, file, 11, 0, 338);
    			attr_dev(a, "class", "hover:underline");
    			attr_dev(a, "href", "archive.html");
    			add_location(a, file, 34, 4, 1045);
    			attr_dev(p1, "class", "mt-12");
    			add_location(p1, file, 33, 2, 1023);
    			attr_dev(section, "class", "mt-48");
    			add_location(section, file, 31, 0, 974);
    			attr_dev(footer, "class", "mb-4");
    			add_location(footer, file, 37, 0, 1127);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const otdSrc = memes.otd[otdCode]
    	? `memes/${memes.otd[otdCode]}`
    	: undefined;

    	const writable_props = ['memes', 'dateToString'];
    	...
    	$$self.$$set = $$props => {
    		if ('memes' in $$props) $$invalidate(1, memes = $$props.memes);
    		if ('dateToString' in $$props) $$invalidate(2, dateToString = $$props.dateToString);
    	};
    	...
    	return [otdSrc, memes, dateToString];
    }

    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { memes: 1, dateToString: 2 });
    		...
    		if (/*memes*/ ctx[1] === undefined && !('memes' in props)) {
    			console.warn("<App> was created without expected prop 'memes'");
    		}

    		if (/*dateToString*/ ctx[2] === undefined && !('dateToString' in props)) {
    			console.warn("<App> was created without expected prop 'dateToString'");
    		}
    	}
