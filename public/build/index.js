...
/**
     ...
     * limitations under the License.
     */
function Tt(e){return Promise.all(e.map((e=>e.catch((e=>e)))))}function jt(e,t,n,r){return async function(i,o,a){try{"event"===i?await async function(e,t,n,r,i){try{let o=[];if(i&&i.send_to){let e=i.send_to;Array.isArray(e)||(e=[e]);const r=await Tt(n);for(const n of e){const e=r.find((e=>e.measurementId===n)),i=e&&t[e.appId];if(!i){o=[];break}o.push(i)}}0===o.length&&(o=Object.values(t)),await Promise.all(o),e("event",r,i||{})}catch(e){kt.error(e)}}(e,t,n,o,a):"config"===i?await async function(e,t,n,r,i,o){const a=r[i];try{if(a)await t[a];else{const e=(await Tt(n)).find((e=>e.measurementId===i));e&&await t[e.appId]}}catch(e){kt.error(e)}e("config",i,o)}(e,t,n,r,o,a):e("set",o)}catch(e){kt.error(e)}}}
/**
     * @license
     * Copyright 2019 Google LLC
     *
