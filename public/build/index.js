...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(fetch.bind(self));const gl=function(t,e={}){if("object"!=typeof e){e={name:e}}const n=Object.assign({name:G,automaticDataCollectionEnabled:!1},e),s=n.name;if("string"!=typeof s||!s)throw Z.create("bad-app-name",{appName:String(s)});const i=Q.get(s);if(i){if(l(t,i.options)&&l(n,i.config))return i;throw Z.create("duplicate-app",{appName:s})}const r=new v(s);for(const t of W.values())r.addComponent(t);const o=new tt(t,n,r);return Q.set(s,o),o}({apiKey:"AIzaSyDfGaweLVDXcfxJDZ4ztoMoilhU9fv4uXU",authDomain:"pmpirate.firebaseapp.com",projectId:"pmpirate",storageBucket:"pmpirate.appspot.com",messagingSenderId:"198590478768",appId:"1:198590478768:web:3d10abd6d006c0a0b93e75",measurementId:"G-19MDLJEYQG"});!function(t=et()){const e=J(t=p(t),te);e.isInitialized()?e.getImmediate():function(t,e={}){const n=J(t,te);if(n.isInitialized()){const t=n.getImmediate();if(l(e,n.getOptions()))return t;throw re.create("already-initialized")}n.initialize({options:e})}(t)}(gl);const ml=function(t=et()){return J(t,"firestore").getImmediate()}(gl),yl=function(t=et(),e="us-central1"){return J(p(t),ul).getImmediate({identifier:e})}(gl,"europe-west2");var vl,wl;function bl(){}function El(t){return t()}function Tl(){return Object.create(null)}function Il(t){t.forEach(El)}function Sl(t){return"function"==typeof t}function Cl(t,e){return t!=t?e==e:t!==e||t&&"object"==typeof t||"function"==typeof t}let Al,Dl;function kl(t,e){return Al||(Al=document.createElement("a")),Al.href=e,t===Al.href}function _l(t,e,n,s){return t[1]&&s?function(t,e){for(const n in e)t[n]=e[n];return t}(n.ctx.slice(),t[1](s(e))):n.ctx}function Nl(t,e){t.appendChild(e)}function xl(t,e,n){t.insertBefore(e,n||null)}function Ll(t){t.parentNode.removeChild(t)}function Ol(t,e){for(let n=0;n<t.length;n+=1)t[n]&&t[n].d(e)}function Rl(t){return document.createElement(t)}function Ml(t){return document.createTextNode(t)}function Pl(){return Ml(" ")}function Fl(t,e,n){null==n?t.removeAttribute(e):t.getAttribute(e)!==n&&t.setAttribute(e,n)}function Vl(t){Dl=t}function $l(){if(!Dl)throw new Error("Function called outside component initialization");return Dl}(location.href.includes("localhost")||location.href.includes("127.0.0.1"))&&(function(t,e,s,i={}){var r;const o=(t=Bh(t,qh))._getSettings();if("firestore.googleapis.com"!==o.host&&o.host!==e&&jr("Host has been set in both settings() and useEmulator(), emulator host will be used"),t._setSettings(Object.assign(Object.assign({},o),{host:`${e}:${s}`,ssl:!1})),i.mockUserToken){let e,s;if("string"==typeof i.mockUserToken)e=i.mockUserToken,s=Pr.MOCK_USER;else{e=function(t,e){if(t.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const s=e||"demo-project",i=t.iat||0,r=t.sub||t.user_id;if(!r)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const o=Object.assign({iss:`https://securetoken.google.com/${s}`,aud:s,iat:i,exp:i+3600,auth_time:i,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}}},t);return[n(JSON.stringify({alg:"none",type:"JWT"})),n(JSON.stringify(o)),""].join(".")}(i.mockUserToken,null===(r=t._app)||void 0===r?void 0:r.options.projectId);const o=i.mockUserToken.sub||i.mockUserToken.user_id;if(!o)throw new Qr(Hr.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");s=new Pr(o)}t._authCredentials=new Jr(new Xr(e,s))}}(ml,"localhost",8080),vl="localhost",wl=5001,function(t,e,n){t.emulatorOrigin=`http://${e}:${n}`}(p(yl),vl,wl));const Ul=[],Bl=[],jl=[],ql=[],Kl=Promise.resolve();let zl=!1;function Gl(t){jl.push(t)}const Hl=new Set;let Ql=0;function Wl(){const t=Dl;do{for(;Ql<Ul.length;){const t=Ul[Ql];Ql++,Vl(t),Xl(t.$$)}for(Vl(null),Ul.length=0,Ql=0;Bl.length;)Bl.pop()();for(let t=0;t<jl.length;t+=1){const e=jl[t];Hl.has(e)||(Hl.add(e),e())}jl.length=0}while(Ul.length);for(;ql.length;)ql.pop()();zl=!1,Hl.clear(),Vl(t)}function Xl(t){if(null!==t.fragment){t.update(),Il(t.before_update);const e=t.dirty;t.dirty=[-1],t.fragment&&t.fragment.p(t.ctx,e),t.after_update.forEach(Gl)}}const Yl=new Set;let Jl;function Zl(){Jl={r:0,c:[],p:Jl}}function td(){Jl.r||Il(Jl.c),Jl=Jl.p}function ed(t,e){t&&t.i&&(Yl.delete(t),t.i(e))}function nd(t,e,n,s){if(t&&t.o){if(Yl.has(t))return;Yl.add(t),Jl.c.push((()=>{Yl.delete(t),s&&(n&&t.d(1),s())})),t.o(e)}else s&&s()}function sd(t,e){const n=e.token={};function s(t,s,i,r){if(e.token!==n)return;e.resolved=r;let o=e.ctx;void 0!==i&&(o=o.slice(),o[i]=r);const a=t&&(e.current=t)(o);let c=!1;e.block&&(e.blocks?e.blocks.forEach(((t,n)=>{n!==s&&t&&(Zl(),nd(t,1,1,(()=>{e.blocks[n]===t&&(e.blocks[n]=null)})),td())})):e.block.d(1),a.c(),ed(a,1),a.m(e.mount(),e.anchor),c=!0),e.block=a,e.blocks&&(e.blocks[s]=a),c&&Wl()}if((i=t)&&"object"==typeof i&&"function"==typeof i.then){const n=$l();if(t.then((t=>{Vl(n),s(e.then,1,e.value,t),Vl(null)}),(t=>{if(Vl(n),s(e.catch,2,e.error,t),Vl(null),!e.hasCatch)throw t})),e.current!==e.pending)return s(e.pending,0),!0}else{if(e.current!==e.then)return s(e.then,1,e.value,t),!0;e.resolved=t}var i}function id(t){t&&t.c()}function rd(t,e,n,s){const{fragment:i,on_mount:r,on_destroy:o,after_update:a}=t.$$;i&&i.m(e,n),s||Gl((()=>{const e=r.map(El).filter(Sl);o?o.push(...e):Il(e),t.$$.on_mount=[]})),a.forEach(Gl)}function od(t,e){const n=t.$$;null!==n.fragment&&(Il(n.on_destroy),n.fragment&&n.fragment.d(e),n.on_destroy=n.fragment=null,n.ctx=[])}function ad(t,e){-1===t.$$.dirty[0]&&(Ul.push(t),zl||(zl=!0,Kl.then(Wl)),t.$$.dirty.fill(0)),t.$$.dirty[e/31|0]|=1<<e%31}function cd(t,e,n,s,i,r,o,a=[-1]){const c=Dl;Vl(t);const u=t.$$={fragment:null,ctx:null,props:r,update:bl,not_equal:i,bound:Tl(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(c?c.$$.context:[])),callbacks:Tl(),dirty:a,skip_bound:!1,root:e.target||c.$$.root};o&&o(u.root);let h=!1;if(u.ctx=n?n(t,e.props||{},((e,n,...s)=>{const r=s.length?s[0]:n;return u.ctx&&i(u.ctx[e],u.ctx[e]=r)&&(!u.skip_bound&&u.bound[e]&&u.bound[e](r),h&&ad(t,e)),n})):[],u.update(),h=!0,Il(u.before_update),u.fragment=!!s&&s(u.ctx),e.target){if(e.hydrate){const t=function(t){return Array.from(t.childNodes)}(e.target);u.fragment&&u.fragment.l(t),t.forEach(Ll)}else u.fragment&&u.fragment.c();e.intro&&ed(t.$$.fragment),rd(t,e.target,e.anchor,e.customElement),Wl()}Vl(c)}class ud{$destroy(){od(this,1),this.$destroy=bl}$on(t,e){const n=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return n.push(e),()=>{const t=n.indexOf(e);-1!==t&&n.splice(t,1)}}$set(t){var e;this.$$set&&(e=t,0!==Object.keys(e).length)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}const hd=t=>{const e=parseInt(t);if(!isNaN(e))return e;const n=["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"].indexOf(t);return-1===n?n+1:NaN},ld=t=>[t.getDate(),t.getMonth()+1,t.getFullYear()],dd=(t,e,n)=>new Date(n,e-1,t),fd=t=>{const e=`${t}`;return e.length<=2?fd("20"+e.padStart(2,"0")):3===e.length?NaN:parseInt(e)},pd=t=>(t=>{const e=["/","-","."];for(const n of e){const[e,s,i]=t.split(n).map(hd),r=dd(null!=e?e:NaN,null!=s?s:NaN,fd(null!=i?i:NaN));if(![e,s,i].some((t=>!t))&&"Invalid Date"!=`${r}`)return r}for(const n of e){const[e,s,i]=t.split(n).map(hd),r=dd(null!=i?i:NaN,null!=s?s:NaN,fd(null!=e?e:NaN));if(![i,s,e].some((t=>!t))&&"Invalid Date"!=`${r}`)return r}const n=new Date(t);if("Invalid Date"!=`${n}`)return n})(((t,e="/",n=!1)=>{const[s,i,r]=ld(t).map((t=>`${t}`)),o=[s.padStart(2,"0"),i.padStart(2,"0"),r];return(n?o.reverse():o).join(e)})(t)),gd=()=>pd(new Date),md={},yd=new Set,vd=dd(1,9,2021);async function wd(t,e,n){try{return console.count("DB reads"),console.count(n),(await al(function(t,e,...n){if(t=p(t),1===arguments.length&&(e=ro.I()),$h("doc","path",e),t instanceof qh){const s=lo.fromString(e,...n);return Uh(s),new Kh(t,null,new go(s))}{if(!(t instanceof Kh||t instanceof Gh))throw new Qr(Hr.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=t._path.child(lo.fromString(e,...n));return Uh(s),new Kh(t.firestore,t instanceof Gh?t.converter:null,new go(s))}}(t,e,n))).data()}catch(t){console.warn("Your DB emulations are likely not running correctly"),console.error(t)}}const bd=(t,e)=>{const n=dd(1,e,t),s=gd(),i=ld(s)[2];return vd<=n&&t<=i},Ed=async(t,e,n)=>{var s;if(!bd(e,n))return null;const i=((t,e)=>`${t}-${`${e}`.padStart(2,"0")}`)(e,n);if(yd.has(i))return await(r=1,new Promise((t=>setTimeout(t,1e3*r)))),Td(e,n);var r;yd.add(i);const o=null!==(s=await wd(t,"memes",i))&&void 0!==s?s:{};return((t,e,n)=>{md[t]||(md[t]={}),md[t][e]=n})(e,n,o),yd.delete(i),o},Td=(t,e)=>{try{return md[t][e]}catch(t){console.count("Cache errors")}},Id=async(t,e,n=0)=>{if(!e)return null;if(n>=12)throw new Error("DB recursion");const[s,i,r]=ld(e);if(!bd(r,i))return null;try{return md[r][i][s]}catch(t){console.count("Cache errors")}return await((t,e,n)=>{var s;return null!==(s=Td(t,e))&&void 0!==s?s:Ed(n,t,e)})(r,i,t),Id(t,e,n+1)};function Sd(t){let e,n,s,i;return{c(){e=Rl("span"),n=Rl("a"),s=Ml(t[0]),Fl(n,"class","hover:underline"),Fl(n,"href",i=`pdf/${t[1]}.pdf`),Fl(e,"class","flex-1 basis-1/4 pt-2 pb-8")},m(t,i){xl(t,e,i),Nl(e,n),Nl(n,s)},p(t,[e]){1&e&&function(t,e){e=""+e,t.wholeText!==e&&(t.data=e)}(s,t[0]),2&e&&i!==(i=`pdf/${t[1]}.pdf`)&&Fl(n,"href",i)},i:bl,o:bl,d(t){t&&Ll(e)}}}function Cd(t,e,n){let{name:s}=e,{path:i}=e;return t.$$set=t=>{"name"in t&&n(0,s=t.name),"path"in t&&n(1,i=t.path)},[s,i]}class Ad extends ud{constructor(t){super(),cd(this,t,Cd,Sd,Cl,{name:0,path:1})}}function Dd(t){let e;return{c(){e=Rl("header"),e.innerHTML='<a class="flex" href="/"><img class="inline-block" style="height: 2.5em;" src="./favicon.png" alt="Logo"/> \n    <h1 class="inline-block ml-4">Physics &amp; Maths Pirate</h1></a>',Fl(e,"class","my-8")},m(t,n){xl(t,e,n)},p:bl,i:bl,o:bl,d(t){t&&Ll(e)}}}class kd extends ud{constructor(t){super(),cd(this,t,null,Dd,Cl,{})}}function _d(t){let e;return{c(){e=Rl("footer")},m(t,n){xl(t,e,n)},p:bl,i:bl,o:bl,d(t){t&&Ll(e)}}}class Nd extends ud{constructor(t){super(),cd(this,t,null,_d,Cl,{})}}function xd(t){let e;return{c(){e=Rl("p"),e.textContent="It's loading, bro..."},m(t,n){xl(t,e,n)},p:bl,i:bl,o:bl,d(t){t&&Ll(e)}}}class Ld extends ud{constructor(t){super(),cd(this,t,null,xd,Cl,{})}}function Od(t){let e,n;const s=t[4].default,i=function(t,e,n,s){if(t){const i=_l(t,e,n,s);return t[0](i)}}(s,t,t[3],null),r=i||function(t){let e;return{c(){e=Ml(Fd)},m(t,n){xl(t,e,n)},p:bl,d(t){t&&Ll(e)}}}();return{c(){e=Rl("p"),r&&r.c(),Fl(e,"class",`${Pd} text-center`)},m(t,s){xl(t,e,s),r&&r.m(e,null),n=!0},p(t,e){i&&i.p&&(!n||8&e)&&function(t,e,n,s,i,r){if(i){const o=_l(e,n,s,r);t.p(o,i)}}(i,s,t,t[3],n?function(t,e,n,s){if(t[2]&&s){const i=t[2](s(n));if(void 0===e.dirty)return i;if("object"==typeof i){const t=[],n=Math.max(e.dirty.length,i.length);for(let s=0;s<n;s+=1)t[s]=e.dirty[s]|i[s];return t}return e.dirty|i}return e.dirty}(s,t[3],e,null):function(t){if(t.ctx.length>32){const e=[],n=t.ctx.length/32;for(let t=0;t<n;t++)e[t]=-1;return e}return-1}(t[3]),null)},i(t){n||(ed(r,t),n=!0)},o(t){nd(r,t),n=!1},d(t){t&&Ll(e),r&&r.d(t)}}}function Rd(t){let e,n,s,i,r,o;return{c(){e=Rl("img"),Fl(e,"class",n=Pd+" md:w-1/2"+(isNaN(t[1])?" max-w-md":"")),Fl(e,"style",s=t[1]?`width: ${t[1]}px`:""),kl(e.src,i=t[0])||Fl(e,"src",i),Fl(e,"alt","Meme")},m(n,s){var i,a,c,u;xl(n,e,s),r||(i=e,a="error",c=t[5],i.addEventListener(a,c,u),o=()=>i.removeEventListener(a,c,u),r=!0)},p(t,r){2&r&&n!==(n=Pd+" md:w-1/2"+(isNaN(t[1])?" max-w-md":""))&&Fl(e,"class",n),2&r&&s!==(s=t[1]?`width: ${t[1]}px`:"")&&Fl(e,"style",s),1&r&&!kl(e.src,i=t[0])&&Fl(e,"src",i)},i:bl,o:bl,d(t){t&&Ll(e),r=!1,o()}}}function Md(t){let e,n,s,i;const r=[Rd,Od],o=[];function a(t,e){return t[0]&&!t[2]?0:1}return e=a(t),n=o[e]=r[e](t),{c(){n.c(),s=Ml("")},m(t,n){o[e].m(t,n),xl(t,s,n),i=!0},p(t,[i]){let c=e;e=a(t),e===c?o[e].p(t,i):(Zl(),nd(o[c],1,1,(()=>{o[c]=null})),td(),n=o[e],n?n.p(t,i):(n=o[e]=r[e](t),n.c()),ed(n,1),n.m(s.parentNode,s))},i(t){i||(ed(n),i=!0)},o(t){nd(n),i=!1},d(t){o[e].d(t),t&&Ll(s)}}}let Pd="mx-auto w-full sm:w-4/6";const Fd="Couldn't load meme :(";function Vd(t,e,n){let{$$slots:s={},$$scope:i}=e,{url:r=""}=e,{width:o=NaN}=e,a=!1;return t.$$set=t=>{"url"in t&&n(0,r=t.url),"width"in t&&n(1,o=t.width),"$$scope"in t&&n(3,i=t.$$scope)},t.$$.update=()=>{1&t.$$.dirty&&n(2,a=!1)},[r,o,a,i,s,()=>{n(2,a=!0),console.log("Detected error")}]}class $d extends ud{constructor(t){super(),cd(this,t,Vd,Md,Cl,{url:0,width:1})}}function Ud(t,e,n){const s=t.slice();return s[7]=e[n],s}function Bd(t,e,n){const s=t.slice();return s[10]=e[n],s}function jd(t,e,n){const s=t.slice();return s[10]=e[n],s}function qd(t){let e,n;return e=new Ad({props:{name:t[10],path:`maths/${t[10]}`}}),{c(){id(e.$$.fragment)},m(t,s){rd(e,t,s),n=!0},p:bl,i(t){n||(ed(e.$$.fragment,t),n=!0)},o(t){nd(e.$$.fragment,t),n=!1},d(t){od(e,t)}}}function Kd(t){let e,n;return e=new Ad({props:{name:t[10],path:`maths/${t[10]}`}}),{c(){id(e.$$.fragment)},m(t,s){rd(e,t,s),n=!0},p:bl,i(t){n||(ed(e.$$.fragment,t),n=!0)},o(t){nd(e.$$.fragment,t),n=!1},d(t){od(e,t)}}}function zd(t){let e,n;return e=new Ad({props:{name:t[7],path:`physics/${t[7].toLowerCase().split(" ").join("_")}_GBD`}}),{c(){id(e.$$.fragment)},m(t,s){rd(e,t,s),n=!0},p:bl,i(t){n||(ed(e.$$.fragment,t),n=!0)},o(t){nd(e.$$.fragment,t),n=!1},d(t){od(e,t)}}}function Gd(t){return{c:bl,m:bl,p:bl,i:bl,o:bl,d:bl}}function Hd(t){let e,n;return e=new $d({props:{url:t[6]?.url,$$slots:{default:[Qd]},$$scope:{ctx:t}}}),{c(){id(e.$$.fragment)},m(t,s){rd(e,t,s),n=!0},p(t,n){const s={};32768&n&&(s.$$scope={dirty:n,ctx:t}),e.$set(s)},i(t){n||(ed(e.$$.fragment,t),n=!0)},o(t){nd(e.$$.fragment,t),n=!1},d(t){od(e,t)}}}function Qd(t){let e,n,s,i;return{c(){e=Ml("No meme today :( ... "),n=Rl("a"),n.textContent="Send suggestions",s=Ml("\n      or "),i=Rl("a"),i.textContent="upload one",Fl(n,"class","hover:underline"),Fl(n,"href","mailto:emma.goodliffe@spgs.org"),Fl(i,"class","hover:underline"),Fl(i,"href","schedule.html")},m(t,r){xl(t,e,r),xl(t,n,r),xl(t,s,r),xl(t,i,r)},p:bl,d(t){t&&Ll(e),t&&Ll(n),t&&Ll(s),t&&Ll(i)}}}function Wd(t){let e,n;return e=new Ld({}),{c(){id(e.$$.fragment)},m(t,s){rd(e,t,s),n=!0},p:bl,i(t){n||(ed(e.$$.fragment,t),n=!0)},o(t){nd(e.$$.fragment,t),n=!1},d(t){od(e,t)}}}function Xd(t){let e,n,s,i,r,o,a,c,u,h,l,d,f,p,g,m,y,v,w,b,E,T,I,S,C,A,D,k,_,N,x,L,O,R,M,P,F,V,$,U,B,j;e=new kd({});let q=t[1],K=[];for(let e=0;e<q.length;e+=1)K[e]=qd(jd(t,q,e));const z=t=>nd(K[t],1,1,(()=>{K[t]=null}));let G=t[2],H=[];for(let e=0;e<G.length;e+=1)H[e]=Kd(Bd(t,G,e));const Q=t=>nd(H[t],1,1,(()=>{H[t]=null}));let W=t[3],X=[];for(let e=0;e<W.length;e+=1)X[e]=zd(Ud(t,W,e));const Y=t=>nd(X[t],1,1,(()=>{X[t]=null}));D=new Ad({props:{name:"Physics Year 2",path:"physics/Physics Year 2"}}),_=new Ad({props:{name:"PiP",path:"physics/PiP"}});let J={ctx:t,current:null,token:null,hasCatch:!1,pending:Wd,then:Hd,catch:Gd,value:6,blocks:[,,,]};return sd(t[0],J),B=new Nd({}),{c(){id(e.$$.fragment),n=Pl(),s=Rl("main"),i=Rl("h2"),i.textContent="Maths",r=Pl(),o=Rl("div");for(let t=0;t<K.length;t+=1)K[t].c();a=Pl(),c=Rl("hr"),u=Pl(),h=Rl("h2"),h.textContent="Further Maths",l=Pl(),d=Rl("div");for(let t=0;t<H.length;t+=1)H[t].c();f=Pl(),p=Rl("p"),p.textContent="The year 1 pure and stats are dodgy older versions but I'll fix them soon.",g=Pl(),m=Rl("hr"),y=Pl(),v=Rl("h2"),v.textContent="GBD Booklets",w=Pl(),b=Rl("div");for(let t=0;t<X.length;t+=1)X[t].c();E=Pl(),T=Rl("hr"),I=Pl(),S=Rl("h2"),S.textContent="Physics",C=Pl(),A=Rl("div"),id(D.$$.fragment),k=Pl(),id(_.$$.fragment),N=Pl(),x=Rl("hr"),L=Pl(),O=Rl("section"),R=Rl("h2"),R.textContent="Meme of the Day",M=Pl(),J.block.c(),P=Pl(),F=Rl("hr"),V=Pl(),$=Rl("section"),$.innerHTML='<h2>Meme Archive</h2> \n  <p class="epilogue"><a class="hover:underline" href="archive.html">Meme Archive</a></p>',U=Pl(),id(B.$$.fragment),Fl(o,"class","book-section"),Fl(d,"class","book-section"),Fl(p,"class","epilogue"),Fl(b,"class","book-section"),Fl(A,"class","book-section"),Fl(O,"id","otd")},m(t,q){rd(e,t,q),xl(t,n,q),xl(t,s,q),Nl(s,i),Nl(s,r),Nl(s,o);for(let t=0;t<K.length;t+=1)K[t].m(o,null);Nl(s,a),Nl(s,c),Nl(s,u),Nl(s,h),Nl(s,l),Nl(s,d);for(let t=0;t<H.length;t+=1)H[t].m(d,null);Nl(s,f),Nl(s,p),Nl(s,g),Nl(s,m),Nl(s,y),Nl(s,v),Nl(s,w),Nl(s,b);for(let t=0;t<X.length;t+=1)X[t].m(b,null);Nl(s,E),Nl(s,T),Nl(s,I),Nl(s,S),Nl(s,C),Nl(s,A),rd(D,A,null),Nl(A,k),rd(_,A,null),xl(t,N,q),xl(t,x,q),xl(t,L,q),xl(t,O,q),Nl(O,R),Nl(O,M),J.block.m(O,J.anchor=null),J.mount=()=>O,J.anchor=null,xl(t,P,q),xl(t,F,q),xl(t,V,q),xl(t,$,q),xl(t,U,q),rd(B,t,q),j=!0},p(e,[n]){if(t=e,2&n){let e;for(q=t[1],e=0;e<q.length;e+=1){const s=jd(t,q,e);K[e]?(K[e].p(s,n),ed(K[e],1)):(K[e]=qd(s),K[e].c(),ed(K[e],1),K[e].m(o,null))}for(Zl(),e=q.length;e<K.length;e+=1)z(e);td()}if(4&n){let e;for(G=t[2],e=0;e<G.length;e+=1){const s=Bd(t,G,e);H[e]?(H[e].p(s,n),ed(H[e],1)):(H[e]=Kd(s),H[e].c(),ed(H[e],1),H[e].m(d,null))}for(Zl(),e=G.length;e<H.length;e+=1)Q(e);td()}if(8&n){let e;for(W=t[3],e=0;e<W.length;e+=1){const s=Ud(t,W,e);X[e]?(X[e].p(s,n),ed(X[e],1)):(X[e]=zd(s),X[e].c(),ed(X[e],1),X[e].m(b,null))}for(Zl(),e=W.length;e<X.length;e+=1)Y(e);td()}!function(t,e,n){const s=e.slice(),{resolved:i}=t;t.current===t.then&&(s[t.value]=i),t.current===t.catch&&(s[t.error]=i),t.block.p(s,n)}(J,t,n)},i(t){if(!j){ed(e.$$.fragment,t);for(let t=0;t<q.length;t+=1)ed(K[t]);for(let t=0;t<G.length;t+=1)ed(H[t]);for(let t=0;t<W.length;t+=1)ed(X[t]);ed(D.$$.fragment,t),ed(_.$$.fragment,t),ed(J.block),ed(B.$$.fragment,t),j=!0}},o(t){nd(e.$$.fragment,t),K=K.filter(Boolean);for(let t=0;t<K.length;t+=1)nd(K[t]);H=H.filter(Boolean);for(let t=0;t<H.length;t+=1)nd(H[t]);X=X.filter(Boolean);for(let t=0;t<X.length;t+=1)nd(X[t]);nd(D.$$.fragment,t),nd(_.$$.fragment,t);for(let t=0;t<3;t+=1){nd(J.blocks[t])}nd(B.$$.fragment,t),j=!1},d(t){od(e,t),t&&Ll(n),t&&Ll(s),Ol(K,t),Ol(H,t),Ol(X,t),od(D),od(_),t&&Ll(N),t&&Ll(x),t&&Ll(L),t&&Ll(O),J.block.d(),J.token=null,J=null,t&&Ll(P),t&&Ll(F),t&&Ll(V),t&&Ll($),t&&Ll(U),od(B,t)}}}function Yd(t,e,n){let{db:s}=e;const i=gd(),r=Id(s,i);return t.$$set=t=>{"db"in t&&n(4,s=t.db)},[r,["Pure Year 1","Pure Year 2","Applied Year 1","Applied Year 2"],["Further Mech","Further Pure Year 1","Further Pure Year 2","Further Stats"],["Gravitational Fields","Circular Motion","Electric Fields","Simple Harmonic Motion","Capacitors","Thermal Physics","Magnetism","Nuclear Physics","Radioactivity","Astrophysics"],s]}return new class extends ud{constructor(t){super(),cd(this,t,Yd,Xd,Cl,{db:4})}}({target:document.body,props:{db:ml}})}();
