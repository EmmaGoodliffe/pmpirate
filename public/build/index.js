...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(fetch.bind(self));const gl=function(t,e={}){if("object"!=typeof e){e={name:e}}const n=Object.assign({name:G,automaticDataCollectionEnabled:!1},e),s=n.name;if("string"!=typeof s||!s)throw Z.create("bad-app-name",{appName:String(s)});const i=Q.get(s);if(i){if(l(t,i.options)&&l(n,i.config))return i;throw Z.create("duplicate-app",{appName:s})}const r=new v(s);for(const t of W.values())r.addComponent(t);const o=new tt(t,n,r);return Q.set(s,o),o}({apiKey:"AIzaSyDfGaweLVDXcfxJDZ4ztoMoilhU9fv4uXU",authDomain:"pmpirate.firebaseapp.com",projectId:"pmpirate",storageBucket:"pmpirate.appspot.com",messagingSenderId:"198590478768",appId:"1:198590478768:web:3d10abd6d006c0a0b93e75",measurementId:"G-19MDLJEYQG"});!function(t=et()){const e=J(t=p(t),te);e.isInitialized()?e.getImmediate():function(t,e={}){const n=J(t,te);if(n.isInitialized()){const t=n.getImmediate();if(l(e,n.getOptions()))return t;throw re.create("already-initialized")}n.initialize({options:e})}(t)}(gl);const ml=function(t=et()){return J(t,"firestore").getImmediate()}(gl),yl=function(t=et(),e="us-central1"){return J(p(t),ul).getImmediate({identifier:e})}(gl,"europe-west2");var vl,wl;function bl(){}function El(t){return t()}function Tl(){return Object.create(null)}function Il(t){t.forEach(El)}function Sl(t){return"function"==typeof t}function Cl(t,e){return t!=t?e==e:t!==e||t&&"object"==typeof t||"function"==typeof t}let Al,Dl;function kl(t,e){return Al||(Al=document.createElement("a")),Al.href=e,t===Al.href}function _l(t,e){t.appendChild(e)}function Nl(t,e,n){t.insertBefore(e,n||null)}function xl(t){t.parentNode.removeChild(t)}function Ll(t,e){for(let n=0;n<t.length;n+=1)t[n]&&t[n].d(e)}function Ol(t){return document.createElement(t)}function Rl(t){return document.createTextNode(t)}function Ml(){return Rl(" ")}function Pl(t,e,n){null==n?t.removeAttribute(e):t.getAttribute(e)!==n&&t.setAttribute(e,n)}function Fl(t){Dl=t}function Vl(){if(!Dl)throw new Error("Function called outside component initialization");return Dl}(location.href.includes("localhost")||location.href.includes("127.0.0.1"))&&(function(t,e,s,i={}){var r;const o=(t=Bh(t,qh))._getSettings();if("firestore.googleapis.com"!==o.host&&o.host!==e&&jr("Host has been set in both settings() and useEmulator(), emulator host will be used"),t._setSettings(Object.assign(Object.assign({},o),{host:`${e}:${s}`,ssl:!1})),i.mockUserToken){let e,s;if("string"==typeof i.mockUserToken)e=i.mockUserToken,s=Pr.MOCK_USER;else{e=function(t,e){if(t.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const s=e||"demo-project",i=t.iat||0,r=t.sub||t.user_id;if(!r)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const o=Object.assign({iss:`https://securetoken.google.com/${s}`,aud:s,iat:i,exp:i+3600,auth_time:i,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}}},t);return[n(JSON.stringify({alg:"none",type:"JWT"})),n(JSON.stringify(o)),""].join(".")}(i.mockUserToken,null===(r=t._app)||void 0===r?void 0:r.options.projectId);const o=i.mockUserToken.sub||i.mockUserToken.user_id;if(!o)throw new Qr(Hr.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");s=new Pr(o)}t._authCredentials=new Jr(new Xr(e,s))}}(ml,"localhost",8080),vl="localhost",wl=5001,function(t,e,n){t.emulatorOrigin=`http://${e}:${n}`}(p(yl),vl,wl));const $l=[],Ul=[],Bl=[],jl=[],ql=Promise.resolve();let Kl=!1;function zl(t){Bl.push(t)}const Gl=new Set;let Hl=0;function Ql(){const t=Dl;do{for(;Hl<$l.length;){const t=$l[Hl];Hl++,Fl(t),Wl(t.$$)}for(Fl(null),$l.length=0,Hl=0;Ul.length;)Ul.pop()();for(let t=0;t<Bl.length;t+=1){const e=Bl[t];Gl.has(e)||(Gl.add(e),e())}Bl.length=0}while($l.length);for(;jl.length;)jl.pop()();Kl=!1,Gl.clear(),Fl(t)}function Wl(t){if(null!==t.fragment){t.update(),Il(t.before_update);const e=t.dirty;t.dirty=[-1],t.fragment&&t.fragment.p(t.ctx,e),t.after_update.forEach(zl)}}const Xl=new Set;let Yl;function Jl(){Yl={r:0,c:[],p:Yl}}function Zl(){Yl.r||Il(Yl.c),Yl=Yl.p}function td(t,e){t&&t.i&&(Xl.delete(t),t.i(e))}function ed(t,e,n,s){if(t&&t.o){if(Xl.has(t))return;Xl.add(t),Yl.c.push((()=>{Xl.delete(t),s&&(n&&t.d(1),s())})),t.o(e)}else s&&s()}function nd(t,e){const n=e.token={};function s(t,s,i,r){if(e.token!==n)return;e.resolved=r;let o=e.ctx;void 0!==i&&(o=o.slice(),o[i]=r);const a=t&&(e.current=t)(o);let c=!1;e.block&&(e.blocks?e.blocks.forEach(((t,n)=>{n!==s&&t&&(Jl(),ed(t,1,1,(()=>{e.blocks[n]===t&&(e.blocks[n]=null)})),Zl())})):e.block.d(1),a.c(),td(a,1),a.m(e.mount(),e.anchor),c=!0),e.block=a,e.blocks&&(e.blocks[s]=a),c&&Ql()}if((i=t)&&"object"==typeof i&&"function"==typeof i.then){const n=Vl();if(t.then((t=>{Fl(n),s(e.then,1,e.value,t),Fl(null)}),(t=>{if(Fl(n),s(e.catch,2,e.error,t),Fl(null),!e.hasCatch)throw t})),e.current!==e.pending)return s(e.pending,0),!0}else{if(e.current!==e.then)return s(e.then,1,e.value,t),!0;e.resolved=t}var i}function sd(t){t&&t.c()}function id(t,e,n,s){const{fragment:i,on_mount:r,on_destroy:o,after_update:a}=t.$$;i&&i.m(e,n),s||zl((()=>{const e=r.map(El).filter(Sl);o?o.push(...e):Il(e),t.$$.on_mount=[]})),a.forEach(zl)}function rd(t,e){const n=t.$$;null!==n.fragment&&(Il(n.on_destroy),n.fragment&&n.fragment.d(e),n.on_destroy=n.fragment=null,n.ctx=[])}function od(t,e){-1===t.$$.dirty[0]&&($l.push(t),Kl||(Kl=!0,ql.then(Ql)),t.$$.dirty.fill(0)),t.$$.dirty[e/31|0]|=1<<e%31}function ad(t,e,n,s,i,r,o,a=[-1]){const c=Dl;Fl(t);const u=t.$$={fragment:null,ctx:null,props:r,update:bl,not_equal:i,bound:Tl(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(c?c.$$.context:[])),callbacks:Tl(),dirty:a,skip_bound:!1,root:e.target||c.$$.root};o&&o(u.root);let h=!1;if(u.ctx=n?n(t,e.props||{},((e,n,...s)=>{const r=s.length?s[0]:n;return u.ctx&&i(u.ctx[e],u.ctx[e]=r)&&(!u.skip_bound&&u.bound[e]&&u.bound[e](r),h&&od(t,e)),n})):[],u.update(),h=!0,Il(u.before_update),u.fragment=!!s&&s(u.ctx),e.target){if(e.hydrate){const t=function(t){return Array.from(t.childNodes)}(e.target);u.fragment&&u.fragment.l(t),t.forEach(xl)}else u.fragment&&u.fragment.c();e.intro&&td(t.$$.fragment),id(t,e.target,e.anchor,e.customElement),Ql()}Fl(c)}class cd{$destroy(){rd(this,1),this.$destroy=bl}$on(t,e){const n=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return n.push(e),()=>{const t=n.indexOf(e);-1!==t&&n.splice(t,1)}}$set(t){var e;this.$$set&&(e=t,0!==Object.keys(e).length)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}const ud=t=>{const e=parseInt(t);if(!isNaN(e))return e;const n=["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"].indexOf(t);return-1===n?n+1:NaN},hd=t=>[t.getDate(),t.getMonth()+1,t.getFullYear()],ld=(t,e,n)=>new Date(n,e-1,t),dd=t=>{const e=`${t}`;return e.length<=2?dd("20"+e.padStart(2,"0")):3===e.length?NaN:parseInt(e)},fd=t=>(t=>{const e=["/","-","."];for(const n of e){const[e,s,i]=t.split(n).map(ud),r=ld(null!=e?e:NaN,null!=s?s:NaN,dd(null!=i?i:NaN));if(![e,s,i].some((t=>!t))&&"Invalid Date"!=`${r}`)return r}for(const n of e){const[e,s,i]=t.split(n).map(ud),r=ld(null!=i?i:NaN,null!=s?s:NaN,dd(null!=e?e:NaN));if(![i,s,e].some((t=>!t))&&"Invalid Date"!=`${r}`)return r}const n=new Date(t);if("Invalid Date"!=`${n}`)return n})(((t,e="/",n=!1)=>{const[s,i,r]=hd(t).map((t=>`${t}`)),o=[s.padStart(2,"0"),i.padStart(2,"0"),r];return(n?o.reverse():o).join(e)})(t)),pd={},gd=new Set,md=ld(1,9,2021);async function yd(t,e,n){try{return console.count("DB reads"),console.count(n),(await al(function(t,e,...n){if(t=p(t),1===arguments.length&&(e=ro.I()),$h("doc","path",e),t instanceof qh){const s=lo.fromString(e,...n);return Uh(s),new Kh(t,null,new go(s))}{if(!(t instanceof Kh||t instanceof Gh))throw new Qr(Hr.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=t._path.child(lo.fromString(e,...n));return Uh(s),new Kh(t.firestore,t instanceof Gh?t.converter:null,new go(s))}}(t,e,n))).data()}catch(t){console.warn("Your DB emulations are likely not running correctly"),console.error(t)}}const vd=(t,e)=>{const n=ld(1,e,t),s=new Date,i=hd(s)[2];return md<=n&&t<=i},wd=async(t,e,n)=>{var s;if(!vd(t,e))return null;const i=((t,e)=>`${t}-${`${e}`.padStart(2,"0")}`)(t,e);if(gd.has(i))return await(r=1,new Promise((t=>setTimeout(t,1e3*r)))),bd(t,e);var r;gd.add(i);const o=null!==(s=await yd(n,"memes",i))&&void 0!==s?s:{};return((t,e,n)=>{pd[t]||(pd[t]={}),pd[t][e]=n})(t,e,o),gd.delete(i),o},bd=(t,e)=>{try{return pd[t][e]}catch(t){console.count("Cache errors")}},Ed=async(t,e,n=0)=>{if(!t)return null;if(n>=12)throw new Error("DB recursion");const[s,i,r]=hd(t);if(!vd(r,i))return null;try{return pd[r][i][s]}catch(t){console.count("Cache errors")}return await((t,e,n)=>{var s;return null!==(s=bd(t,e))&&void 0!==s?s:wd(t,e,n)})(r,i,e),Ed(t,e,n+1)};function Td(t){let e,n,s,i;return{c(){e=Ol("span"),n=Ol("a"),s=Rl(t[0]),Pl(n,"class","hover:underline"),Pl(n,"href",i=`pdf/${t[1]}.pdf`),Pl(e,"class","flex-1 basis-1/4 pt-2 pb-8")},m(t,i){Nl(t,e,i),_l(e,n),_l(n,s)},p(t,[e]){1&e&&function(t,e){e=""+e,t.wholeText!==e&&(t.data=e)}(s,t[0]),2&e&&i!==(i=`pdf/${t[1]}.pdf`)&&Pl(n,"href",i)},i:bl,o:bl,d(t){t&&xl(e)}}}function Id(t,e,n){let{name:s}=e,{path:i}=e;return t.$$set=t=>{"name"in t&&n(0,s=t.name),"path"in t&&n(1,i=t.path)},[s,i]}class Sd extends cd{constructor(t){super(),ad(this,t,Id,Td,Cl,{name:0,path:1})}}function Cd(t){let e;return{c(){e=Ol("header"),e.innerHTML='<a href="/"><img class="inline-block" style="height: 2.5em;" src="./favicon.png" alt="Logo"/> \n    <h1 class="inline-block ml-4">Physics &amp; Maths Pirate</h1></a>',Pl(e,"class","my-8 flex")},m(t,n){Nl(t,e,n)},p:bl,i:bl,o:bl,d(t){t&&xl(e)}}}class Ad extends cd{constructor(t){super(),ad(this,t,null,Cd,Cl,{})}}function Dd(t){let e;return{c(){e=Ol("p"),e.textContent="It's loading, bro..."},m(t,n){Nl(t,e,n)},p:bl,i:bl,o:bl,d(t){t&&xl(e)}}}class kd extends cd{constructor(t){super(),ad(this,t,null,Dd,Cl,{})}}function _d(t){let e,n;return{c(){e=Ol("p"),n=Rl("No meme today :( ... Send suggestions"),Pl(e,"class",`${Ld} text-center`)},m(t,s){Nl(t,e,s),_l(e,n)},p:bl,d(t){t&&xl(e)}}}function Nd(t){let e,n;return{c(){e=Ol("img"),Pl(e,"class",Ld),kl(e.src,n=`memes/${t[0].url}`)||Pl(e,"src",n),Pl(e,"alt","Meme")},m(t,n){Nl(t,e,n)},p(t,s){1&s&&!kl(e.src,n=`memes/${t[0].url}`)&&Pl(e,"src",n)},d(t){t&&xl(e)}}}function xd(t){let e;function n(t,e){return t[0]?Nd:_d}let s=n(t),i=s(t);return{c(){i.c(),e=Rl("")},m(t,n){i.m(t,n),Nl(t,e,n)},p(t,[r]){s===(s=n(t))&&i?i.p(t,r):(i.d(1),i=s(t),i&&(i.c(),i.m(e.parentNode,e)))},i:bl,o:bl,d(t){i.d(t),t&&xl(e)}}}const Ld="w-full sm:w-4/6 md:w-1/2 max-w-md mx-auto";function Od(t,e,n){let{meme:s}=e;return t.$$set=t=>{"meme"in t&&n(0,s=t.meme)},[s]}class Rd extends cd{constructor(t){super(),ad(this,t,Od,xd,Cl,{meme:0})}}function Md(t,e,n){const s=t.slice();return s[7]=e[n],s}function Pd(t,e,n){const s=t.slice();return s[10]=e[n],s}function Fd(t,e,n){const s=t.slice();return s[10]=e[n],s}function Vd(t){let e,n;return e=new Sd({props:{name:t[10],path:`maths/${t[10]}`}}),{c(){sd(e.$$.fragment)},m(t,s){id(e,t,s),n=!0},p:bl,i(t){n||(td(e.$$.fragment,t),n=!0)},o(t){ed(e.$$.fragment,t),n=!1},d(t){rd(e,t)}}}function $d(t){let e,n;return e=new Sd({props:{name:t[10],path:`maths/${t[10]}`}}),{c(){sd(e.$$.fragment)},m(t,s){id(e,t,s),n=!0},p:bl,i(t){n||(td(e.$$.fragment,t),n=!0)},o(t){ed(e.$$.fragment,t),n=!1},d(t){rd(e,t)}}}function Ud(t){let e,n;return e=new Sd({props:{name:t[7],path:`physics/${t[7].toLowerCase().split(" ").join("_")}_GBD`}}),{c(){sd(e.$$.fragment)},m(t,s){id(e,t,s),n=!0},p:bl,i(t){n||(td(e.$$.fragment,t),n=!0)},o(t){ed(e.$$.fragment,t),n=!1},d(t){rd(e,t)}}}function Bd(t){return{c:bl,m:bl,p:bl,i:bl,o:bl,d:bl}}function jd(t){let e,n;return e=new Rd({props:{meme:t[6]}}),{c(){sd(e.$$.fragment)},m(t,s){id(e,t,s),n=!0},p:bl,i(t){n||(td(e.$$.fragment,t),n=!0)},o(t){ed(e.$$.fragment,t),n=!1},d(t){rd(e,t)}}}function qd(t){let e,n;return e=new kd({}),{c(){sd(e.$$.fragment)},m(t,s){id(e,t,s),n=!0},p:bl,i(t){n||(td(e.$$.fragment,t),n=!0)},o(t){ed(e.$$.fragment,t),n=!1},d(t){rd(e,t)}}}function Kd(t){let e,n,s,i,r,o,a,c,u,h,l,d,f,p,g,m,y,v,w,b,E,T,I,S,C,A,D,k,_,N,x,L,O,R,M,P,F,V,$,U,B,j;e=new Ad({});let q=t[1],K=[];for(let e=0;e<q.length;e+=1)K[e]=Vd(Fd(t,q,e));const z=t=>ed(K[t],1,1,(()=>{K[t]=null}));let G=t[2],H=[];for(let e=0;e<G.length;e+=1)H[e]=$d(Pd(t,G,e));const Q=t=>ed(H[t],1,1,(()=>{H[t]=null}));let W=t[3],X=[];for(let e=0;e<W.length;e+=1)X[e]=Ud(Md(t,W,e));const Y=t=>ed(X[t],1,1,(()=>{X[t]=null}));D=new Sd({props:{name:"Physics Year 2",path:"physics/Physics Year 2"}}),_=new Sd({props:{name:"PiP",path:"physics/PiP"}});let J={ctx:t,current:null,token:null,hasCatch:!1,pending:qd,then:jd,catch:Bd,value:6,blocks:[,,,]};return nd(t[0],J),{c(){sd(e.$$.fragment),n=Ml(),s=Ol("main"),i=Ol("h2"),i.textContent="Maths",r=Ml(),o=Ol("div");for(let t=0;t<K.length;t+=1)K[t].c();a=Ml(),c=Ol("hr"),u=Ml(),h=Ol("h2"),h.textContent="Further Maths",l=Ml(),d=Ol("div");for(let t=0;t<H.length;t+=1)H[t].c();f=Ml(),p=Ol("p"),p.textContent="The year 1 pure and stats are dodgy older versions but I'll fix them soon.",g=Ml(),m=Ol("hr"),y=Ml(),v=Ol("h2"),v.textContent="GBD Booklets",w=Ml(),b=Ol("div");for(let t=0;t<X.length;t+=1)X[t].c();E=Ml(),T=Ol("hr"),I=Ml(),S=Ol("h2"),S.textContent="Physics",C=Ml(),A=Ol("div"),sd(D.$$.fragment),k=Ml(),sd(_.$$.fragment),N=Ml(),x=Ol("hr"),L=Ml(),O=Ol("section"),R=Ol("h2"),R.textContent="Meme of the Day",M=Ml(),J.block.c(),P=Ml(),F=Ol("hr"),V=Ml(),$=Ol("section"),$.innerHTML='<h2>Meme Archive</h2> \n  <p class="epilogue"><a class="hover:underline" href="archive.html">Meme Archive</a></p>',U=Ml(),B=Ol("footer"),Pl(o,"class","book-section"),Pl(d,"class","book-section"),Pl(p,"class","epilogue"),Pl(b,"class","book-section"),Pl(A,"class","book-section"),Pl(O,"id","otd")},m(t,q){id(e,t,q),Nl(t,n,q),Nl(t,s,q),_l(s,i),_l(s,r),_l(s,o);for(let t=0;t<K.length;t+=1)K[t].m(o,null);_l(s,a),_l(s,c),_l(s,u),_l(s,h),_l(s,l),_l(s,d);for(let t=0;t<H.length;t+=1)H[t].m(d,null);_l(s,f),_l(s,p),_l(s,g),_l(s,m),_l(s,y),_l(s,v),_l(s,w),_l(s,b);for(let t=0;t<X.length;t+=1)X[t].m(b,null);_l(s,E),_l(s,T),_l(s,I),_l(s,S),_l(s,C),_l(s,A),id(D,A,null),_l(A,k),id(_,A,null),Nl(t,N,q),Nl(t,x,q),Nl(t,L,q),Nl(t,O,q),_l(O,R),_l(O,M),J.block.m(O,J.anchor=null),J.mount=()=>O,J.anchor=null,Nl(t,P,q),Nl(t,F,q),Nl(t,V,q),Nl(t,$,q),Nl(t,U,q),Nl(t,B,q),j=!0},p(e,[n]){if(t=e,2&n){let e;for(q=t[1],e=0;e<q.length;e+=1){const s=Fd(t,q,e);K[e]?(K[e].p(s,n),td(K[e],1)):(K[e]=Vd(s),K[e].c(),td(K[e],1),K[e].m(o,null))}for(Jl(),e=q.length;e<K.length;e+=1)z(e);Zl()}if(4&n){let e;for(G=t[2],e=0;e<G.length;e+=1){const s=Pd(t,G,e);H[e]?(H[e].p(s,n),td(H[e],1)):(H[e]=$d(s),H[e].c(),td(H[e],1),H[e].m(d,null))}for(Jl(),e=G.length;e<H.length;e+=1)Q(e);Zl()}if(8&n){let e;for(W=t[3],e=0;e<W.length;e+=1){const s=Md(t,W,e);X[e]?(X[e].p(s,n),td(X[e],1)):(X[e]=Ud(s),X[e].c(),td(X[e],1),X[e].m(b,null))}for(Jl(),e=W.length;e<X.length;e+=1)Y(e);Zl()}!function(t,e,n){const s=e.slice(),{resolved:i}=t;t.current===t.then&&(s[t.value]=i),t.current===t.catch&&(s[t.error]=i),t.block.p(s,n)}(J,t,n)},i(t){if(!j){td(e.$$.fragment,t);for(let t=0;t<q.length;t+=1)td(K[t]);for(let t=0;t<G.length;t+=1)td(H[t]);for(let t=0;t<W.length;t+=1)td(X[t]);td(D.$$.fragment,t),td(_.$$.fragment,t),td(J.block),j=!0}},o(t){ed(e.$$.fragment,t),K=K.filter(Boolean);for(let t=0;t<K.length;t+=1)ed(K[t]);H=H.filter(Boolean);for(let t=0;t<H.length;t+=1)ed(H[t]);X=X.filter(Boolean);for(let t=0;t<X.length;t+=1)ed(X[t]);ed(D.$$.fragment,t),ed(_.$$.fragment,t);for(let t=0;t<3;t+=1){ed(J.blocks[t])}j=!1},d(t){rd(e,t),t&&xl(n),t&&xl(s),Ll(K,t),Ll(H,t),Ll(X,t),rd(D),rd(_),t&&xl(N),t&&xl(x),t&&xl(L),t&&xl(O),J.block.d(),J.token=null,J=null,t&&xl(P),t&&xl(F),t&&xl(V),t&&xl($),t&&xl(U),t&&xl(B)}}}function zd(t,e,n){let{db:s}=e;const i=fd(new Date),r=Ed(i,s);return t.$$set=t=>{"db"in t&&n(4,s=t.db)},[r,["Pure Year 1","Pure Year 2","Applied Year 1","Applied Year 2"],["Further Mech","Further Pure Year 1","Further Pure Year 2","Further Stats"],["Gravitational Fields","Circular Motion","Electric Fields","Simple Harmonic Motion","Capacitors","Thermal Physics","Magnetism","Nuclear Physics","Radioactivity","Astrophysics"],s]}return new class extends cd{constructor(t){super(),ad(this,t,zd,Kd,Cl,{db:4})}}({target:document.body,props:{db:ml}})}();
